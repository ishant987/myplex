...
class MgrCurrenciesValueDailySF extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'migration:currenciesvaluedailysitefolks';
     ...
     * @var string
     */
    protected $description = 'Take data from tb_currencydetail table.';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $totRecords = $mgrDb->table('tb_currencydetail')->select('CurrencyID')->count();
            if ($totRecords > 0) {
                ...
                for ($i = 1; $i <= $noOfLot; $i++) {
                    ...
                    $dataRows = $mgrDb->table('tb_currencydetail')->offset($offset)->take($this->fetchRecords)->get();
