...
class MgrAUMsValueMonthlySF extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'migration:aumsvaluemonthlysitefolks';
     ...
     * @var string
     */
    protected $description = 'Take data from tb_corpusentry table.';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $totRecords = $mgrDb->table('tb_corpusentry')->select('EntryDate')->count();
            if ($totRecords > 0) {
                ...
                for ($i = 1; $i <= $noOfLot; $i++) {
                    ...
                    $dataRows = $mgrDb->table('tb_corpusentry')->offset($offset)->take($this->fetchRecords)->get();
