...
class MgrNavsValueDailySF extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'migration:navsvaluedailysitefolks';
     ...
     * @var string
     */
    protected $description = 'Take data from tb_funddetail table.';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $totRecords = $mgrDb->table('tb_funddetail')->select('EntryDate')->count();
            if ($totRecords > 0) {
                ...
                for ($i = 1; $i <= $noOfLot; $i++) {
                    ...
                    $dataRows = $mgrDb->table('tb_funddetail')->offset($offset)->take($this->fetchRecords)->get();
