...
class blogCreate extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'tags' => 'required',
            'is_active' => 'required',
            'image_thumb' => 'required|mimes:jpg,jpeg,png|max:1024',
            'image_banner' => 'required|mimes:jpg,jpeg,png|max:1024',
            'image_thumb' => 'required|max:1024',
            'image_banner' => 'required|max:1024',
