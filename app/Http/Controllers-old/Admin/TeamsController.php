...
class TeamsController extends BaseController
{
    ...
    public function index()
    {
        ...
        $dataListModel = Teams::list();

        $coreObj = new App();
        $listDataAtrArr = $coreObj->getListDataAtr();
        $statusAtrArr = $coreObj->getStatusLblTyp2Atr();

        $roleRights = ['add' => App::hasAccessToMethod($this->className, 'admin.team.create'), 'edit' => App::hasAccessToMethod($this->className, 'admin.team.edit'), 'delete' => App::hasAccessToMethod($this->className, 'admin.team.delete')];

        return view('themes.backend.pages.team.index', compact('dataListModel', 'listDataAtrArr', 'statusAtrArr', 'roleRights'));
    }
    ...
    public function create()
    {
        ...
        return view('themes.backend.pages.team.createform', compact('statusArr'));
    }
    ...
    {
        $dataArr = Teams::find($id);

        $statusArr = App::getStatusLblTyp2Arr();

        $editDataAtrArr = ["title" => __('admin.team.edit_txt'), "route" => 'team.edit'];

        return view('themes.backend.pages.team.updateform', compact('dataArr', 'statusArr', 'editDataAtrArr'));
    }
