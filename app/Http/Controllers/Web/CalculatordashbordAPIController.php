...
class CalculatordashbordAPIController extends BaseController
{
    public $className;
    public $class_id;
    ...
    public function beta_calculator(Request $request)
    {
        ...
        if(isset($input['search']) && $input['search'] == 'Search')
        {
            ...
            // dd($from_date_fund_data);
            // dd($input["search_from_date"]);
    ...
    public function beta_calculator_mar(Request $request)
    {
        $input = $request->all();
        if(isset($input['search']) && $input['search'] == 'Search')
        {
