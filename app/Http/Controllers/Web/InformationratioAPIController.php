...
class InformationratioAPIController extends BaseController
{
    public $className;
    public $class_id;
    ...
    public function information_ratio_calculator(Request $request)
    {
        // dd('hi');
        $input = $request->all();
        // dd($input);
        ...
        {   
            ...
            if(date('Y-m-d H:i:s', strtotime($fund_opening_date)) > date('Y-m-d H:i:s', strtotime($data['search_from_date']))){
                $data['tracking_error'] = 'N/A';
                $data['information_ratio'] = 'N/A';
            ...
            // If you want the result to be a floating-point number, use this version:
            $getYear = round($getYear, 2);
            $allDates = [];
            $data['getyear'] = $getYear;
            echo $getYear;

            $getYear = ceil($monthsDifference / 12);
            */
    ...
    public function information_ratio_calculator_mar(Request $request)
    {
        // dd('hi');
        $input = $request->all();
        // dd($input);
