...
class TrackingerrorAPIController extends BaseController
{
    public $className;
    public $class_id;
    ...
    public function tracking_error_calculator(Request $request)
    {
        $input = $request->all();
        if(isset($input['search']) && $input['search'] == 'Search')
        {
            ...
            if(count($sub_of_fund_index_array) > 1)
            {
                ...
                $data['tracking_error'] = sqrt($squaredDifferencesSum / (count($sub_of_fund_index_array) - 1));
            }
            else
            {
                $data['tracking_error'] = 0;
            }
        ...
        // return view('web.infosolz-calculator.tracking_error',$data);
    }


    public function tracking_error_calculator_mar(Request $request)
    {
        $input = $request->all();
        if(isset($input['search']) && $input['search'] == 'Search')
        {
