...
class SkewnessAPIController extends BaseController
{
    public $className;
    public $class_id;
    ...
    public function skewness_calculator(Request $request)
    {
        $input = $request->all();
        ...
        // return view('web.infosolz-calculator.skewness',$data);
    }

    
    public function skewness_calculator_mar(Request $request)
    {
        $input = $request->all();
        if(isset($input['search']) && $input['search'] == 'Search')
        {
