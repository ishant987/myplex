...
class TreynorAPIController extends BaseController
{
    public $className;
    public $class_id;
    ...
    public function treynor_calculator(Request $request)
    {
        $input = $request->all();
        if(isset($input['search']) && $input['search'] == 'Search')
        {
            ...
            foreach($allDates as $value)
            {
                ...
                if($foundFundRow != false )
                {
                    ...
                    $f_g_sum += $f_g;
                    $h_sum +=$index_rate_average_of_index_squere;
            ...
            if($variance != 0)
            {
                $data['beta'] = $beta = $covariance/$variance;
            }
            else
            {
                $data['beta'] = $beta = 0;
    ...
    public function treynor_calculator_mar(Request $request)
    {
        $input = $request->all();
        if(isset($input['search']) && $input['search'] == 'Search')
        {
