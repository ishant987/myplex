...
class VolatilityController extends BaseController
{
    public $className;
    public $class_id;
    ...
    public function volatility_calculator(Request $request)
    {
        $input = $request->all();
            ...
            foreach($allDates as $value)
            {
                ...
                if($foundFundRow != false )
                {
                    ...
                    $res = array(
                        ...
                        'fund_ret_avg_of_nav' => ($fund_ret_avg_of_nav == -0) ? 0 : $fund_ret_avg_of_nav,
                        'fund_ret_avg_of_nav_squere' => $fund_ret_avg_of_nav*$fund_ret_avg_of_nav,
                    );
        ...
        return view('web.infosolz-calculator.volatility',$data);
    }
