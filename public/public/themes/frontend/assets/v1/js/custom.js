...
let current_age_input = document.getElementById("current_age_input");
let current_age_output = document.getElementById("current_age_output");

let expected_age_retirement = document.getElementById("expected_age_retirement");
let expected_age_retirement_output = document.getElementById("expected_age_retirement_output");

let life_expectancy = document.getElementById("life_expectancy");
let life_expectancy_output = document.getElementById("life_expectancy_output");

let accumulation_period = document.getElementById("accumulation_period");
let accumulation_period_output = document.getElementById("accumulation_period_output");

let retirement = document.getElementById("retirement");
let retirement_output = document.getElementById("retirement_output");

let inflation = document.getElementById("inflation");
let inflation_output = document.getElementById("inflation_output");

current_age_input.oninput = function() {
    current_age_output.value = this.value;
  }
