...
GO
    /****** Object:  StoredProcedure [dbo].[Sp_GetQuartileDecile]    Script Date: 03-03-2022 15:18:13 ******/
SET
    ANSI_NULLS ON
GO
SET
...
GO
    ALTER PROCEDURE [dbo].[Sp_GetQuartileDecile] @StartDate VARCHAR(10),
    @EndDate VARCHAR(10),
...
from
    ...
    inner join TbIndicesDetail_3Y i on i.EntryDate = f.EntryDate
...
SET
    @RiskFreeReturn = @RiskFreeReturn / 365;
