            ...
            <div class="comp_schem_bdr">
                <div class="tab_snap_shot">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li  class="nav-item" role="presentation"><a class="nav-link" :class="{'active show':currentTab == 'monthly'}" data-toggle="tab" href="#tab-monthly" @click="currentTab = 'monthly'">Monthly</a></li>
                    </ul>
                    <div class="tab-wrapper">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab-weekly" class="tab-pane fade in" :class="{'active show':currentTab == 'weekly'}">
                                    ...
                                    <div class="invst-wrap">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <Datepicker placeholder="As On Date" class="custom-input" v-model="selectedDateWeekly" :format="'dd/MM/yyyy'" :enableTimePicker="false" :autoApply="true" :range="false" :maxDate="maxDateRang"></Datepicker>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <multiselect 
                                ...
                                <div class="datatable_ll main_trer fund_performance_table perform-snapshot-table full-table-style-2 custom-sort-table">
                                        ...
                                        <tbody>
                                            <tr v-for="(data,index) in weekly_snapshot_data" :key="index">
                                                ...
                                                <td v-if="dataCategoryWeekly == 'return' && data['5DAYS'] != null">
													{{ data['5DAYS'].toFixed(2) }}
													</td>
												<td v-else>0.00</td>
                                                <td v-if="data['14DAYS'] != null">{{ data['7DAYS'].toFixed(2) }}</td>
												<td v-else>0.00</td>
                                                <td v-if="data['14DAYS'] != null">{{ data['14DAYS'].toFixed(2) }}</td>
												<td v-else>0.00</td>
                                                <td v-if="data['30DAYS'] != null">{{ data['30DAYS'].toFixed(2) }}</td>
												<td v-else>0.00</td>
                                                <td v-if="data['60DAYS'] != null">{{ data['60DAYS'].toFixed(2) }}</td>
												<td v-else>0.00</td>
                                            </tr>
                            ...
                            <div id="tab-monthly" class="tab-pane fade" :class="{'active show':currentTab == 'monthly'}">
                                <form action="#" method="get">
                                    <div class="invst-wrap">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <Datepicker placeholder="As On Date" class="custom-input" v-model="selectedDateMonthly" :format="'dd/MM/yyyy'" :enableTimePicker="false" :autoApply="true" :range="false" :maxDate="maxDateRang"></Datepicker>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <multiselect 
                                                :disabled="loading || process"
