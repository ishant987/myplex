        ...
        <div class="container">
            <div class="portfoliodiv">
				...
				<div class="row" v-if="isFundHouseSelected && isFundNameSelected">
					<div class="col-md-12">
						<h4>Fund Portfolio for Fund House: {{ selectedFundHouse.fund_house }} and Fund Name: {{ selectedFund.fund_name }} </h4>
					</div>
				</div>
                <div class="row">
                    <div class="col-md-12">
            ...
            async getFundPortfolio() {
                ...
                await axios.get(that.app_url+'/api/v1/fund-portfolio', {
                    ...
                    .then(response => {
                        ...
                        that.totalAmount = parseFloat(response.data.data.total_amount).toLocaleString('en-IN', {minimumFractionDigits: 2});
