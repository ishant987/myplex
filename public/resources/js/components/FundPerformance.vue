                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-Return" role="tabpanel"
                            ...
                            <div class="datatable_ll performance_compare_top_table mt-4">
                                ...
                                <div class="mt-3" v-if="Object.keys(fund_details).length">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-4 mb-2"><b>Category:</b> {{ fund_details.no_of_schemes }}</div>
                            ...
                            <div class="datatable_ll mt-3" v-if="Object.keys(fund_details_ratios).length">
                                <div class="">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-4 mb-2"><b>Category:{{ fund_details_ratios.no_of_schemes }}</b></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{
                                                            Object.keys(jensenalpha_beta_volatility_ratios.TWOYEAR).length
                                                                ?
                                                                jensenalpha_beta_volatility_ratios.TWOYEAR.jensen_alpha.toFixed(2)
                                                                : 'NA'
                                                    }}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>{{
                                                            Object.keys(jensenalpha_beta_volatility_ratios.TWOYEAR).length
                                                                ? jensenalpha_beta_volatility_ratios.TWOYEAR.beta.toFixed(2) :
                                                                'NA'
                                                    }}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>{{
                                                            Object.keys(jensenalpha_beta_volatility_ratios.TWOYEAR).length
                                                                ?
                                                                jensenalpha_beta_volatility_ratios.TWOYEAR.volatality.toFixed(2)
                                                                : 'NA'
                                                    }}</td>
                                                </tr>
                                            </template>
                            ...
                            <div class="datatable_ll performance_compare_top_table mt-4">
                                ...
                                <div class="mt-3" v-if="Object.keys(fund_details_portfolios).length">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-4 mb-2"><b>Category:{{ fund_details_portfolios.no_of_schemes }}</b></div>
...
export default {
    ...
    methods: {
        ...
        async getFundRatios() {
			...
			{
				that.heading = 'Scheme Performance, '+that.selectedFundReturns.fund_name+' - Benchmark as on '+that.fund_details.nav_entry_date;
				//console.log(that.selectedFundReturns.fund_name);
			}
            ...
            if (!Object.keys(that.category_compare_data).length && that.ratio_type == 'to_category') {
                await axios.get(this.app_url + '/api/v1/fund-performance-compare-category', {
                    ...
                    .then(response => {
						...
						//console.log(that.category_compare_data);
						if(that.category_compare_data.SEVENDAYS?.laggard && that.category_compare_data.SEVENDAYS?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'sevendays');
						}
					
						if(that.category_compare_data.THIRTYDAYS?.laggard && that.category_compare_data.THIRTYDAYS?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'thirtydays');
						}
					
						if(that.category_compare_data.NINTYDAYS?.laggard && that.category_compare_data.NINTYDAYS?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'nintydays');
						}
					
						if(that.category_compare_data.SIXMONTHS?.laggard && that.category_compare_data.SIXMONTHS?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'sixmonths');
						}
					
						if(that.category_compare_data.ONEYEAR?.laggard && that.category_compare_data.ONEYEAR?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'oneyear');
						}
					
						if(that.category_compare_data.TWOYEAR?.laggard && that.category_compare_data.TWOYEAR?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'twoyears');
						}
					
						if(that.category_compare_data.THREEYEAR?.laggard && that.category_compare_data.THREEYEAR?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'threeyears');
						}
					
						if(that.category_compare_data.FIVEYEAR?.laggard && that.category_compare_data.FIVEYEAR?.leader)
						{
							...
							that.addLaggardLeder(0, 0, 'fiveyears');
						}					
		...
		addLaggardLeder(laggard, leader, no_of_days) {		
			...
			{
				console.log(laggard, leader, no_of_days);
				this.category_declie.push(0);
				this.category_quartile.push(0);
				
			} else {
				
				const class_gap = ((leader-laggard)/10).toFixed(3);
				const quartile_class_gap = ((leader-laggard)/4).toFixed(3);				
		...
		getQuartileNum(class_gap, laggard, leader, scheme_value)
		{
			...
			console.log('First Value: '+first_value+' Second Value: '+second_value+' scheme value: '+scheme_value);
			...
			if( Number(second_value) < Number(scheme_value) && Number(scheme_value) < Number(first_value) )
			{
				...
				for(let i=2; i<=4; i++)
				{
					...
					if( Number(second_value) < Number(scheme_value) && Number(scheme_value) < Number(first_value) )
					{
						//console.log('Inside First Value: '+first_value+' Second Value: '+second_value);
						num_val = i;
					}				
            ...
            await axios.get(this.app_url + '/api/v1/fund-performance-jensenalpha-beta-volatility', {
                ...
                .then(response => {
                    ...
                    if (that.currentTab == 'ratios' || (that.selectedFundRatios.fund_code && that.selectedFundRatios.fund_code == fund_code)) {
						...
						console.log('JensenAlpha Ratio');
						console.log(that.jensenalpha_beta_volatility_ratios);
                    }
                })
                .catch(error => {
                    console.log(error);
