                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header" id="heading{{$record->ktr_id}}">
                                <button class="accordion-button {{ ($index == 0)?'':' collapsed' }}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{$record->ktr_id}}" aria-expanded="true" aria-controls="collapse{{$record->ktr_id}}">
                                    {{$record->title}}
