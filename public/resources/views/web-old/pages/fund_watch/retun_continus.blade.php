...
<tr>
    ...
    <td data-label="3Y">
		@if($category_average['THREEYEAR'])
				{{ round($category_average['THREEYEAR']['category_avg'], 2) }}
		@endif
	</td>
    <td data-label="5Y">
		@if($category_average['FIVEYEAR'])
			{{ round($category_average['FIVEYEAR']['category_avg'], 2) }}
		@endif
	</td>
</tr>
