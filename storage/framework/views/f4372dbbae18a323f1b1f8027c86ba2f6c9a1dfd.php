                                    ...
                                    <div class="col-xl-4 col-lg-4 mt-4">
                                        <div class="single-service-box-style1 h-100">
											<div class="top-float blog">
												<p class="mb-0"><?php echo e($allnewfroms[0]->type_id); ?></p>
											</div>
                                            <div class="icon">
                                                <span class="icon-safebox"></span>
                                            </div>
                                            
                                            <h3><a href="<?php echo e($allnewfroms[0]->link); ?>" target="_blank"><?php echo e($allnewfroms[0]->title); ?></a></h3>
                                            <div class="border-box"></div>
                                            <!--<p>Aditya Birla Sun Life Flexi Cap Fund</p>-->
                                            <!-- <h6><span>*</span> Interest rate up to 5% p.a</h6> -->
                                            <div class="btn-box">
                            <a href="<?php echo e($allnewfroms[0]->link); ?>" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 mt-4">
                                        <div class="single-service-box-style1 h-100">
											<div class="top-float">
												<p class="mb-0"><?php echo e($allnewfroms[2]->type_id); ?></p>
											</div>
                                            <div class="icon">
                                                <span class="icon-loan"></span>
                                            </div>
                                            <h3><a href="<?php echo e($allnewfroms[2]->link); ?>" target="_blank"><?php echo e($allnewfroms[2]->title); ?></a></h3>
                                            <div class="border-box"></div>
                                            <!--<p>With Compare Scheme</p> -->
                                            <!-- <h6><span>*</span> Check today’s Interest Rates</h6> -->
                                            <div class="btn-box">
                                                <a href="<?php echo e($allnewfroms[2]->link); ?>" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End Single Service Box Style1-->
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <?php if($i <= 2): ?>
				...
				<div class="col-md-6 mb-4" data-aos="fade-up" data-aos-duration="<?php echo e(500*$i); ?>">
					<div class="money_left_sec">
						<div class="fund_watch_home_sec_single_img">
                        <img src="<?php echo e(env('ADMIN_SITE')); ?>/assets/images/<?php echo e($fndWtchMdl[0]->logo); ?>" />
						</div>
					</div>
        ...
        <div class="row">
            <div class="col-md-7 col-lg-5">
                <div class="fund_man_expert_home" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <a href="<?php echo e(route('user.user_login')); ?>" class="money_title_btn type2 me-3 ms-0">Login</a>
                    <a href="<?php echo e(route('user.registration')); ?>" class="money_title_btn type2">Register</a>
                </div>
            </div>
        </div>
    </div>
