            ...
            <div class="col-md-12 col-lg-9 px-0">
                <div class="hero_banner_right_slider">
                    <div class="single_slider_for">
                        <img src="<?php echo e(asset('themes/frontend/assets/v1/img/home1.jpeg')); ?>" class="img-fluid" alt="Mutual Fund Research Platform" />
                    ...
                    <div class="single_slider_for">
                        <img src="<?php echo e(asset('themes/frontend/assets/v1/img/banner-2.jpg')); ?>" class="img-fluid" alt="Invest in Mutual Funds" />
                        <div class="slider_caption">
					...
					<div class="single_slider_for">
                        <img src="<?php echo e(asset('themes/frontend/assets/v1/img/banner-3.jpg')); ?>" class="img-fluid" alt="Mutual Fund Analytics" />
                        <div class="slider_caption">
                            <h2 class="animate__animated animate__fadeInUp">Invest in the freedom to choose</h2>
                            <p class="animate__animated animate__fadeInUp">Wealth is not just about money. It's about
                                what all you can do with it. It is having your own story of progress. And living it
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 mt-4">
                                        <div class="single-service-box-style1 h-100">
                                            ...
                                            <?php if(!empty($nfoMdl[0])): ?>
                                            <h3><a href="<?php echo e(url('/nfo-monitor').'/'.$nfoMdl[0]->no_id); ?>" target="_blank"><?php echo e($nfoMdl[0]->fund_name); ?></a></h3>
                                            <div class="border-box"></div>
                                            <!--<p>Aditya Birla Sun Life Flexi Cap Fund</p>-->
                                            <!-- <h6><span>*</span> Interest rate up to 5% p.a</h6> -->
                                            <div class="btn-box">
                                                <a href="<?php echo e(url('/nfo-monitor').'/'.$nfoMdl[0]->no_id); ?>" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <!--Start Single Service Box Style1-->
                                    <div class="col-xl-4 col-lg-4 mt-4">
                                        <?php if(isset($allnewfroms[1])): ?>
                                        <div class="single-service-box-style1 h-100">
											<div class="top-float">
												<p class="mb-0"><?php echo e($allnewfroms[1]->type_id); ?></p>
											</div>
                                            <div class="icon">
                                                <span class="icon-online"></span>
                                            </div>
                                          <h3><a href="<?php echo e($allnewfroms[1]->link); ?>" target="_blank"><?php echo e($allnewfroms[1]->title); ?></a></h3>
                                            <div class="border-box"></div>
                                            <!--<p>Future Value Calculator?</p> -->
                                            <!-- <h6><span>*</span> Terms &amp; Conditions</h6> -->
                                            <div class="btn-box"> 
                                                <a href="<?php echo e($allnewfroms[1]->link); ?>" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                        <?php else: ?>
                                        <div class="single-service-box-style1 h-100">
                                    ...
                                    <div class="col-xl-4 col-lg-4 mt-4">
                                        <div class="single-service-box-style1 h-100">
                                            ...
                                            <h3><a href="<?php echo e($blogResponses[0]['link']); ?>" target="_blank"><?php echo e($blogResponses[0]['title']); ?></a></h3>
                                            <div class="border-box"></div>
                                            <!--<p>With Compare Scheme</p> -->
                                            <!-- <h6><span>*</span> Check today’s Interest Rates</h6> -->
                                            <div class="btn-box">
                                                <a href="<?php echo e($blogResponses[0]['link']); ?>" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End Single Service Box Style1-->
            ...
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-md-12 col-lg-4">
                        <div class="single_abt_item" data-aos="fade-up" data-aos-duration="1500">
                            <div class="abt_icon d-flex align-items-center">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/ranking-icon.png')); ?>" alt="Monthly Ranking" />
                            ...
                            <div class="single_abt_content">
                               ...
                               <div class="dropdown tools_dropdown">
                                    <select class="form-select select2" id="risk-management" aria-label="Default select example" onchange="performance(this.value, 'risk')">
										...
										<?php if($performaceResponses['success']): ?>
											<?php $__currentLoopData = $performaceResponses['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $performaceResponse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($performaceResponse['ft_id']); ?>"><?php echo e($performaceResponse['name']); ?></option>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="single_abt_item " data-aos="fade-up" data-aos-duration="1500">
                            <div class="abt_icon d-flex align-items-center">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/fund-icon.png')); ?>" alt="Fund Portfolio" />
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="single_abt_item " data-aos="fade-up" data-aos-duration="1500">
                            <div class="abt_icon d-flex align-items-center">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/performance-icon.png')); ?>" alt="Fund Performance" />
        ...
        <div class="row columns_padding_25 columns_margin_bottom_30">
            ...
            <div class="col-md-12 text-center">
                <!-- <div class="workflow inline-block columns_padding_0">
                    ...
                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/workflow.png')); ?>" alt="myplexus Workflow">
                    <div class="row columns_margin_bottom_0">
                        <div class="col-xs-12">
                ...
                <div class="row columns_padding_25">
                    <div class="col-lg-4 col-md-4 mt-5">
                        ...
                        <div class="with_padding teaser text-center px-5 px-md-0" data-aos="fade-up" data-aos-duration="1000">
                            <!-- <div class="teaser_icon">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/daily-price-icon.png')); ?>" alt="Daily Price" />
                    ...
                    <div class="col-lg-4 col-md-4 mt-5">
                            <div class="with_padding teaser text-center" data-aos="fade-up" data-aos-duration="1000">
                                <!-- <div class="teaser_icon">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/ratio-icon.png')); ?>" alt="Fund Ratios" />
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 mt-5">
                            <div class="with_padding teaser text-center" data-aos="fade-up" data-aos-duration="1000">
                                <!-- <div class="teaser_icon">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/composition-icon.png')); ?>" alt="Fund Composition" />
                                </div>
        ...
        <div class="row align-items-end"> -->
            <!-- <div class="col-lg-6 offset-lg-0 col-md-10 offset-md-1" data-aos="fade-up" data-aos-duration="1500">
                <div class="compare_left_sction">
                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/compare-sheme-img.png')); ?>" class="img-fluid" alt="Compare Mutual Fund Schemes" />
                </div>
            </div> -->
...
<section class="money_seriously_section section">
    <div class="container">
                ...
                <div class="col-md-12" data-aos="fade-up" data-aos-duration="1000">
                    <div class="money_seriously_title d-block d-sm-flex align-items-center">
                        <h4 style="display: inline-flex;">Money, Seriously!! 
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/blog-image.png')); ?>" style="width: 40%;"/>
                        </h4>					
        ...
        <div class="row align-items-center">		
			...
			<?php $__currentLoopData = $blogResponses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>			
            <div class="col-md-4 mb-4">
                <div class="money_left_sec" data-aos="fade-up" data-aos-duration="1000">
                 	<img src="<?php echo e($value['img']); ?>" class="img-fluid" />
                </div>
                <div class="money_right_section" data-aos="fade-up" data-aos-duration="1000">
                    <h4><?php echo e($value['title']); ?></h4>					
					<p>
                        <?php echo e(Str::limit(strip_tags($value['short_desc']), 200, '...')); ?> 
                    </p>
                   <a href="<?php echo e($value['link']); ?>" target="_blank">Read More</a>
                </div>
            </div> 
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                            ...
                            <div class="col-md-12">
                                <div class="calculator_inner d-md-flex d-block align-items-center-between justify-content-center w-100">
                                    <div class="single_calculator">
                                        ...
                                        <div data-aos="zoom-in" data-aos-duration="500">
                                            <a href="https://myplexus.com/calctest?cal=sip">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/lumpsum.png')); ?>" />
                                                <h4>SIP Planner</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="single_calculator have_before">
                                        ...
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="https://myplexus.com/calctest?cal=lump">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/sip.png')); ?>" />
                                    ...
                                    <div class="single_calculator have_before">
                                        ...
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="https://myplexus.com/calctest?cal=retire">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/calculator-icon2.png')); ?>" />
                                    ...
                                    <div class="single_calculator have_before">
                                        ...
                                        <span class="right_circle d-none d-sm-block"></span>
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="<?php echo e(route('web.calculators')); ?>?tab=risk-tol-eval">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/calculator-icon4.png')); ?>" />
                                    ...
                                    <div class="single_calculator have_before">
                                        ...
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="https://myplexus.com/calctest?cal=inflation">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/calculator-icon1.png')); ?>" />
                            ...
                            <div class="col-md-12">
                                <div class="calculator_inner d-md-flex d-block align-items-center-between justify-content-center w-100">
                                    <div class="single_calculator">
                                        <span class="right_circle d-none d-sm-block"></span>
                                        <div data-aos="zoom-in" data-aos-duration="500">
                                            <a href="<?php echo e(route('web.calculators')); ?>?tab=pills-monthly1">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/lumpsum.png')); ?>" />
                                    ...
                                    <div class="single_calculator have_before">
                                        <span class="left_circle d-none d-sm-block"></span>
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="<?php echo e(route('web.calculators')); ?>?tab=sip-planner">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/sip.png')); ?>" />
...
<section class="money_seriously_section fund_watch_setion_home section">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <?php $i =1; ?>
            <?php if($i <= 2): ?>
                <?php $__currentLoopData = $fndWtchMdl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newfndWtchMdl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-md-4 mb-4" data-aos="fade-up" data-aos-duration="<?php echo e(500*$i); ?>">
                <?php if($newfndWtchMdl->logo): ?>
					<div class="money_left_sec">
						<div class="fund_watch_home_sec_single_img">
                            <img src="<?php echo e(env('ADMIN_SITE')); ?>/assets/images/<?php echo e($newfndWtchMdl->logo); ?>" />
						</div>
					</div>
                <?php endif; ?>    
					<div class="money_right_section">
						<?php
                         ...
                         ?>
						<h4><a href="<?php echo e(url('new-fundwatch')); ?>/<?php echo e($fid); ?>" target="_blank"><?php echo e($newfndWtchMdl->fundDetails->fund_name); ?></a></h4>
			...
			<div class="col-md-12 text-center">
            <?php if(count($fndWtchMdl) > 0): ?>
                <a href="<?php echo e(url('new-fundwatch-list')); ?>" class="money_title_btn type2">View More</a>
            <?php endif; ?>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12 patshala-right pl-0">
                    ...
                    <div class="patshala-new-rgt ml-3">
                        <ul>
                            <?php if($nfoMdl): ?>
                            <?php $__currentLoopData = $nfoMdl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(url('/nfo-monitor').'/'.$val->no_id); ?>"><?php echo e($val->fund_name); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
                            <?php endif; ?>						
...
<!-- <section class="money_seriously_section fund_watch_setion_home nfo_monitor_home_section section">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="money_left_sec" data-aos="fade-up" data-aos-duration="500">
                    <?php if($val->media != null): ?>
                    <div class="fund_watch_home_sec_single_img">
                        <img src="<?php echo e($BlogImagePath . $val->media->path); ?>" alt="<?php echo e($val->media->title); ?>" />
                    </div> 
                    <?php endif; ?>
                </div>
                <a href="<?php echo e(url('/nfo-monitor').'/'.$val->no_id); ?>"><div class="money_right_section" data-aos="fade-up" data-aos-duration="1000">
                    <h4><?php echo e($val->fund_name); ?></h4>
                     <p><?php echo e($val->objective); ?></p> 
        ...
        <div class="row mt-4">
            <div class="col-md-12 text-center">
                <a href="<?php echo e(route('web.nfomonitor.list')); ?>" class="money_title_btn ">View All Monitor</a>
            </div>
        </div>
    </div>
</section> -->
...
<!-- <section class="fund_expert_section section">
    ...
    <div class="container">
        <div class="row align-items-center meet_fund_expert">
            <div class="col-md-4">
                <img class='w-100' src="<?php echo e(asset('themes/frontend/assets/v1/img/fund_expert.png')); ?>">
            </div>
            ...
            <div class="row">
                <div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="2000">
                    <div class="MultiCarousel-inner">
                        <?php $__currentLoopData = $fundManMdl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k_FM=> $fundManData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>	
                            <div class="item">
                                <div class="pad15">
                                    <div class="money_left_sec car-img">
                                        <?php if($fundManData->media): ?>
                                        <img src="<?php echo e($fundManData->media->getModuleVars()['media_folder'].$fundManData->media['path']); ?>" class="img-fluid">
                                        <?php endif; ?>
                                    </div>
                                    <div class="money_right_section expertHeight">	
                                        <a href="<?php echo e(route('web.fundman', $fundManData->slug)); ?>"><h4><?php echo e($fundManData->name); ?></h4></a>				
                                        <p>
                                            <?php echo e($fundManData->designation); ?> <br>
                                            <?php echo e($fundManData->company_name); ?>
                    ...
                    <div class="testimonial_slider">
                        <div class="single_testimonila_slide">
                            <div class="single_slider_message">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/quote.png')); ?>" />
                            ...
                            <div class="testimonila_user_group_sec d-flex align-items-center justify-content-center">
                                <div class="user_img_group">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/1647351746-ajit.jpg')); ?>" />
                                </div>
                        ...
                        <div class="single_testimonila_slide">
                            ...
                            <div class="testimonila_user_group_sec d-flex align-items-center justify-content-center">
                                <div class="user_img_group">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/1647351746-Absm.jpg')); ?>" />
                                </div>
                                <div class="user_details_group">
                                    <h4>Arun Prasad G</h4>
						...
						<div class="single_testimonila_slide">
                            ...
                            <div class="testimonila_user_group_sec d-flex align-items-center justify-content-center">
                                <div class="user_img_group">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/1647351746-saugataC.jpg')); ?>" />
                                </div>
                                <div class="user_details_group">
						...
						<div class="single_testimonila_slide">
                            ...
                            <div class="testimonila_user_group_sec d-flex align-items-center justify-content-center">
                                <div class="user_img_group">
                                    <img src="<?php echo e(asset('themes/frontend/assets/v1/img/1647351746-waqur.jpg')); ?>" />
                                </div>
                                <div class="user_details_group">
                                    <h4>Waqar Naqvi</h4>
                                    <p>Chief Executive, </p>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="research_titile">
					...
					<a href="<?php echo e(route('user.user_login')); ?>" class="money_title_btn type2 ms-0">Login</a>
					<a href="<?php echo e(route('user.registration')); ?>" class="money_title_btn type2 ms-0">Register</a>
                </div>
            </div>
                ...
                <div class="research_right_sec">
                    <div class="research_row d-md-block d-lg-flex d-block align-items-center mb-40">
                        <div class="single_reserch d-flex align-items-center text-end mr-40 gb-right">
                            ...
                            <div class="research_icon">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/research1.png')); ?>" />
                            </div>
                        </div>
                        <div class="single_reserch d-flex align-items-center">
                            <div class="research_icon">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/research2.png')); ?>" />
                            </div>
                    ...
                    <div class="research_row d-md-block d-lg-flex d-block  align-items-center">
                        <div class="single_reserch d-flex align-items-center text-end mr-40 gb-right">
                            ...
                            <div class="research_icon">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/research3.png')); ?>" />
                            </div>
                        </div>
                        <div class="single_reserch d-flex align-items-center">
                            <div class="research_icon">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/research4.png')); ?>" />
                            </div>
...
<!-- <section class="ask_the_expert_sec section">
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="ask_expert_slider">
                    <div class="single_ask_expert">
						...
						<br>
                        <img src="<?php echo e(asset('themes/frontend/assets/v1/img/quote-green.png')); ?>" />
        ...
        <div class="row mt-3">
            <div class="col-md-12 text-center">
                <a href="<?php echo e(route('web.ask-expert')); ?>" class="money_title_btn">Ask An Expert</a>
            </div>
        </div>
    </div>
</section> -->
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="fund_man_expert_home">
                    ...
                    <!-- <a href="<?php echo e(route('web.login')); ?>" class="money_title_btn type2 me-3 ms-0">Login</a> -->
                    <!-- <a href="<?php echo e(route('web.investor-signup')); ?>" class="money_title_btn type2">Register</a> -->
...
<section class="faq_section section">
    <?php echo $__env->make('web.common.faq_section', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</section>
        ...
        <div class="row">
            <div class="col-md-7 col-lg-5">
                <div class="fund_man_expert_home">
                    ...
                    <a href="<?php echo e(route('web.know.your.scheme')); ?>" class="money_title_btn ms-0 type2">Get Started</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="as_seen_slider_inner text-center">
                    ...
                    <div class="as_seen_slider">
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client1.jpg')); ?>" />
                        </div>
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client2.jpg')); ?>" />
                        </div>
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client3.jpg')); ?>" />
                        </div>
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client4.jpg')); ?>" />
                        </div>
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client5.jpg')); ?>" />
                        </div>
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client6.jpg')); ?>" />
                        </div>
                        <div class="single_slider_seen">
                            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/client1.jpg')); ?>" />
                        </div>
...
<div class="press-release">
    <div class="container">
        ...
        <div class="row news-blocks">
            <?php $__currentLoopData = $nwsListMdl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>			
            <div class="col-lg-4 col-md-md-4 col-sm-12">                
                <div class="news-inner-block">
                    <a href="<?php echo e($newsData->news_source_link); ?>" target="_blank"><img src="https://new.myplexus.com/storage/news/<?php echo e($newsData->image); ?>" class="img-fluid" alt="<?php echo e($newsData->title); ?>" title="<?php echo e($newsData->title); ?>"><span>How MFs can help students &amp; working professionals to achieve financial goals</span></a>
                </div>
            </div> 
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
            <!-- <div class="col-lg-4 col-md-md-4 col-sm-12">
...
{
    $.ajax({
            url: "<?php echo e(route('web.get.news')); ?>",
            type: "get",
            dataType: 'json',
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/home/index.blade.php ENDPATH**/ ?>