...
<section class="landing-shell">
    <div class="landing-top">
        <div class="landing-nav">
            <a href="<?php echo e(url('/')); ?>" class="landing-brand">
            ...
            <div class="hero-grid">
                <div>
                    ...
                    <div class="hero-trust">
                        ...
                        <div>
                            <strong><?php echo e(number_format($fundCount ?: 0)); ?>+ research items</strong>
                    ...
                    <div class="hero-card">
                        <div class="market-marquee" aria-hidden="true">
                            <div class="market-track">
                                <?php $__currentLoopData = $heroSignals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $signal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="market-pill"><b><?php echo e($signal['label']); ?></b> <?php echo e($signal['value']); ?></span>
                    ...
                    <div class="hero-floating">
                        <div class="brand-row">
                            <div>
                                ...
                                <div class="brand-name"><?php echo e(data_get($heroFund, 'fund_name', 'Fund market overview')); ?></div>
                            </div>
                            <div class="mini-badge">Live</div>
                        </div>
                        <div class="rowline">
                            <div>
                                <div class="big"><?php echo e(number_format($performanceCount ?: 0)); ?></div>
                        ...
                        <div class="rowline" style="margin-bottom:0;">
                            <div>
                                <div class="big"><?php echo e(number_format($fundCount ?: 0)); ?></div>
                                <div class="small">funds in view</div>
                            </div>
                            <div class="small"><?php echo e(number_format($watchCount ?: 0)); ?> watch items</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="compare-tool-card" data-aos="fade-up" data-aos-duration="900">
                        ...
                        <div class="compare-tool-field">
                            <select aria-label="Daily price compare select">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $fundTypeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e(data_get($fundType, 'ft_id')); ?>"><?php echo e(data_get($fundType, 'name')); ?></option>
                    ...
                    <div class="compare-tool-card" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="compare-tool-field">
                            <select aria-label="Ratio compare select">
                                <option value="" selected>Select An Item</option>
                                <?php $__empty_1 = true; $__currentLoopData = $benchmarkOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benchmark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($benchmark); ?>"><?php echo e($benchmark); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="compare-tool-card" data-aos="fade-up" data-aos-duration="1100">
                        ...
                        <div class="compare-tool-field">
                            <select aria-label="Composition compare select">
                                <option value="" selected>Select An Item</option>
                                <?php $__empty_1 = true; $__currentLoopData = $classificationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="container">
            ...
            <div class="footer-card section-shell">
                ...
                <div class="footer-bottom d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>© <?php echo e(date('Y')); ?> MyPlexus. All rights reserved.</div>
