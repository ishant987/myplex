    ...
    <div class="container">
        <div class="market-hero">
            ...
            <div class="market-window">
                <span class="market-chip">Window: <?php echo e(date('d M Y', strtotime($startDate))); ?> - <?php echo e(date('d M Y', strtotime($endDate))); ?></span>
                <span class="market-chip">Time frame: <?php echo e($timeFrame); ?></span>
                <span class="market-chip">Records: <?php echo e(number_format($summary['total_funds'])); ?></span>
                <span class="market-chip">Updated: <?php echo e(date('d M Y', strtotime($summary['last_updated_at']))); ?></span>
            </div>
            ...
            <div class="mo-toplists">
                <div class="mo-toplist">
                    <h4>Top Gainers</h4>
                    <ol>
                        <?php $__empty_1 = true; $__currentLoopData = $topGainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <?php echo e($item['fund_name']); ?>

                                <small><?php echo e($item['fund_code']); ?> · <?php echo e(number_format($item['change_percent'], 2)); ?>%</small>
                            </li>
                ...
                <div class="mo-toplist">
                    <h4>Top Losers</h4>
                    <ol>
                        <?php $__empty_1 = true; $__currentLoopData = $topLosers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <?php echo e($item['fund_name']); ?>
        ...
        <div class="mo-summary-grid">
            <div class="mo-summary-card">
                ...
                <div class="value"><?php echo e(number_format($summary['total_funds'])); ?></div>
                <div class="subtext">Active records in the filtered set</div>
            </div>
            <div class="mo-summary-card">
                <div class="label">Positive</div>
                <div class="value"><?php echo e(number_format($summary['positive_count'])); ?></div>
                <div class="subtext">Funds moving above the previous NAV</div>
            </div>
            <div class="mo-summary-card">
                <div class="label">Negative</div>
                <div class="value"><?php echo e(number_format($summary['negative_count'])); ?></div>
                <div class="subtext">Funds moving below the previous NAV</div>
            </div>
            <div class="mo-summary-card">
                <div class="label">Flat</div>
                <div class="value"><?php echo e(number_format($summary['flat_count'])); ?></div>
                <div class="subtext">Funds with no movement in the window</div>
            </div>
            <div class="mo-summary-card">
                <div class="label">Average Change</div>
                <div class="value"><?php echo e(number_format($summary['average_change_percent'], 2)); ?>%</div>
                <div class="subtext">Mean change percent across the set</div>
            </div>
            <div class="mo-summary-card">
                <div class="label">Last Updated</div>
                <div class="value" style="font-size: 20px;"><?php echo e(date('d M Y', strtotime($summary['last_updated_at']))); ?></div>
                <div class="subtext">As of the current market window</div>
            </div>
        </div>

        <div class="mo-panel">
            <form method="GET" action="<?php echo e(route('web.market-overview')); ?>">
                <div class="mo-filter-grid">
                    <div class="form-group">
                        <label for="q">Search</label>
                        <input type="text" id="q" name="q" class="form-control" value="<?php echo e($request->input('q')); ?>" placeholder="Fund code, name, classification">
                    </div>
                    <div class="form-group">
                        ...
                        <select id="fund_type_id" name="fund_type_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $fundTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($fundType->ft_id); ?>" @selected((string) $request->input('fund_type_id') === (string) $fundType->ft_id)><?php echo e($fundType->name); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="classification" name="classification" class="form-select">
                            ...
                            <?php $__currentLoopData = $classificationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($option); ?>" @selected($request->input('classification') === $option)><?php echo e($option); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="benchmark" name="benchmark" class="form-select">
                            ...
                            <?php $__currentLoopData = $benchmarkOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($option); ?>" @selected($request->input('benchmark') === $option)><?php echo e($option); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="fund_manager" name="fund_manager" class="form-select">
                            ...
                            <?php $__currentLoopData = $managerOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($option); ?>" @selected($request->input('fund_manager') === $option)><?php echo e($option); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="time_frame" name="time_frame" class="form-select">
                            ...
                            ?>
                            <?php $__currentLoopData = $frames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" @selected($timeFrame === $value)><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="as_on_date">As On</label>
                        <input type="date" id="as_on_date" name="as_on_date" class="form-control" value="<?php echo e($request->input('as_on_date')); ?>">
                    </div>
                    <div class="form-group">
            ...
            <aside class="mo-sidebar">
                <div class="mo-panel">
                    ...
                    <div class="mo-group-list">
                        <?php $__empty_1 = true; $__currentLoopData = $classificationGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="mo-group-card">
                                <div class="topline">
                                    <div>
                                        <div class="name"><?php echo e($group['name']); ?></div>
                                        <div style="color: var(--mo-muted); font-size: 13px;"><?php echo e($group['count']); ?> funds</div>
                                    </div>
                                    <span class="mo-pill <?php echo e($group['average_change_percent'] > 0 ? 'positive' : ($group['average_change_percent'] < 0 ? 'negative' : 'flat')); ?>">
                                        <?php echo e(number_format($group['average_change_percent'], 2)); ?>%
                                    </span>
                                </div>
                                <div class="stats">
                                    <div class="mo-mini">
                                        <span>Total Corpus</span>
                                        <strong><?php echo e(number_format($group['total_corpus'], 2)); ?></strong>
                                    </div>
                                    <div class="mo-mini">
                                        <span>Top Fund</span>
                                        <strong style="display:block; font-size: 13px; line-height: 1.35;"><?php echo e($group['top_fund']['fund_code'] ?? 'N/A'); ?></strong>
                                    </div>
                                    <div class="mo-mini">
                                        <span>Top Change</span>
                                        <strong><?php echo e(isset($group['top_fund']) ? number_format($group['top_fund']['change_percent'], 2) . '%' : '0.00%'); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <main>
                <div class="mo-panel">
                    <div class="mo-section-title">
                        ...
                        <span class="mo-pill neutral"><?php echo e(count($items)); ?> visible funds</span>
                    </div>
                        ...
                        <div class="mo-heatmap-grid">
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button
                                    ...
                                    data-fund-id="<?php echo e($item['fund_id']); ?>"
                                    data-fund-code="<?php echo e($item['fund_code']); ?>"
                                    data-fund-name="<?php echo e(e($item['fund_name'])); ?>"
                                    data-fund-type="<?php echo e(e($item['fund_type_name'])); ?>"
                                    data-classification="<?php echo e(e($item['classification'])); ?>"
                                    data-benchmark="<?php echo e(e($item['benchmark'])); ?>"
                                    data-manager="<?php echo e(e($item['fund_manager'])); ?>"
                                    data-house="<?php echo e(e($item['fund_house'])); ?>"
                                    data-nav="<?php echo e(number_format($item['nav'], 2, '.', '')); ?>"
                                    data-change-amount="<?php echo e(number_format($item['change_amount'], 2, '.', '')); ?>"
                                    data-change-percent="<?php echo e(number_format($item['change_percent'], 2, '.', '')); ?>"
                                    data-corpus="<?php echo e(number_format($item['corpus'], 2, '.', '')); ?>"
                                    data-size-metric="<?php echo e(number_format($item['size_metric'], 2, '.', '')); ?>"
                                    data-updated="<?php echo e($item['last_updated_at']); ?>"
                                    style="min-height: <?php echo e($item['tile_height']); ?>px; background: linear-gradient(180deg, rgba(255,255,255,0.98) 0%, <?php echo e($item['accent_color']); ?> 100%);">

                                    <div class="fund-code"><?php echo e($item['fund_code']); ?></div>
                                    <div class="fund-name"><?php echo e($item['fund_name']); ?></div>
                                    <div class="fund-meta">
                                        <div><strong>Type:</strong> <?php echo e($item['fund_type_name']); ?></div>
                                        <div><strong>Benchmark:</strong> <?php echo e($item['benchmark']); ?></div>
                                        <div><strong>Manager:</strong> <?php echo e($item['fund_manager']); ?></div>
                                    </div>
                                    <div class="metric-row">
                                        <span class="mo-pill <?php echo e($item['heat_class']); ?>">
                                            <?php echo e(number_format($item['change_percent'], 2)); ?>%
                                        </span>
                                        <span class="mo-pill neutral">
                                            NAV <?php echo e(number_format($item['nav'], 2)); ?>

                                        </span>
                                        <span class="mo-pill neutral">
                                            Corpus <?php echo e(number_format($item['corpus'], 2)); ?>
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/market-overview.blade.php ENDPATH**/ ?>