...
<?php echo e(Breadcrumbs::render('missingindices.create')); ?>
   ...
   <div class="col-sm-12">
      <div class="card m-b-0">
         <div class="card-header">
            <h5 class="card-header-text"><?php echo e(__('admin.indices.missing.upld_lbl_txt')); ?></h5>
         </div>
...
<?php endif; ?>
            <form id="upload_bulk_sheet_form" name="upload_bulk_sheet_form" method="post" action="<?php echo e(route('admin.missing-indices.store')); ?>" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/indices/missing-createform.blade.php ENDPATH**/ ?>