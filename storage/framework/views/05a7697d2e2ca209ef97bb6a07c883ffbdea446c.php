...
<?php echo e(Breadcrumbs::render('faq.create')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5 class="card-header-text"><?php echo e(__('faq.add_txt')); ?></h5>
      </div>
...
<?php endif; ?>
        ...
        <form name="aeDataFrm" id="aeDataFrm" action="<?php echo e(route('admin.faq.store')); ?>" method="POST">
...
<?php endif; ?>
          ...
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => ''.e(__('admin.category_txt')).'','for' => 'cc_id','error' => ''.e($errors->first('cc_id')).'','required' => 'true']]); ?>
<?php $component->withName('form.group_lyt1_2_10'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => ''.e(__('admin.category_txt')).'','for' => 'cc_id','error' => ''.e($errors->first('cc_id')).'','required' => 'true']); ?>
            <select id="cc_id" class="form-control" name="cc_id">
              <option value=""><?php echo e(__('admin.def_drop_optn_styl1_txt')); ?></option>
              <?php $__currentLoopData = $categoryArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $optTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($value); ?>" <?php echo e(( $value == old('cc_id') ) ? 'selected' : ''); ?>><?php echo e($optTitle); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/faq/createform.blade.php ENDPATH**/ ?>