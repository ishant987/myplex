...
<?php echo e(Breadcrumbs::render('indices-comp.list')); ?>
    ...
    <div class="col-sm-12">
        <div class="card m-b-0">
            <div class="card-header">
                <h5><?php echo e(__('admin.indices.comp.list_label_txt')); ?></h5>
                <div class="c-f-btns">
                    <div class="c-f-b-f">
                        <!-- Filter -->
...
<?php endif; ?>
                    ...
                    <div class="c-f-b-r">
                        ...
                        <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.indices-comp.delete')); ?>">
...
<?php endif; ?>
                <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form id="filterForm" name="filterForm" method="get" action="<?php echo e(route('admin.indices-comp.list')); ?>">
                    ...
                    <table class="table table-striped table-bordered nowrap">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e($sortbyArr['indices_name']); ?></th>
                                ...
                                <th class="cc-w-80"><?php echo e($sortbyArr['percentage']); ?></th>
...
<?php endif; ?>
                                ...
                                <td>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'fin','name' => 'fin','value' => ''.e($fltrDataArr['indices_name'] ?? '').'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'fin','name' => 'fin','value' => ''.e($fltrDataArr['indices_name'] ?? '').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                            ...
                            <tr role="row" class="">
                                ...
                                <td><?php echo e($record->indices_name); ?></td>
...
<script>
    ...
    function filter() {
        ...
        var ftrFinVlu = document.getElementById("fin").value;
        if (ftrFinVlu != "") {
            searchPagiData = searchPagiData + "&fin=" + ftrFinVlu.replace("&", "_");
        }
        ...
        window.location.href = "<?php echo e(route('admin.indices-comp.list')); ?>" + "?page=0" + searchPagiData + "&ppage=" + "<?php echo e($perPage); ?>";
        return false;
    }
    /*Reset Filter*/
    function resetfilter() {
        window.location.href = "<?php echo e(route('admin.indices-comp.list')); ?>";
    }
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/indices/comp-list.blade.php ENDPATH**/ ?>