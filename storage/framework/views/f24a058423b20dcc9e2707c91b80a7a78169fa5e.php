...
document.addEventListener('DOMContentLoaded', function() {
    ...
    exportButton.addEventListener('click', function() {
        ...
        img.onload = function() {
            ...
            <?php if(isset($month) && isset($month_second) && isset($year) && isset($year_second)): ?>
                var scripsBoomersText = `Boomers: For the month of <?php echo e(date('F', mktime(0, 0, 0, $month, 10))); ?>, <?php echo e($year); ?> to <?php echo e(date('F', mktime(0, 0, 0, $month_second, 10))); ?>, <?php echo e($year_second); ?>`;
...
<?php echo $__env->make('web.layout.infosolz_user_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/composition_report/busters.blade.php ENDPATH**/ ?>