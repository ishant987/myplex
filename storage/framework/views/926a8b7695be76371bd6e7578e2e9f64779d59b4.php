...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.currency.update', $dataArr->cm_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.currency.url_txt')).'','for' => 'currency_url','error' => ''.e($errors->first('currency_url')).'','required' => 'true']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'currency_url','name' => 'currency_url','value' => ''.e($dataArr->currencycor->cor).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'currency_url','name' => 'currency_url','value' => ''.e($dataArr->currencycor->cor).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/currency/updateform.blade.php ENDPATH**/ ?>