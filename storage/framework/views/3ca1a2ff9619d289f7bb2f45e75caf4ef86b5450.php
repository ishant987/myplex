            ...
            <div class="inner_padding">
                ...
                <div class="new_page">
                    ...
                    <div class="light_green_bg">
                        <form action="<?php echo e(route('user.filters.jensens')); ?>" method="GET">
                    ...
                    <?php elseif(!empty($fund_series) || !empty($index_series)): ?>
                        <div class="graph_section">
                            <div id="jensens-chart" style="width: 100%; min-height: 420px;"></div>
                        </div>
                    <?php else: ?>
                        <div class="graph_table">
    ...
    <?php if(!empty($fund_series) || !empty($index_series)): ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                Highcharts.chart('jensens-chart', {
                    chart: {
                        type: 'spline',
                        zoomType: 'x'
                    },
...
<?php echo $__env->make('web.layout.infosolz_user_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/filters/jensens.blade.php ENDPATH**/ ?>