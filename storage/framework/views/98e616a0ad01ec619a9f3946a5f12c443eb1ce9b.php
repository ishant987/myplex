...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.currency.values.update')); ?>" method="POST">
          ...
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => ''.e(__('admin.save_values_date_txt')).'','for' => 'entry_date','error' => ''.e($errors->first('entry_date')).'','required' => 'true']]); ?>
...
<?php endif; ?>
          ...
          <div class="form-group has-primary row">
            <label class="col-sm-2 col-form-label"><?php echo e(__('admin.currency.last_save_txt')); ?></label>
            <div class="col-sm-10">
              <div class="col-form-label"><?php echo e($otherData['last_saved_cur']); ?></div>
            </div>
          </div>
...
<?php $component->withAttributes([]); ?>
            <?php echo e(__('admin.currency.all_txt')); ?>
...
<?php endif; ?>
          ...
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => ''.e($record->name).'']]); ?>
<?php $component->withName('form.group_lyt1_2_10'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => ''.e($record->name).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'entry_value_'.e($record->cm_id).'','name' => 'entry_value['.e($record->cm_id).']','value' => ''.e($record->entry_value).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'entry_value_'.e($record->cm_id).'','name' => 'entry_value['.e($record->cm_id).']','value' => ''.e($record->entry_value).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/currency/daily-values.blade.php ENDPATH**/ ?>