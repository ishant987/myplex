...
<?php echo e(Breadcrumbs::render('subscribeduser.create')); ?>
   ...
   <div class="col-sm-12">
      <div class="card m-b-0">
         <div class="card-header">
            <h5 class="card-header-text"><?php echo e(__('subscribeduser.add_txt')); ?></h5>
         </div>
...
<?php endif; ?>
            <form name="aeUsrFrm" id="aeUsrFrm" action="<?php echo e(route('admin.subscribeduser.store')); ?>" method="POST">
               <?php echo e(csrf_field()); ?>

               <div class="row">
                  <div class="col-lg-6 col-md-12">
                     <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link','data' => ['url' => ''.e(route('admin.subscribeduser.createmanual')).'','class' => 'btn btn-success waves-effect waves-light btn-block']]); ?>
<?php $component->withName('link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.subscribeduser.createmanual')).'','class' => 'btn btn-success waves-effect waves-light btn-block']); ?>
...
<?php $component->withAttributes([]); ?>
   <div class="modal-content">
      <div class="modal-header">
         <h4 class="modal-title"><?php echo e(__('subscribeduser.bulk_upload_hdng')); ?></h4>
         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
      ...
      <form id="upload_user_sheet_form" name="upload_user_sheet_form" method="post" action="<?php echo e(route('admin.subscribeduser.uploadfile')); ?>" enctype="multipart/form-data">
         <?php echo e(csrf_field()); ?>
               ...
               <div class="m-t-10">
                  ...
                  <span class="help-block">
                     <i>
                        <b>
                           <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link','data' => ['url' => ''.e(asset('themes/backend/assets/formats/registration-user-data-myplexus.xlsx')).'','class' => 'text-right f-w-600','target' => '_blank']]); ?>
<?php $component->withName('link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(asset('themes/backend/assets/formats/registration-user-data-myplexus.xlsx')).'','class' => 'text-right f-w-600','target' => '_blank']); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/subscribeduser/createform.blade.php ENDPATH**/ ?>