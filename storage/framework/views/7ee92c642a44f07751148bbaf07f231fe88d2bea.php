...
<section class="inner-top">
    ...
    <div class="container">
        <h3 class="report-sub-heading">Report : Jensen's Alpha</h3>
        <form id="myForm">
            <div class="top-form">
                <div class="row">
                        ...
                        <table class="table table-bordered result-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Risk Free</th>
                                    <th style="text-align: center">Beta</th>
                                    <th style="text-align: center">Jensen's Alpha</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center"><?php echo e($risk_free); ?></td>
                                    <td align="center"><?php echo e($beta); ?></td>
                                    <td align="center"><?php echo e($jensens_alpha); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('web.layout.infosolz_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/infosolz-calculator/jensens_alpha.blade.php ENDPATH**/ ?>