...
<section class="inner-top">
    ...
    <div class="container">
        <h3 class="report-sub-heading">Report : Kurtosis</h3>
        <form id="myForm">
            <div class="top-form">
                <div class="row">
        ...
        <?php if(isset($skewness) &&
            isset($excess_kurtosis) &&
            isset($kurtosis)): ?>
            <div class="row">
                        ...
                        <table class="table table-bordered result-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Excess kurtosis</th>
                            ...
                            <tbody>
                                <tr>
                                    <td align="center"><?php echo e($skewness); ?></td>
                                    <td align="center"><?php echo e($excess_kurtosis); ?></td>
                                    <td align="center"><?php echo e($kurtosis); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('web.layout.infosolz_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/infosolz-calculator/kurtosis.blade.php ENDPATH**/ ?>