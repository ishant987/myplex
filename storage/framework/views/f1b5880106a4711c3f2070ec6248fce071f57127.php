...
<?php echo e(Breadcrumbs::render('page.index')); ?> 
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('admin.page.all_txt')); ?></h5>
        <?php if($roleRights['add']): ?>
          <!-- Add New -->
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_add_new','data' => ['url' => ''.e(route('admin.page.create.custom')).'']]); ?>
<?php $component->withName('link_add_new'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.page.create.custom')).'']); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
       <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.deletepage')); ?>">
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <th class="cc-w-150"><?php echo e(__('admin.template_txt')); ?></th>
            ...
            <?php if( count($dataListModel) > 0 ): ?>       
              ...
              <tr role="row" class="">
                <?php if($roleRights['delete']): ?>
                  <td class="sorting_<?php echo e($record->page_id); ?>">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.checkbox','data' => ['style' => 'default','name' => 'checkbox[]','value' => ''.e($record->page_id).'','fldclass' => 'del-chkbx']]); ?>
<?php $component->withName('form.field.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['style' => 'default','name' => 'checkbox[]','value' => ''.e($record->page_id).'','fldclass' => 'del-chkbx']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
              ...
              <td>
                <?php if($roleRights['edit']): ?>
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.e(route('admin.page.edit.custom', [$record->page_id, $record->template_id])).'','title' => ''.e($record->note != '' ? $record->note : $listDataAtrArr['edit_txt']).'']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.page.edit.custom', [$record->page_id, $record->template_id])).'','title' => ''.e($record->note != '' ? $record->note : $listDataAtrArr['edit_txt']).'']); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if( $moduleAtrArr['flds_hide']['parent'] == $moduleAtrArr['bool_false'] ): ?>
                  <td><?php echo e($record->parentpage != null ? $record->parentpage->title : ''); ?></td>
                <?php endif; ?>
                <td><?php echo e($record->template != null ? $record->template->title : ''); ?></td>
                <?php if( $moduleAtrArr['flds_hide']['c_order'] == $moduleAtrArr['bool_false'] ): ?>
                  <td><?php echo e($record->c_order > 0 ? $record->c_order : ''); ?></td>
                <?php endif; ?>
                <td>
                  <?php if($roleRights['edit']): ?>
                    <label id="change_status<?php echo e($record->page_id); ?>" onclick="return changeStatus('page_id', <?php echo e($record->page_id); ?>, 'pages', <?php echo e($record->status); ?>, '<?php echo e($statusAtrArr['status_type']); ?>');" class="label btn-<?php echo e($listDataAtrArr['alert_css'][$record->status]); ?>"><?php echo e($statusAtrArr['label'][$record->status]); ?></label>
                  <?php else: ?>
                    <label id="change_status<?php echo e($record->page_id); ?>" class="label btn-<?php echo e($listDataAtrArr['alert_css'][$record->status]); ?> no-drop"><?php echo e($statusAtrArr['label'][$record->status]); ?></label>
                  <?php endif; ?>                                   
                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/page/index.blade.php ENDPATH**/ ?>