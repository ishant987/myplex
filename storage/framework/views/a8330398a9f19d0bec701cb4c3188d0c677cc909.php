...
<section class="stock-heatmap-shell">
    <div class="container-fluid px-3 px-xl-4">
        <div class="stock-heatmap-head">
            ...
            <div class="actions">
                <a href="<?php echo e($overviewUrl); ?>" class="mh-pill">Open classic overview</a>
                <a href="<?php echo e($heatmapUrl); ?>?<?php echo e(http_build_query(array_merge($currentParams, ['time_frame' => 'ALL']))); ?>" class="mh-pill <?php echo e($timeFrame === 'ALL' ? 'active' : ''); ?>">All data</a>
            </div>
        </div>
        ...
        <div class="mh-subtle-bar">
            <div class="mh-subtle-chip">Window: <?php echo e($startDate); ?> to <?php echo e($endDate); ?></div>
            <div class="mh-subtle-chip">Funds: <?php echo e(number_format($summary['total_funds'])); ?></div>
            <div class="mh-subtle-chip">Positive: <?php echo e(number_format($summary['positive_count'])); ?></div>
            <div class="mh-subtle-chip">Negative: <?php echo e(number_format($summary['negative_count'])); ?></div>
            <div class="mh-subtle-chip">Average: <?php echo e(number_format($summary['average_change_percent'], 2)); ?>%</div>
        </div>
        ...
        <div class="mh-classify-strip">
            ...
            ?>
            <a href="<?php echo e($allClassUrl); ?>" class="mh-classify-tab <?php echo e($selectedClassification === '' ? 'active' : ''); ?>">
                <span class="name">All Funds</span>
                <span class="count"><?php echo e(number_format(count($items))); ?></span>
            </a>
            <?php $__currentLoopData = $dataArr['classification_options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <a href="<?php echo e($tabUrl); ?>" class="mh-classify-tab <?php echo e($selectedClassification === $option ? 'active' : ''); ?>">
                    <span class="name"><?php echo e($option); ?></span>
                    <span class="count"><?php echo e(number_format((int) ($tabGroup['count'] ?? 0))); ?></span>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div class="mh-filter-bar">
            <form method="GET" action="<?php echo e($heatmapUrl); ?>">
                <input type="hidden" name="time_frame" value="<?php echo e($timeFrame); ?>">
                <div class="row g-3 align-items-end">
                    <div class="col-12 col-lg-3">
                        <label for="q">Search</label>
                        <input type="text" name="q" id="q" class="form-control" value="<?php echo e($request->input('q')); ?>" placeholder="Fund code, name, classification">
                    </div>
                    ...
                    <div class="col-6 col-lg-2">
                        ...
                        <select id="fund_manager" name="fund_manager" class="form-select">
                            <option value="">All</option>
                            <?php $__currentLoopData = $dataArr['manager_options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                <div class="mh-panel">
                    <div class="mh-panel-head">
                        ...
                        <p>
                            <?php if($selectedClassification !== ''): ?>
                                Showing <strong style="color:#172033;"><?php echo e($selectedClassification); ?></strong>
                            <?php else: ?>
                                Showing the full market universe
                            <?php endif; ?>
                            · selected fund: <span id="selectedFundName"><?php echo e($selectedFund['fund_name'] ?? 'No funds found'); ?></span>
                        </p>
                    </div>
                    ...
                    <div class="mh-chart-meta">
                        <div class="mh-mini">
                            ...
                            <div class="value" id="selectedNav"><?php echo e($selectedFund ? number_format((float) $selectedFund['nav'], 2) : '0.00'); ?></div>
                            <div class="sub" id="selectedCode"><?php echo e($selectedFund['classification'] ?? '-'); ?></div>
                        </div>
                        <div class="mh-mini">
                            <div class="label">Change</div>
                            <div class="value <?php echo e(($selectedFund['change_percent'] ?? 0) >= 0 ? 'positive' : 'negative'); ?>" id="selectedChange">
                                <?php echo e($selectedFund ? number_format((float) $selectedFund['change_amount'], 2) . ' / ' . number_format((float) $selectedFund['change_percent'], 2) . '%' : '0.00'); ?>
                        ...
                        <div class="mh-mini">
                            ...
                            <div class="value"><?php echo e($selectedFund ? number_format((float) $selectedFund['corpus'], 2) : '0.00'); ?></div>
                            <div class="sub"><?php echo e($selectedFund['fund_type_name'] ?? 'Unclassified'); ?></div>
                        </div>
                        <div class="mh-mini">
                            <div class="label">Last Update</div>
                            <div class="value" style="font-size: 19px;"><?php echo e($selectedFund['last_updated_at'] ?? $endDate); ?></div>
                            <div class="sub"><?php echo e($selectedFund['fund_house'] ?? 'MyPlex data'); ?></div>
                        </div>
                    </div>

                    <div class="mh-time-tabs">
                        <?php $__currentLoopData = $timeFrames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <a href="<?php echo e($frameUrl); ?>" class="<?php echo e($timeFrame === $frame['value'] ? 'active' : ''); ?>"><?php echo e($frame['label']); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

                    <div class="mh-list" id="fundList">
                        <?php $__empty_1 = true; $__currentLoopData = $featuredFunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <button
                                ...
                                data-fund-code="<?php echo e($fund['fund_code']); ?>"
                                data-fund-name="<?php echo e(e($fund['fund_name'])); ?>"
                                data-fund-code-label="<?php echo e(e($fund['classification'])); ?>"
                                data-nav="<?php echo e(number_format((float) $fund['nav'], 2)); ?>"
                                data-change="<?php echo e(number_format((float) $fund['change_amount'], 2)); ?> / <?php echo e(number_format((float) $fund['change_percent'], 2)); ?>%"
                                data-history='<?php echo json_encode($fund["history"], 15, 512) ?>'
                            >
                                <div class="mh-avatar"><?php echo e($initials ?: substr($fund['fund_code'], 0, 2)); ?></div>
                                <div>
                                    <div class="name"><?php echo e($fund['fund_name']); ?> <span style="color: #b26f00; font-size: 13px;"><?php echo e($fund['fund_type_name'] !== 'Unclassified' ? '• ' . $fund['fund_type_name'] : ''); ?></span></div>
                                    <div class="meta">
                                        <span><?php echo e($fund['fund_house']); ?></span>
                                        <span><?php echo e($fund['classification']); ?></span>
                                    </div>
                                </div>
                                <div class="metric">
                                    <div class="nav"><?php echo e(number_format((float) $fund['nav'], 2)); ?></div>
                                    <div class="chg <?php echo e($changeClass); ?>">
                                        <?php echo e($fund['change_percent'] > 0 ? '+' : ''); ?><?php echo e(number_format((float) $fund['change_percent'], 2)); ?>%
                                    </div>
                                </div>
                            </button>
                ...
                <div class="mh-note">
                    <strong style="color:#172033;">Disclaimer:</strong> <?php echo e($disclaimer); ?>
...
<script>
    (function () {
        ...
        const heatmapGroups = <?php echo json_encode($heatmapGroups, 15, 512) ?>;
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/stock-heatmap.blade.php ENDPATH**/ ?>