            ...
            <ul class="nav nav-pills filter_tab mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation"><button class="nav-link active show" id="pills-monthly-tab1"
                        ...
                        aria-controls="pills-monthly1" aria-selected="false"><img
                            src="https://new.myplexus.com/themes/frontend/assets/v1/img/tab_icon_cal1.png"> SIP Planner
                    </button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" id="pills-weekly-tab1"
                        ...
                        aria-controls="pills-weekly1" aria-selected="false"><img
                            src="https://new.myplexus.com/themes/frontend/assets/v1/img/tab_icon_cal.png"> Lumpsum
                        Planner </button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" id="pills-monthly-tab3"
                        ...
                        aria-controls="pills-monthly3" aria-selected="true"><img
                            src="https://new.myplexus.com/themes/frontend/assets/v1/img/tab_icon_cal3.png"> Retirement
                        Planner </button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" id="pills-monthly-tab4"
                        ...
                        aria-controls="pills-monthly4" aria-selected="false"><img
                            src="https://new.myplexus.com/themes/frontend/assets/v1/img/tab_icon_cal4.png"> Risk
                ...
                <li class="nav-item" role="presentation"><button class="nav-link" id="pills-monthly-tab2"
                        ...
                        aria-controls="pills-monthly2" aria-selected="false"><img
                            src="https://new.myplexus.com/themes/frontend/assets/v1/img/tab_icon_cal2.png"> Inflation
				...
				<li class="nav-item" role="presentation"><button class="nav-link" id="pills-goal-tab1"
                        ...
                        aria-controls="pills-goal1" aria-selected="false"><img
                            src="https://new.myplexus.com/themes/frontend/assets/v1/img/tab_icon_cal2.png"> Goal Planner </button></li>
            </ul>
					  ...
					  <div class="comp_schem_bdr">
                                        <div class="s_renge p-0">
                                            <div class="row calbanner">
                                                ...
                                                <div class="r"><img
                                                        src="https://new.myplexus.com/themes/frontend/assets/v1/img/retirementcalculator.png">
                                                </div>
                                            </div>
                    ...
                    <div class="comp_schem_bdr">
						<div class="s_renge p-0">
							<div class="row calbanner">
                                ...
                                <div class="r"><img
                                        src="https://new.myplexus.com/themes/frontend/assets/v1/img/InflationCalculator.png">
                                </div>
                            </div>
							 <div class="row">
                    ...
                    <div class="comp_schem_bdr">
						<div class="s_renge p-0">
							 <div class="row calbanner">
                                ...
                                <div class="r"><img
                                        src="https://new.myplexus.com/themes/frontend/assets/v1/img/SIPCalculator,.png">
                                </div>
                            </div>
							 <div class="row">
                                <div class="col-md-12 left-side">
                    ...
                    <div class="comp_schem_bdr">
                        <div class="s_renge sip_calc_range_grop p-0">
                            <div class="row calbanner">
                                ...
                                <div class="r"><img
                                        src="https://new.myplexus.com/themes/frontend/assets/v1/img/cal-1.png"></div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 left-side">
                                    <form id="sipcalc">
                                    ...
                                    <div class="comp_schem_bdr">
                                        <div class="s_renge risk_tolarance_evaliator p-0">
                                            <div class="row calbanner">
                                                ...
                                                <div class="r"><img
                                                        src="https://new.myplexus.com/themes/frontend/assets/v1/img/RiskAppetiteCalculator,.png">
                                                </div>
                                            </div>
...
<script>
    ...
    monthlyTab1.addEventListener('click', function(e) {
      e.preventDefault();
      window.location.href = 'https://new.myplexus.com/calculator?cal=risk';
    });
  }

        });
    </script>
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/pages/calculatortest.blade.php ENDPATH**/ ?>