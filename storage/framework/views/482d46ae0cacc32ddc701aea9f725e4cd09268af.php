...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%;max-width: 840px;margin: 15px auto;padding: 20px;border: 1px solid #efefef;">
    ...
    <tr>
        <td style="padding:5px 15px;"><p style="text-align:left; color:#4a4a4a; font-size:12px; margin:0; padding:0px 0;">
            User Name : <span style="color:#156db9;"><?php echo e($email); ?></span></p></td>
    </tr>
    <tr>
        <td style="padding:5px 15px;"><p style="text-align:left; color:#4a4a4a; font-size:12px; margin:0; padding:0px 0;">
            Password : <?php echo e($password); ?></p></td>
    </tr>
    <tr>
        <td style="padding:5px 15px;">
            <p style="text-align:left; color:#4a4a4a; font-size:12px; margin:0; padding:0px 0;">
                ...
                <a href="https://myplexus.com/verify-email/<?php echo e($id); ?>"> Verify</a>
                <br>
                or copy/paste the URL below into your browser:<br>
            
                <span>https://myplexus.com/verify-email/<?php echo e($id); ?></span>
    ...
    <tr>
        <td style="padding:20px 0; text-align: left;">
            ...
            <p style="color:#4a4a4a;  font-size:12px; margin:0; padding:0px 0;">Myplexus<br><?php echo e(date("d-m-Y",strtotime($date))); ?></p>
        </td>
    </tr>
    <tr>
        <td style="background-color: #022a5b; padding:6px 0;">
            <p style="color:#fff; font-family:Verdana, Geneva, sans-serif; text-align:center; font-size:11px;">© <?php echo e(date("Y",strtotime($date))); ?> by Myplexus. All Rights Reserved</p>
        </td>
    </tr>
</table>
...
<?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web-old/auth/email/registration_email.blade.php ENDPATH**/ ?>