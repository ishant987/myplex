                ...
                <div class="row all_tables"  id="pdfData">
                    ...
                    <div class="col-md-4">
                        <div class="graph_table green_bg">
                            <h4><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/icon1.png')); ?>" alt=""><?php if($i==1): ?><?php echo e(' BSE Index'); ?><?php elseif($i==2): ?><?php echo e(' NSE Index'); ?><?php else: ?><?php echo e(' Global & Sectoral Index'); ?><?php endif; ?></h4>
                    ...
                    <div class="col-md-4">
                        ...
                        <h4><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/icon2.png')); ?>" alt=""> Currency Changes</h4>
                    ...
                    <div class="col-md-4">
                        ...
                        <h4><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/icon3.png')); ?>" alt=""> Commodity Changes</h4>
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    <th>Commodity </th>
                    ...
                    <div class="col-md-12">
                        ...
                        <h4><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/icon4.png')); ?>" alt=""> Percentage Change by Category of Funds(Returns)</h4>
                        <div class="">
                        <table class="table datatable">
                            <thead>
                                <tr>
                    ...
                    <div class="col-md-12">
                        ...
                        <h4><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/icon5.png')); ?>" alt=""> 10 Best Performing Schemes</h4>
                        <div class="">
                        <table class="table datatable">
                            <thead>
                                <tr>
