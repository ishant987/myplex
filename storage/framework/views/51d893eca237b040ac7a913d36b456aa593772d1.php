                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form_group">
                                                <input type="date" name="from_date" class="form-control"
                                                    value="<?php echo e(!empty($request['from_date']) ? \Carbon\Carbon::parse($request['from_date'])->format('Y-m-d') : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label>To date</label>
                                            <div class="form_group">
                                                <input type="date" name="to_date" class="form-control"
                                                    value="<?php echo e(!empty($request['to_date']) ? \Carbon\Carbon::parse($request['to_date'])->format('Y-m-d') : ''); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
