...
<?php echo e(Breadcrumbs::render('aums.list')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('admin.fund.aums.list_label_txt')); ?></h5>
        <div class="c-f-btns">
          <div class="c-f-b-f">
            <!-- Filter -->
...
<?php endif; ?>
          ...
          <div class="c-f-b-r">
            ...
            <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.aums.delete')); ?>">
...
<?php endif; ?>
        <div class="dataTables_wrapper dt-bootstrap4 no-footer">
          <form id="filterForm" name="filterForm" method="get" action="<?php echo e(route('admin.aums.list')); ?>">
          ...
          <table class="table table-striped table-bordered nowrap">
            <thead>
              <tr>
                ...
                <th class="cc-w-125"><?php echo e($sortbyArr['corpus_entry']); ?></th>
                <th class="cc-w-125"><?php echo e($sortbyArr['percentage_change']); ?></th>
                <th class="cc-w-80"><?php echo e($sortbyArr['corpus_change']); ?></th>
...
<?php endif; ?>
              ...
              <tr role="row" class="">
                ...
                <td><?php echo e($record->corpus_entry); ?></td>
                <td><?php echo e($record->percentage_change); ?></td>
                <td><?php echo e($record->corpus_change); ?></td>
...
<script>
  ...
  function filter() {
    ...
    window.location.href = "<?php echo e(route('admin.aums.list')); ?>" + "?page=0" + searchPagiData + "&ppage=" + "<?php echo e($perPage); ?>";
    return false;
  }
  /*Reset Filter*/
  function resetfilter() {
    window.location.href = "<?php echo e(route('admin.aums.list')); ?>";
  }
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fund/aum-list.blade.php ENDPATH**/ ?>