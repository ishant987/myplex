...
<section class="inner-top">
    ...
    <div class="container">
        <h3 class="report-sub-heading">Report : R Squere</h3>
        <form id="myForm">
            <div class="top-form">
                <div class="row">
                        ...
                        <table class="table table-bordered result-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">R Squere</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center"><?php echo e($correlation); ?></td>
                                    <td align="center"><?php echo e($r_squere); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('web.layout.infosolz_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/infosolz-calculator/r_squere.blade.php ENDPATH**/ ?>