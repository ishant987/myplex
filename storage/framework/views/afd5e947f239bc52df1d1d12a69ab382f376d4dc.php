...
<?php endif; ?>
        <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.navs.values.update')); ?>">
            ...
            <table id="dom-jqry-all" class="table table-striped table-bordered nowrap">
              <thead>
                <tr>
                  ...
                  <th><?php echo e(__('admin.fund.corelation_txt')); ?></th>
                  <th class="cc-w-150"><?php echo e(__('admin.fund.code_txt')); ?></th>
                  <th class="cc-w-95"><?php echo e(__('admin.fund.nav.label_readonly_txt')); ?></th>
                  <th class="cc-w-95 no-sort"><?php echo e(__('admin.fund.nav.label_txt')); ?></th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr role="row" class="<?php echo e($record->last_nav == 'NA'?'no-record':''); ?>">
                  <td><?php echo e($record->fund_name); ?></td>
                  <td><?php echo e($record->cor); ?></td>
                  <td><?php echo e($record->fund_code); ?></td>
                  <td><?php echo e($record->last_nav != '' ? $record->last_nav : 0); ?></td>
                  <td>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'nav_'.e($loop->iteration).'','name' => 'nav['.e($record->fund_code).']','value' => ''.e($record->last_nav != '' ? $record->last_nav : 0).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'nav_'.e($loop->iteration).'','name' => 'nav['.e($record->fund_code).']','value' => ''.e($record->last_nav != '' ? $record->last_nav : 0).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<script>
  $(function() {
    $("#entry_date[value='']").datepicker("setDate", "-1d");
  });
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fund/navuploadedlist.blade.php ENDPATH**/ ?>