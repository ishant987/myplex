    ...
    <html lang="en">
        ...
        <header class="head">
                ...
                <nav class="left_menu same_height">
                    ...
                    <?php else: ?>
                    <ul class="menu-main">
                        <li class="<?php echo e(request()->routeIs('user.ratio_dashboard', 'user.quick_ratio', 'user.weekly_snapshot*', 'user.monthly_snapshot*', 'user.fund_factsheet', 'user.performance_ratios', 'user.stats', 'user.quartile_decile', 'user.comparative', 'user.r_square_comparison') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.ratio_dashboard')); ?>"><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/ratop_report.png')); ?>" alt="">Ratio Reports</a></li>
                        <li class="<?php echo e(request()->routeIs('user.ratio_analysis', 'user.risk_ratio', 'user.return_ratio', 'user.sortino_ratio') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.ratio_analysis')); ?>"><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/ratio_ana.png')); ?>" alt=""> Ratio Analysis</a></li>
                        <li class="<?php echo e(request()->routeIs('user.composition_report', 'user.allocation_snapshot', 'user.scheme_portfolio', 'user.occurrence_report', 'user.top_script_rop_industry', 'user.new_script_new_industry', 'user.boomers', 'user.busters') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.composition_report')); ?>"><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/compos.png')); ?>" alt="">Composition Report</a></li>
                        <li class="<?php echo e(request()->routeIs('user.indies_report', 'user.indices_report', 'user.indices-history', 'user.indices-composition', 'user.schemes-associated-with-index', 'user.indices-report.*', 'user.index_vs_NAV') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.indies_report')); ?>"><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/indies.png')); ?>" alt="">Indices Report</a></li>
                        ...
                        <li class="<?php echo e(request()->routeIs('user.filters', 'user.filters.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.filters')); ?>"><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/filter.png')); ?>" alt="">Filters</a></li>
                        <li class="<?php echo e(request()->routeIs('user.predictive', 'user.predictive.*') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.predictive')); ?>"><img src="<?php echo e(asset('themes/frontend/assets/infosolz/images/predic.png')); ?>" alt="">Predictive</a></li>
                    </ul>
                    <ul class="menu-bottom">
