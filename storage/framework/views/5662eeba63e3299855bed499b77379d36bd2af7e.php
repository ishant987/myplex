...
<div class="row dshbrd-qck-bx">
    <?php $__currentLoopData = $subscriptionStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-xl-3 col-md-6 p-r-0">
        <div class="card m-b-10">
            <div class="card-block">
                <div class="row align-items-center m-l-0">
                    ...
                    <div class="col-auto">
                        <h6 class="text-muted m-b-10"><?php echo e($stat['title']); ?></h6>
                        <h2 class="m-b-0"><?php echo e($stat['total']); ?></h2>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/dashboard.blade.php ENDPATH**/ ?>