                                ...
                                <div class="calculator_inner d-md-flex d-block align-items-center-between justify-content-center w-100">
                                    <div class="single_calculator">
                                        ...
                                        <div data-aos="zoom-in" data-aos-duration="500">
                                            <a href="https://new.myplexus.com/calctest?cal=sip">
                                    ...
                                    <div class="single_calculator have_before">
                                        ...
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="https://new.myplexus.com/calctest?cal=lump">
                                    ...
                                    <div class="single_calculator have_before">
                                        ...
                                        <span class="right_circle d-none d-sm-block"></span>
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="https://new.myplexus.com/calctest?cal=retire">
                                    ...
                                    <div class="single_calculator have_before">
										...
										<span class="right_circle d-none d-sm-block"></span>
                                        <div data-aos="zoom-in" data-aos-duration="1000">
                                            <a href="https://new.myplexus.com/calctest?cal=inflation">
									...
									<div class="single_calculator have_before">
                                        <span class="left_circle d-none d-sm-block"></span>
                                        <div data-aos="zoom-in" data-aos-duration="500">
                                            <a href="https://new.myplexus.com/calctest?cal=pills-goal1">
                                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/calculator-icon2.png')); ?>" />
                                                <h4>Goal Planner</h4>
                                            </a>
                                        </div>
...
<section class="money_seriously_section fund_watch_setion_home section">
    <div class="container">
        ...
        <div class="row align-items-center">
				...
				<div class="col-md-6 mb-4" data-aos="fade-up" data-aos-duration="500">
					<div class="money_left_sec">
						<div class="fund_watch_home_sec_single_img">
							<img src="<?php echo e(asset('themes/frontend/assets/v1/img/nippon.jpg')); ?>" />
						</div>
					</div>
					<div class="money_right_section">
						<?php
                         ...
                         ?>
						<h4><a href="<?php echo e(route('web.fundwatch.index', $fid )); ?>" target="_blank"><?php echo e($fndWtchMdl[0]->title); ?></a></h4>
				...
				<div class="col-md-6 mb-4" data-aos="fade-up" data-aos-duration="1000">
					...
					<div class="money_right_section">
						<?php
                         ...
                         ?>
						<h4><a href="<?php echo e(route('web.fundwatch.index', $sid )); ?>" target="_blank"><?php echo e($fndWtchMdl[1]->title); ?></a></h4>
						<!--<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
							the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
							of type and scrambled it to make a type specimen book.</p>
						<a href="#">View More Details</a>-->
			...
			<?php endif; ?>
			<div class="col-md-12 text-center">
                <a href="/fund-watch" class="money_title_btn type2">View More</a>
            </div>
        </div>
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/home/index.blade.php ENDPATH**/ ?>