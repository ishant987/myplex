...
<?php echo e(Breadcrumbs::render('newsletter.index')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('admin.newsletter.all_txt')); ?></h5>
        <div class="c-f-btns">
          <div class="c-f-b-f">
            <!-- Filter -->
...
<?php endif; ?>
            ...
            <!-- Export -->
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.route('admin.newsletter.export',$exportDataArr).'','class' => 'btn waves-effect waves-light btn-sm f-right btn-success','title' => ''.e(__('admin.export_txt')).'']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.route('admin.newsletter.export',$exportDataArr).'','class' => 'btn waves-effect waves-light btn-sm f-right btn-success','title' => ''.e(__('admin.export_txt')).'']); ?>
...
<?php endif; ?>
        <div class="dataTables_wrapper dt-bootstrap4 no-footer">
          <form id="filterForm" name="filterForm" method="get" action="<?php echo e(route('admin.newsletter.index')); ?>">
        ...
        <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.newsletter.delete')); ?>">
...
<?php endif; ?>
                ...
                <?php else: ?>
                <tr>
                  <td colspan="3"><?php echo e(__('message.data_not_available')); ?></td>
                </tr>
                <?php endif; ?>
              </tbody>
            </table>
...
<script>
  ...
  function filter() {
    ...
    window.location.href = "<?php echo e(route('admin.newsletter.index')); ?>" + "?page=0" + searchPagiData + "&ppage=" + "<?php echo e($perPage); ?>";
    return false;
  }
  /*Reset Filter*/
  function resetfilter() {
    window.location.href = "<?php echo e(route('admin.newsletter.index')); ?>";
  }
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/newsletter/index.blade.php ENDPATH**/ ?>