            ...
            <div class="page_detail">
                    ...
                    <div class="head_brdcm">
                        ...
                        <div class="all_dash">
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('user.allocation_snapshot')); ?>">
                                        <figure><img src="<?php echo e(asset('new-images/Composition.png')); ?>" alt=""></figure>
                                        <h4>Composition<br> Allocation<br> Snapshot</h4>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('user.scheme_portfolio')); ?>">
                                        <figure><img src="<?php echo e(asset('new-images/Scheme-Portfolio.png')); ?>" alt=""></figure>
                                        <h4>Scheme Portfolio</h4>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('user.occurrence_report')); ?>">
                                        <figure><img src="<?php echo e(asset('new-images/Occurrence-Report.png')); ?>" alt=""></figure>
                                        <h4>Occurrence<br> Report</h4>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('user.top_script_rop_industry')); ?>">
                                        <figure><img src="<?php echo e(asset('new-images/Top-Scrips.png')); ?>" alt=""></figure>
                                        <h4>Top Scrips <br>Top Industries</h4>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('user.new_script_new_industry')); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('user.boomers')); ?>">
                                ...
                                <li>
                                    <a href="<?php echo e(route('user.busters')); ?>">
...
<?php echo $__env->make('web.layout.infosolz_user_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/auth/composition_report/index.blade.php ENDPATH**/ ?>