...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.banner.update', $dataArr->bnr_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.description_txt')).'','for' => 'descp','error' => ''.e($errors->first('descp')).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.textarea','data' => ['id' => 'descp','name' => 'descp','value' => ''.$dataArr['descp'].'','rows' => '8','class' => 'editor_full']]); ?>
<?php $component->withName('form.field.textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'descp','name' => 'descp','value' => ''.$dataArr['descp'].'','rows' => '8','class' => 'editor_full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.link_txt')).'','for' => 'link','error' => ''.e($errors->first('link')).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'link','name' => 'link','value' => ''.e($dataArr->link).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'link','name' => 'link','value' => ''.e($dataArr->link).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.link_text_txt')).'','for' => 'link_text','error' => ''.e($errors->first('link_text')).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'link_text','name' => 'link_text','value' => ''.e($dataArr->link_text).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'link_text','name' => 'link_text','value' => ''.e($dataArr->link_text).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.target_txt')).'','for' => 'link_target','error' => ''.e($errors->first('link_target')).'','info' => ''.__('admin.info.link_target').'']); ?>
            <select id="link_target" class="form-control" name="link_target">
              ...
              <option value="<?php echo e($optVal); ?>" <?php if( old('link_target')==$optVal ): ?> <?php echo e('selected'); ?> <?php elseif( $dataArr->link_target == $optVal ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($optVal); ?></option>
...
<?php endif; ?>
          ...
          <div class="form-group has-primary row">
            ...
            <div class="col-sm-5">
              <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'bnr_group','name' => 'bnr_group','value' => ''.e($dataArr->bnr_group).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'bnr_group','name' => 'bnr_group','value' => ''.e($dataArr->bnr_group).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
            ...
            <div class="col-sm-5">
              <select id="bnr_group_dd" class="form-control" name="bnr_group_dd">
                ...
                <option value="<?php echo e($optValGrp); ?>" <?php if( old('bnr_group_dd')==$optValGrp ): ?> <?php echo e('selected'); ?> <?php elseif( $dataArr->bnr_group == $optValGrp ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($optValGrp); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/banner/updateform.blade.php ENDPATH**/ ?>