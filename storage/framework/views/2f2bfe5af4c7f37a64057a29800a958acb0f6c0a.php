...
<?php echo e(Breadcrumbs::render('mcap-eps.list')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('admin.mcapeps.list_label_txt')); ?></h5>
        <div class="c-f-btns">
          <div class="c-f-b-f">
            <!-- Filter -->
...
<?php endif; ?>
          ...
          <div class="c-f-b-r">
            ...
            <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.mcap-eps.delete')); ?>">
...
<?php endif; ?>
        <div class="dataTables_wrapper dt-bootstrap4 no-footer">
          <form id="filterForm" name="filterForm" method="get" action="<?php echo e(route('admin.mcap-eps.list')); ?>">
          ...
          <table class="table table-striped table-bordered nowrap">
            <thead>
              <tr>
                ...
                <th class="cc-w-125"><?php echo e($sortbyArr['market_cap']); ?></th>
                <th class="cc-w-125"><?php echo e($sortbyArr['eps']); ?></th>
                <th class="cc-w-80"><?php echo e($sortbyArr['pe']); ?></th>
...
<?php endif; ?>
              ...
              <tr role="row" class="">
                ...
                <td><?php echo e($record->market_cap); ?></td>
                <td><?php echo e($record->eps); ?></td>
                <td><?php echo e($record->pe); ?></td>
...
<script>
  ...
  function filter() {
    ...
    window.location.href = "<?php echo e(route('admin.mcap-eps.list')); ?>" + "?page=0" + searchPagiData + "&ppage=" + "<?php echo e($perPage); ?>";
    return false;
  }
  /*Reset Filter*/
  function resetfilter() {
    window.location.href = "<?php echo e(route('admin.mcap-eps.list')); ?>";
  }
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/mcapeps/list.blade.php ENDPATH**/ ?>