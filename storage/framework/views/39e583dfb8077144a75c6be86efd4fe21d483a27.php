...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.topic.update', $dataArr->aet_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.parent_txt')).'','for' => 'role','error' => ''.e($errors->first('parent')).'']); ?>
            <select id="parent" class="form-control" name="parent">
              ...
              <?php $__currentLoopData = $parentDataArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $optVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($value); ?>" <?php if((old('parent')> 0) && ($value == old('parent'))): ?> <?php echo e('selected'); ?> <?php elseif((($dataArr->parent > 0) && ($value == $dataArr->parent))): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($optVal); ?></option>
...
<?php endif; ?>
          ...
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => ''.e(__('admin.featured_img_txt')).'','for' => 'media_id','error' => ''.e($errors->first('media_id')).'','info' => ''.__('askexpert.info.topic_featured_img').'']]); ?>
<?php $component->withName('form.group_lyt1_2_10'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => ''.e(__('admin.featured_img_txt')).'','for' => 'media_id','error' => ''.e($errors->first('media_id')).'','info' => ''.__('askexpert.info.topic_featured_img').'']); ?>
...
<?php endif; ?>
          ...
          <div class="row m-b-20<?php echo e($errors->first('assigned_to')?' has-danger':''); ?>">
            <div class="col-sm-12">
              <label class="col-form-label"><?php echo e(__('admin.assigned_to_txt')); ?></label>
            </div>
            <div class="col-sm-5">
              <label class="col-form-label"><?php echo e(__('askexpert.topic.available_usr_txt')); ?></label>
            ...
            <div class="col-sm-5">
              <label class="col-form-label"><?php echo e(__('askexpert.topic.selected_usr_txt')); ?></label>
              <select name="assigned_to[]" id="multiselect_to" class="form-control multiselect" size="15" multiple="multiple">
                <?php if(count($toObj) > 0): ?>
                ...
                <option value="<?php echo e($value->u_id); ?>"><?php echo e(rtrim($value->users->f_name.' '.$value->users->l_name).' ('.$value->users->email.')'); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
              </select>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/topic/updateform.blade.php ENDPATH**/ ?>