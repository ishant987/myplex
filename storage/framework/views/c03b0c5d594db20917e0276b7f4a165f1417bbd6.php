...
<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
		...
		<div class="row mb-1">
			<div class="col-md-12 col-lg-4 pe-lg-1 mb-2 mb-sm-0">
				<div class="form_select border_top_left">
					...
					<select class="form-select select2 form-select-lg js-example-basic-single" id="ratio_main_list">
			...
			<div class="col-lg-2 col-md-6 pe-lg-1 ps-lg-0 mb-2 mb-sm-0">
				<div class="form_select">
					...
					<select class="w-100" id="return_ratio">
						...
						<option value="jensens_alpha">Jensen</option>
		...
		<div class="row">
			<div class="col-lg-3 pe-lg-1 col-12 col-md-12 mb-1">
				<div class="form_select bg_green border_bottom_left">
					<label for="">Schemes</label>
					<select class="form-select select2 form-select-lg js-example-basic-single" id="ratio_2nd_list">
						<option value="">Select Fund</option>
					</select>
			...
			<div class="col-lg-3 ps-lg-0 pe-lg-1 col-12 col-md-12">
				<div class="form_select bg_green">
					<label for="">Schemes</label>
					<select class="form-select select2 form-select-lg js-example-basic-single" id="ratio_3rd_list">
						<option value="">Select Fund</option>
					</select>
			...
			<div class="col-lg-3 pe-lg-1 ps-lg-0 col-12 col-md-12">
				<div class="form_select bg_green">
					<label for="">Schemes</label>
					<select class="form-select select2 form-select-lg js-example-basic-single" id="ratio_4th_list">
						<option value="">Select Fund</option>
					</select>
			...
			<div class="col-lg-3 col-md-12 ps-lg-0 col-12">
				<div class="form_select bg_green border_bottom_right">
					<label for="">Schemes</label>
					<select class="form-select select2 form-select-lg js-example-basic-single" id="ratio_5th_list">
						<option value="">Select Fund</option>
					</select>
	...
	<div class="text-center mt-3">
		<h4 class="fund_per_heading " id="info_box"></h4>
		<!--v-if-->
...
<script>
	...
	let ratio_compare_type = ratio_compare_type_text = "";
	...
	async function ratioCompare() {
		...
		ratio_from_date1 = new Date(ratio_from_date);
		ratio_to_date1 = new Date(ratio_to_date);

		//console.log('From Date: ' + ratio_from_date + ' To Date: ' + ratio_to_date);
		//console.log('Compare Type: ' + ratio_compare_type_text);

		var info_box = 'Compare : ' + ratio_compare_type_text + ' || From : ' + ratio_from_date1.toLocaleDateString("hi-IN") + ' To ' + ratio_to_date1.toLocaleDateString("hi-IN");
		console.log(info_box);
		$('#info_box').text(info_box);
		...
		if ($('#ratio_frm_date').val() == "" || $('#ratio_to_date').val() == "") {
			if ($('.rset').hasClass('active')) {
				...
				let api_url = "<?= URL::to('api/v1/get-dates'); ?>";
		...
		if (ratio_value1 != "" && (ratio_value2 != "" || ratio_value3 != "" || ratio_value4 != "" || ratio_value5 != "") && ratio_compare_type != "" && ratio_from_date != "" && ratio_to_date != "") {
			...
			let ratio_url = "<?= URL::to('api/v1/compare-ratios'); ?>";
	...
	$('#return_ratio').on('change', function() {
		...
		if ($('#return_ratio option:selected').val() != "") {
			...
			ratio_compare_type_text = $('#return_ratio option:selected').text();
	...
	$('#risk_ratio').on('change', function() {
		...
		if ($('#risk_ratio option:selected').val() != "") {
			...
			ratio_compare_type_text = $('#risk_ratio option:selected').text();
		} else {
...
<?php $__env->stopPush(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/ratio-calculation.blade.php ENDPATH**/ ?>