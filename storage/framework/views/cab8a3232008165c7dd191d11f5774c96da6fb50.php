...
<script>
    ...
    function initRiskRatioPage() {
        ...
        exportButton.addEventListener('click', function() {
            ...
            img.onload = function() {
                ...
                var ranking = "<?php echo e($request->ranking ?? 'range'); ?>";
                ...
                var asOnDate = "<?php echo e(!empty($request->as_on_date) ? date('d/m/Y', strtotime($request->as_on_date)) : '00/00/0000'); ?>";
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRiskRatioPage);
    } else {
        initRiskRatioPage();
    }
</script>
