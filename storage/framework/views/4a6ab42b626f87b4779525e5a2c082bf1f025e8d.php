...
<?php echo e(Breadcrumbs::render('fundwatch.create')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5 class="card-header-text"><?php echo e(__('admin.fundwatch.add_txt')); ?></h5>
      </div>
...
<?php endif; ?>
        ...
        <form name="aeDataFrm" id="aeDataFrm" action="<?php echo e(route('admin.fund-watch.store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fundwatch/createform.blade.php ENDPATH**/ ?>