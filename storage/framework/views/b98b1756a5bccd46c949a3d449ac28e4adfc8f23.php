    ...
    <div class="body_main py-5">
        <div class="container">
            <div class="status-card p-4 mb-4">
                ...
                <p class="mb-0">Create an account to get a <?php echo e($trialDays); ?>-day trial on Basic or Premium, then subscribe whenever you are ready.</p>
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('user.auth-dashboard')); ?>" class="btn btn-outline-success">Continue With Free Trial</a>
            ...
            <div id="plans" class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="plan-card h-100 p-4 d-flex flex-column <?php echo e($plan->slug === 'premium' ? 'featured' : ''); ?>">
                        ...
                        <p class="muted-note mb-3">Includes a <?php echo e($trialDays); ?>-day trial for new users.</p>
                        <?php elseif($planAllowsTrial && $hasUsedTrial): ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function openRazorpayCheckout(orderData) {
        ...
        rzp.on('payment.failed', function(response) {
            fetch('<?php echo e(route('web.subscription.payment-failed')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken,
