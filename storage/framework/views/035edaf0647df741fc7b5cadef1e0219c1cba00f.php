...
<?php endif; ?>
            <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.usergroup.update', $dataArr->u_g_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('subscribeduser.user_group.name')).'','for' => 'group_name','error' => ''.e($errors->first('group_name')).'','required' => 'true']); ?>
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'group_name','name' => 'group_name','value' => ''.e($dataArr->group_name).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'group_name','name' => 'group_name','value' => ''.e($dataArr->group_name).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
               ...
               <div class="row m-b-20<?php echo e($errors->first('assigned_to')?' has-danger':''); ?>">
                  ...
                  <div class="col-sm-5">
                     ...
                     <select name="assigned_to[]" id="multiselect_to" class="form-control multiselect" size="25" multiple="multiple">
                        <?php $__currentLoopData = $slctdSbsUsrObj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->u_id); ?>"><?php echo e($value->user->fullinfo); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </select>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/usergroup/updateform.blade.php ENDPATH**/ ?>