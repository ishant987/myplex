...
<!-- <div id="vue-app">
    <monthly-snapshot page_title="<?php echo e($dataArr['title']); ?>"  page_description="<?php echo e($dataArr['descp']); ?>" page_image="<?php echo e($dataArr['image_path']); ?>" image_path="<?php echo e(asset('themes/frontend/assets/v1/img/')); ?>"></monthly-snapshot>
            ...
            <div class="container p-0">
                <div class="snapshot_inner">
                    <div class="snapshot_header" style="padding: 0px 3px;">
                        <p>Monthly Snapshot Report: <?php echo e(date('d/m/Y', strtotime($from_date))); ?> to <?php echo e(date('d/m/Y', strtotime($to_date))); ?></p>
                    </div>
                                        ...
                                        <div class="changes_table ws-table-wrap">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table dataTable no-footer table-striped" role="grid">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $data['monthly_benchmark']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benchmark_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/monthly-snapshot.blade.php ENDPATH**/ ?>