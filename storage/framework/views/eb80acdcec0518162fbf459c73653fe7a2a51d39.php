...
<?php endif; ?>
          ...
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => 'ARN Verification','for' => 'arn_verification_status','error' => ''.e($errors->first('arn_verification_status')).'','required' => 'true']]); ?>
<?php $component->withName('form.group_lyt1_2_10'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => 'ARN Verification','for' => 'arn_verification_status','error' => ''.e($errors->first('arn_verification_status')).'','required' => 'true']); ?>
            <select id="arn_verification_status" class="form-control" name="arn_verification_status">
              <option value="pending" <?php if(old('arn_verification_status', $dataArr['arn_verification_status'] ?? 'pending') == 'pending'): ?> selected <?php endif; ?>>Pending</option>
              <option value="verified" <?php if(old('arn_verification_status', $dataArr['arn_verification_status'] ?? 'pending') == 'verified'): ?> selected <?php endif; ?>>Verified</option>
            </select>
           <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
