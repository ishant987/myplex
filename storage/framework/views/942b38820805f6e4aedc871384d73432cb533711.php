...
<?php echo e(Breadcrumbs::render('customfield.create')); ?> 
    ...
    <div class="col-sm-12">
        <div class="card m-b-0">
            <div class="card-header">
                <h5 class="card-header-text"><?php echo e(__('admin.customfield.add_txt')); ?></h5>
            </div>
...
<?php endif; ?>
            ...
            <form name="aeDataFrm" id="aeDataFrm" action="<?php echo e(route('admin.customfield.store')); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/customfield/createform.blade.php ENDPATH**/ ?>