...
<?php endif; ?>
            ...
            <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.fundtype.update', $dataArr->ft_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.fundtype.active_passive_txt')).'','for' => 'active_passive','error' => ''.e($errors->first('active_passive')).'','required' => 'true']); ?>
                  <select name="active_passive" id="active_passive" class="form-control">
                     ...
                     <option value="<?php echo e($key); ?>" <?php if( $key==old('active_passive') ): ?> <?php echo e('selected'); ?> <?php elseif( $key==$dataArr->active_passive ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($activePassive); ?></option>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.fundtype.monthly_performance_txt')).'','for' => 'monthly_performance','error' => ''.e($errors->first('monthly_performance')).'','required' => 'true']); ?>
                  <select name="monthly_performance" id="monthly_performance" class="form-control">
                     ...
                     <option value="<?php echo e($key); ?>" <?php if( $key==old('monthly_performance') ): ?> <?php echo e('selected'); ?> <?php elseif( $key==$dataArr->monthly_performance ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($monthlyPerformance); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fundtype/updateform.blade.php ENDPATH**/ ?>