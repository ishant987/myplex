...
<!-- <div id="vue-app">
    <fund-composition-snapshot page_title="<?php echo e($dataArr['title']); ?>"  page_description="<?php echo e($dataArr['descp']); ?>" page_image="<?php echo e($dataArr['image_path']); ?>">
...
<section class="info_monitor_sec">
    <div class="container">
        ...
        <?php if(!empty($heading_name)): ?> <p class="sub_gren_title">
            Composition Snapshot of: <span><?php echo e($heading_name); ?></span>
                                        ...
                                        <table class="table datatable table-striped" id="pdfData">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $fund_snapshot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(in_array($item->fund_name,$fundsArr)): ?>
                                                <tr>
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/fund-composition-snapshot.blade.php ENDPATH**/ ?>