                                        ...
                                        <select name="fund_master" id="fund_master" class="select2">
                                            ...
                                            <?php if(isset($fund_master)): ?>
                                                <?php $__currentLoopData = $fund_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(data_get($val, 'fund_code', '')); ?>"
                                                        <?php echo e(request()->get('fund_master') == data_get($val, 'fund_code') ? 'selected' : ''); ?>>
                                                        <?php echo e(data_get($val, 'fund_name', '')); ?>
                    ...
                    <?php if(isset($scrips) && count($scrips) > 0): ?>
                        <div class="fund_section new_fund_section">
                            <ul>
                                ...
                                <li>
                                    <p>name of Fund :</p>
                                    <span><?php echo e(data_get($fund_details, 'fund_name', '')); ?></span>
                                </li>
                                <li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    exportButton.addEventListener('click', function() {
        ...
        img.onload = function() {
            ...
            var fundName = "<?php echo e(data_get($fund_details, 'fund_name', '')); ?>";
