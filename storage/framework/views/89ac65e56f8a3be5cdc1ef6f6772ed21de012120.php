...
<?php echo e(Breadcrumbs::render('adminrole.edit',$userrole)); ?> 
   ...
   <div class="col-sm-12">
      <div class="card m-b-0">
         <div class="card-header">
            <h5 class="card-header-text"><?php echo e(__('admin.edit_admnrole_user_txt')); ?></h5>
         </div>
...
<?php endif; ?>
            ...
            <form name="aeUsrFrm" id="aeUsrFrm" action="<?php echo e(route('admin.adminrole.update', $userrole->role_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.rolename_txt')).'','for' => 'title','error' => ''.e($errors->first('title')).'','required' => 'true']); ?>
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'title','name' => 'title','value' => ''.e($userrole->title).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'title','name' => 'title','value' => ''.e($userrole->title).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                    ...
                    <table class="table table-bordered m-b-0 user-role-table">
                       ...
                       <tbody>
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                          <?php if($module->getModuleMethods($userrole->role_id) && count($module->getModuleMethods($userrole->role_id))>0): ?>
                           <tr class="<?php echo e($maxTdCnt); ?>">
                              ...
                              <?php $__currentLoopData = $module->getModuleMethods($userrole->role_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2=>$method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <td <?php if( $maxTdCnt !=count($module->getModuleMethods($userrole->role_id)) && $key2==count($module->getModuleMethods($userrole->role_id))-1 ): ?> colspan="<?php echo e($maxTdCnt-$key2); ?>" <?php endif; ?> class="user-method-perm ">
                                ...
                                <div class="checkbox-fade has-primary fade-in-default">
                                   <label>
                                    <?php if($method->default_present == 0): ?>
                                      <input type="checkbox" name="method[]" value="<?php echo e($method->method_id); ?>" <?php if(in_array($method->method_id,$selectedMethodIDArr)): ?> checked="checked" <?php endif; ?>>
                                      <span class="cr">
                                      <i class="cr-icon icofont icofont-ui-check txt-default"></i>
                                     </span>
                                    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/adminrole/updateform.blade.php ENDPATH**/ ?>