...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.13/jspdf.plugin.autotable.min.js"></script>
 <!-- ShareThis Script -->
 <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=<?php echo e(env('SHARE_BUTTON_PROPERTY')); ?>&product=inline-share-buttons" async="async"></script>



<?php if(View::hasSection('captcha')): ?>
    <script src="https://www.google.com/recaptcha/api.js?render=<?php echo e(Config('commonconstants.recaptcha.site_key')); ?>">
    </script>
<?php endif; ?>
...
<?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/layout/includes/javascripts.blade.php ENDPATH**/ ?>