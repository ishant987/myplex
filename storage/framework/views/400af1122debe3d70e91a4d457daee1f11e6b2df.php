...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.faq.update', $dataArr->faq_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.category_txt')).'','for' => 'cc_id','error' => ''.e($errors->first('cc_id')).'','required' => 'true']); ?>
            <select id="cc_id" class="form-control" name="cc_id">
              ...
              <option value="<?php echo e($value); ?>" <?php if( $value==old('cc_id') ): ?> <?php echo e('selected'); ?> <?php elseif( $value==$dataArr['cc_id'] ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($optTitle); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/faq/updateform.blade.php ENDPATH**/ ?>