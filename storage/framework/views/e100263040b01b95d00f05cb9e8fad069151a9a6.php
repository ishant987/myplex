        ...
        <div class="page_detail">
            <div class="inner_padding">
                ...
                <div class="new_page">
                                        ...
                                        <select class="select2 multiple index_select" multiple name="indices[]"
                                            ...
                                            <?php $__currentLoopData = $indices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($index->name); ?>"
                                                    <?php if(isset($request['indices']) && in_array($index->name, $request['indices'])): ?> selected <?php endif; ?>><?php echo e($index->name); ?>
                    ...
                    <?php elseif(!empty($request['indices']) && !empty($request['start_date']) && !empty($request['end_date'])): ?>
                        <div class="graph_section">
