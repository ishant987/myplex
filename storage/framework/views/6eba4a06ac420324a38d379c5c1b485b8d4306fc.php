...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/favicon-my.png')); ?>" type="image/x-icon">
...
<body>
    ...
    <div class="content">
        <header class="header">
            <figure class="header-fig">
                <a href="<?php echo e(url('report-dashboard')); ?>"><img src="<?php echo e(asset('assets/images/my-logo.png')); ?>" alt=""></a>
            </figure>
        </header>
    ...
    <script src="<?php echo e(asset('assets/js/icon.js')); ?>"></script>
    ...
    function getIndicesName()
    {
        ...
        if(fund_code != '')
        {
            $.ajax({
                type: "get",
                url: "<?php echo e(url('get-indices-name')); ?>",
                data: {
                    fund_code: fund_code
                },
...
</html><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/layout/infosolz_app.blade.php ENDPATH**/ ?>