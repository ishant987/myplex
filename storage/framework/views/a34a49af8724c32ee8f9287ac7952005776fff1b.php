            ...
            <div class="col-md-12">
                ...
                <div class="meet_team_slider">
                    <div class="single_team">
                        <div class="single_team_wrapper">
                            <div class="single_team_img">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/about/Prasunjit-Mukherjee-final.jpg')); ?>" />
                            </div>
                            <ul>
                    ...
                    <div class="single_team">
                        <div class="single_team_wrapper">
                            <div class="single_team_img">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/about/Roy-Joseph-final.jpg')); ?>" />
                            </div>
                            <ul>
                                <li><a href="#"><i class="ph-facebook-logo"></i></a></li>
                                <li><a href="#"><i class="ph-twitter-logo"></i></a></li>
                    ...
                    <div class="single_team">
                        <div class="single_team_wrapper">
                            <div class="single_team_img">
                                <img src="<?php echo e(asset('themes/frontend/assets/v1/img/about/Surajit-Kundu-final.jpg')); ?>" />
                            </div>
                            <ul>
                                <li><a href="#"><i class="ph-facebook-logo"></i></a></li>
                                <li><a href="#"><i class="ph-twitter-logo"></i></a></li>
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/about.blade.php ENDPATH**/ ?>