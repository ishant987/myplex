...
<?php echo e(Breadcrumbs::render('customfield.grouptype.classtemplate.edit', $dataArr)); ?> 
    ...
    <div class="col-sm-12">
        <div class="card m-b-0">
            <div class="card-header">
                <h5 class="card-header-text"><?php echo e(__('admin.customfield.grouptype.classtemplate.edit_txt')); ?></h5>
            </div>
...
<?php endif; ?>
            ...
            <form name="aeDataFrm" id="aeDataFrm" action="<?php echo e(route('admin.customfield.grouptype.classtemplate.update', [$dataArr->cfgt->cf_group_id, $dataArr->cf_group_type_id, $dataArr->cf_gt_class_template_id])); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.customfield.grouptype.class_name_txt')).'','for' => 'class_id','error' => ''.e($errors->first('class_id')).'','required' => 'true']); ?>
                <select id="class_id" class="form-control" name="class_id">
                    ...
                    <option value="<?php echo e($class_id); ?>" <?php if((old('class_id') > 0) && ($class_id == old('class_id'))): ?> <?php echo e('selected'); ?> <?php elseif((($dataArr->class_id) && ($class_id == $dataArr->class_id))): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($class_name); ?></option>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.customfield.grouptype.template_for_txt')).'','for' => 'template_id','error' => ''.e($errors->first('template_id')).'','required' => 'true']); ?>
                <select id="template_id" class="form-control" name="template_id">
                    <?php $__currentLoopData = $classTemplatesAssoc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template_id => $template_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($template_id); ?>" <?php if((old('template_id') > 0) && ($template_id == old('template_id'))): ?> <?php echo e('selected'); ?> <?php elseif((($dataArr->template_id) && ($template_id == $dataArr->class_id))): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($template_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $(document).ready(function () {
        getclasstemplate('<?php echo e(old('template_id')??$dataArr->template_id); ?>');
    });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/customfieldgrouptypect/updateform.blade.php ENDPATH**/ ?>