...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.fund-suggestion.update', $dataArr->fs_id)); ?>" method="POST" enctype="multipart/form-data">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.description_txt')).'','for' => 'description','error' => ''.e($errors->first('description')).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.textarea','data' => ['id' => 'description','name' => 'description','value' => ''.$dataArr->description.'','rows' => '8','class' => 'editor']]); ?>
<?php $component->withName('form.field.textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'description','name' => 'description','value' => ''.$dataArr->description.'','rows' => '8','class' => 'editor']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fundsuggestion/updateform.blade.php ENDPATH**/ ?>