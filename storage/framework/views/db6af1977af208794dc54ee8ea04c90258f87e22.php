...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-8 ">
                                    ...
                                    <div class="subs_in bttn_grp w-100 mb-3" style="z-index:1;">
                                        <p>Compare With </p>
                                        <a href="javascript:void(0)" onclick="$('#compare_type').val('Scheme');selectCompareTypeList('Scheme');" class="<?php if(old('compare_type', $request->compare_type) == 'Scheme'): ?> bg-secondary <?php endif; ?>">Scheme</a>
                                        <a href="javascript:void(0)" onclick="$('#compare_type').val('Index');selectCompareTypeList('Index');" class="<?php if(old('compare_type', $request->compare_type) == 'Index'): ?> bg-secondary <?php endif; ?>">Index</a>
                                        <a href="javascript:void(0)" onclick="$('#compare_type').val('Currency');selectCompareTypeList('Currency');" class="<?php if(old('compare_type', $request->compare_type) == 'Currency'): ?> bg-secondary <?php endif; ?>">Currency</a>
                                        <a href="javascript:void(0)" onclick="$('#compare_type').val('Commodity');selectCompareTypeList('Commodity');" class="<?php if(old('compare_type', $request->compare_type) == 'Commodity'): ?> bg-secondary <?php endif; ?>">Commodity</a>                                    
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form_group">
                                        ...
                                        <div id="fund_wrapper" class="<?php if($request->compare_type != 'Scheme' && !empty($request->compare_type) ): ?> d-none <?php endif; ?>">
                                        ...
                                        <div id="index_wrapper" class="<?php if(old('compare_type', $request->compare_type) != 'Index'): ?> d-none <?php endif; ?>">
                                        ...
                                        <div id="currency_wrapper" class="<?php if(old('compare_type', $request->compare_type) != 'Currency'): ?> d-none <?php endif; ?>">
                                        ...
                                        <div id="commodity_wrapper" class="<?php if(old('compare_type', $request->compare_type) != 'Commodity'): ?> d-none <?php endif; ?>">
                            ...
                            <ul>
                                ...
                                <?php endif; ?>
                                    ...
                                    <li>
                                        ...
                                        <span><?php echo e(isset($schemeMaterData) ? $schemeMaterData->fund_name : ''); ?></span>
                                    </li>
