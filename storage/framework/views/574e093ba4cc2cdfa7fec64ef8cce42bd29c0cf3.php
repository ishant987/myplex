    ...
    <div class="container">
        <div class="body_content">
            <div class="content_left">
                <h2>Preamble</h2>
                <p class="pre_text">Preamble text goes here</p>
                ...
                <div class="philo mt_15">
                    <div class="philo_single">
                        ...
                        <p>Fund Philosophy text goes here......</p>
                    </div>
                    <div class="philo_single">
                        <h3>Investment Style</h3>
                        <p>Investment Style text goes here......</p>
                    </div>
                </div>
                ...
                <div class="mt_15">
                    <p>Performance Parameter Bottom Comments goes here......</p>
                </div>
                ...
                <div class="return_less mt_15">
                    ...
                    <p>Index Rank Bottom Comments goes here......</p>
                </div>
                ...
                <div class="risk_adjust mt_15">
                    ...
                    <p>Risk Adjust Bottom Comments goes here.......</p>
                </div>

                <div class="fund_compo mt_15">
                    <h2>Fund Composition Analysis</h2>
                    <p>Composition Analysis Top Comments goes here.......</p>
                    ...
                    <table class="cmn_table">
                        ...
                        <?php if(!empty($fund_scrips) || !empty($fund_scrips1) || !empty($fund_scrips2) || !empty($fund_scrip3s) || !empty($fund_scrips4)): ?>
                            <?php for($i = 0; $i<10; $i++): ?>
                            <tr>
                                <td><?php echo e($fund_scrips[$i]->scrip_name); ?></td>
                                <td><?php echo e($fund_scrips[$i]->qty); ?></td>
                                <td><?php echo e($fund_scrips1[$i]->qty); ?></td>
                                <td><?php echo e($fund_scrips2[$i]->qty); ?></td>
                                <td><?php echo e($fund_scrips3[$i]->qty); ?></td>
                                <td><?php echo e($fund_scrips4[$i]->qty); ?></td>
                            </tr>
                            <?php endfor; ?>
                        <?php endif; ?>
                        </tbody>
                    ...
                    <p>Composition Analysis Bottom Comments goes here........</p>
                </div>
                ...
                <p class="discl"><strong>Disclaimer :</strong> Disclaimer text goes here.......</p>
            </div>     <!--CONTENT LEFT-->    
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web-old/pages/demo-new-fundwatch.blade.php ENDPATH**/ ?>