        ...
        <div class="page_detail">
            <div class="inner_padding">
                ...
                <div class="ratio-analysis-shell">
                    ...
                    <div class="all_dash">
                        <ul>
                            <?php echo $__env->make('web.auth.partials.dashboard-card', ['route' => 'user.risk_ratio', 'icon' => 'new-images/Risk-Ratio.png', 'title' => 'Risk Ratio', 'subtitle' => 'Evaluate downside exposure'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('web.auth.partials.dashboard-card', ['route' => 'user.return_ratio', 'icon' => 'new-images/Return-Ratio.png', 'title' => 'Return Ratio', 'subtitle' => 'Compare return efficiency'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('web.auth.partials.dashboard-card', ['route' => 'user.sortino_ratio', 'icon' => 'new-images/Sortino-Ratio.png', 'title' => 'Sortino Ratio', 'subtitle' => 'Focus on downside-adjusted return'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </ul>
                    </div>
                </div>
            </div>
