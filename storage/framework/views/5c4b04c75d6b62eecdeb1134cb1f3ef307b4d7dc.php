                        ...
                        <div class="fund_section new_fund_section">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <span>
                                        <?php if(isset($request->report_category) && $request->report_category == 'sortino'): ?>
                                            <?php echo e('Sortino'); ?>

                                        <?php elseif(isset($request->report_category) && $request->report_category == 'upside_potential'): ?>
                                            <?php echo e('Upside Potential'); ?>

                                        <?php elseif(isset($request->report_category) && $request->report_category == 'downside_risk'): ?>
                                ...
                                <?php if(isset($request->limit)): ?>
                                    <li>
                                        <p>Minimum Acceptable Rate (in %)  :</p>
                                        <span><?php echo e($request->limit); ?></span>
                                    </li>
                                <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    exportButton.addEventListener('click', function() {
        ...
        img.onload = function() {
            ...
            var ratio = <?php if(isset($request->report_category)): ?>
                            <?php if($request->report_category == 'sortino'): ?>
                                'Sortino'
                            <?php elseif($request->report_category == 'upside_potential'): ?>
                                'Upside Potential'
                            <?php elseif($request->report_category == 'downside_risk'): ?>
                                'Downside Risk'
                            <?php endif; ?>
                         <?php else: ?>
                            ''
            ...
            var duration = <?php if(isset($as_on_time_frame_data)): ?>
                            <?php switch($request->as_on_time_frame):
                                case ('1_month'): ?> '1 Month' <?php break; ?>
                                <?php case ('3_months'): ?> '3 Months' <?php break; ?>
                                <?php case ('6_months'): ?> '6 Months' <?php break; ?>
                                <?php case ('1_year'): ?> '1 Year' <?php break; ?>
                                <?php case ('2_year'): ?> '2 Years' <?php break; ?>
                                <?php case ('3_years'): ?> '3 Years' <?php break; ?>
                                <?php case ('5_years'): ?> '5 Years' <?php break; ?>
                            <?php endswitch; ?>
                         <?php else: ?>
                            ''
                         <?php endif; ?>;
            ...
            var minimumAcceptableRate = "<?php echo e(isset($request->limit) ? $request->limit : ''); ?>";
