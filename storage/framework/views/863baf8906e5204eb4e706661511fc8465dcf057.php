                            ...
                            <div class="col-md-4">
                                <div class="graph_table green_bg">
                                    ...
                                    <table class="table bs_ns_gl datatable">
                                        ...
                                        <tbody>
                                        <?php if($i==1): ?>
                                            <?php $__currentLoopData = ($array_bse ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indices_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                        ...
                                        <?php elseif($i==2): ?>
                                            <?php $__currentLoopData = ($array_nse ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indices_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php $__currentLoopData = ($array_global_it ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indices_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                            ...
                            <div class="col-md-4">
                                <div class="graph_table sky_bg">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = ($changes_currency ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curr_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                            ...
                            <div class="col-md-4">
                                <div class="graph_table yellow_bg">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = ($changes_commodity ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commodity_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                            ...
                            <div class="col-md-12">
                                <div class="graph_table orange_bg">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = ($monthly_benchmark ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benchmark_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                            ...
                            <div class="col-md-12">
                                <div class="graph_table blue_bg">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = ($best_schemes ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheme_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
