...
<?php echo e(Breadcrumbs::render('fundtype.index')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('admin.fundtype.all_txt')); ?></h5>
        <?php if($roleRights['add']): ?>
        <!-- Add New -->
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_add_new','data' => ['url' => ''.e(route('admin.fundtype.create')).'']]); ?>
<?php $component->withName('link_add_new'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.fundtype.create')).'']); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
        <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.fundtype.delete')); ?>">
...
<?php endif; ?>
                  ...
                  <?php endif; ?>
                  <?php endif; ?>
                  <th><?php echo e(__('admin.fundtype.name_txt')); ?></th>
                  <th class="cc-w-150"><?php echo e(__('admin.fundtype.active_passive_txt')); ?></th>
                  <th class="cc-w-150"><?php echo e(__('admin.fundtype.monthly_performance_txt')); ?></th>
...
<?php endif; ?>
                  ...
                  <td>
                    ...
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.e(route('admin.fundtype.edit', $record->ft_id)).'','title' => ''.e($listDataAtrArr['edit_txt']).'']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.fundtype.edit', $record->ft_id)).'','title' => ''.e($listDataAtrArr['edit_txt']).'']); ?>
...
<?php endif; ?>
                  ...
                  <td><?php echo e($moduleAtrArr['active_passive'][$record->active_passive] ?? ''); ?></td>
                  <td><?php echo e($moduleAtrArr['monthly_performance'][$record->monthly_performance] ?? ''); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fundtype/index.blade.php ENDPATH**/ ?>