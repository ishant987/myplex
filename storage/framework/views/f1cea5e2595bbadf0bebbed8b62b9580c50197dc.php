    ...
    <div class="news-listing">
        <div class="container">
            <div class="row" id="news">
                <?php $__currentLoopData = $newsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>			
                <div class="col-md-4 mb-4">
                    <div class="money_left_sec" data-aos="fade-up" data-aos-duration="1000">
                        <img src="https://new.myplexus.com/storage/news/<?php echo e($value->image); ?>" class="img-fluid" />
                    </div>
                    <div class="money_right_section" data-aos="fade-up" data-aos-duration="1000">
                        <h4><?php echo e($value->title); ?></h4>					
                        
                    <a href="<?php echo e($value->news_source_link); ?>" target="_blank">Read More</a>
                    </div>
                </div> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/in-the-news.blade.php ENDPATH**/ ?>