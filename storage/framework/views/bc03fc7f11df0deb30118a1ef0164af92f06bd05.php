...
<?php echo e(Breadcrumbs::render($editDataAtrArr['breadcrumb'], $dataArr)); ?>
...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route($editDataAtrArr['update_route'], $dataArr->cc_id)); ?>" method="POST">
...
<?php endif; ?>
          ...
          <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => ''.e(__('admin.slug_txt')).'','for' => 'slug','error' => ''.e($errors->first('slug')).'','required' => 'true','info' => ''.e(__('admin.info.edit_slug')).'']]); ?>
<?php $component->withName('form.group_lyt1_2_10'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => ''.e(__('admin.slug_txt')).'','for' => 'slug','error' => ''.e($errors->first('slug')).'','required' => 'true','info' => ''.e(__('admin.info.edit_slug')).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.parent_txt')).'','for' => 'role','error' => ''.e($errors->first('parent')).'']); ?>
            <select id="parent" class="form-control" name="parent">
              ...
              <option value="<?php echo e($value); ?>" <?php if( old('parent')==$value ): ?> <?php echo e('selected'); ?> <?php elseif( $dataArr->parent == $value ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($optTitle); ?></option>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.description_txt')).'','for' => 'descp','error' => ''.e($errors->first('descp')).'','info' => ''.__('admin.info.descp').'']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.textarea','data' => ['id' => 'descp','name' => 'descp','value' => ''.$dataArr['descp'].'','rows' => '8']]); ?>
<?php $component->withName('form.field.textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'descp','name' => 'descp','value' => ''.$dataArr['descp'].'','rows' => '8']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/commoncategory/updateform.blade.php ENDPATH**/ ?>