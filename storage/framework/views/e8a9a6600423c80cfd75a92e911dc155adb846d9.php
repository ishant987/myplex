...
<section class="inner-top">
    ...
    <div class="container">
        <h3 class="report-sub-heading">Report : Sharpe</h3>
        <form id="myForm">
            <div class="top-form">
                <div class="row">
                        ...
                        <table class="table table-bordered result-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center"><?php echo e($sharpe); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('web.layout.infosolz_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/infosolz-calculator/sharpe.blade.php ENDPATH**/ ?>