...
<?php echo e(Breadcrumbs::render('indices-comp.values.create')); ?>
   ...
   <div class="col-sm-12">
      <div class="card m-b-0">
         <div class="card-header">
            <h5 class="card-header-text"><?php echo e(__('admin.indices.comp.upld_lbl_txt')); ?></h5>
         </div>
...
<?php endif; ?>
               <form id="upload_bulk_sheet_form" name="upload_bulk_sheet_form" method="post" action="<?php if($msg=='error'): ?><?php echo e(route('admin.indices-comp.values.store', $msg)); ?><?php else: ?><?php echo e(route('admin.indices-comp.values.store')); ?><?php endif; ?>" enctype="multipart/form-data">
...
<?php endif; ?>
               ...
               <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_2_10','data' => ['label' => ''.e(__('admin.file_txt')).'','for' => 'file_upload','error' => ''.e($errors->first('file_upload')).'','info' => ''.__('admin.indices.comp.file_format_info').'','required' => 'true']]); ?>
<?php $component->withName('form.group_lyt1_2_10'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => ''.e(__('admin.file_txt')).'','for' => 'file_upload','error' => ''.e($errors->first('file_upload')).'','info' => ''.__('admin.indices.comp.file_format_info').'','required' => 'true']); ?>
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                  <div class="m-t-10 has-primary">
                     <span class="col-form-label info">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link','data' => ['url' => ''.e(asset('themes/backend/assets/formats/upload-monthly-indices-composition-value.csv')).'','class' => 'b-b-primary text-primary','target' => '_blank']]); ?>
<?php $component->withName('link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(asset('themes/backend/assets/formats/upload-monthly-indices-composition-value.csv')).'','class' => 'b-b-primary text-primary','target' => '_blank']); ?><?php echo e(__('common.click_here_txt')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.button','data' => ['type' => 'reset','id' => 'cancel','name' => 'cancel','class' => 'btn-danger','text' => ''.e(__('admin.cancel_txt')).'','onclick' => 'location.href = \''.e(route('admin.indices-comp.values.create')).'\';']]); ?>
<?php $component->withName('form.field.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'reset','id' => 'cancel','name' => 'cancel','class' => 'btn-danger','text' => ''.e(__('admin.cancel_txt')).'','onclick' => 'location.href = \''.e(route('admin.indices-comp.values.create')).'\';']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/indices/compupload.blade.php ENDPATH**/ ?>