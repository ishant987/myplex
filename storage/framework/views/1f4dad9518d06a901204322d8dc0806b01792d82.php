        ...
        <div class="comp_schem_bdr">
            <div class="tab_snap_shot">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation"><a class="text-dark nav-link <?php if((isset($type) && ($type == 'quartile-active')) || !isset($type)): ?> active <?php endif; ?> " href="performance-synopsis?type=quartile-active" ><i class="fa-solid fa-calendar-check"></i> Quartile (Active Schemes)</a></li>
                    <li class="nav-item" role="presentation"><a class="text-dark nav-link <?php if((isset($type) && ($type == 'quartile-passive')) || !isset($type)): ?> active <?php endif; ?>  " href="performance-synopsis?type=quartile-passive" ><i class="ph-calendar-check"></i> Quartile (Passive Schemes)</a></li>
                    <li class="nav-item" role="presentation"><a class="text-dark nav-link <?php if((isset($type) && ($type == 'decile-active')) || !isset($type)): ?> active <?php endif; ?> " href="performance-synopsis?type=decile-active" ><i class="ph-calendar"></i> Decile (Active Schemes)</a></li>
                    <li class="nav-item" role="presentation"><a class="text-dark nav-link <?php if((isset($type) && ($type == 'decile-passive')) || !isset($type)): ?> active <?php endif; ?> " href="performance-synopsis?type=decile-passive" ><i class="ph-calendar"></i> Decile (Passive Schemes)</a></li>
                </ul>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/web/pages/performance-synopsis.02022026.blade.php ENDPATH**/ ?>