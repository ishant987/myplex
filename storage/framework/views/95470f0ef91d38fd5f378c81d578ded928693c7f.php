...
<?php echo e(Breadcrumbs::render('topic.create')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5 class="card-header-text"><?php echo e(__('askexpert.topic.add_txt')); ?></h5>
      </div>
...
<?php endif; ?>
        <form name="aeDataFrm" id="aeDataFrm" action="<?php echo e(route('admin.topic.store')); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('admin.parent_txt')).'','for' => 'role','error' => ''.e($errors->first('parent')).'']); ?>
            <select id="parent" class="form-control" name="parent">
              ...
              <option value="<?php echo e($value); ?>" <?php echo e(( $value == old('parent') ) ? 'selected' : ''); ?>><?php echo e($optVal); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/topic/createform.blade.php ENDPATH**/ ?>