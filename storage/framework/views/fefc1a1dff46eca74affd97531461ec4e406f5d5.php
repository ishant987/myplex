...
<?php echo e(Breadcrumbs::render('missingnav.index')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('admin.fund.missing.label_txt')); ?></h5>
        <div class="c-f-btns">
          <div class="c-f-b-f">
            <!-- Filter -->
...
<?php endif; ?>
          ...
          <div class="c-f-b-r">
            ...
            <!-- Add New -->
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_add_new','data' => ['url' => ''.e(route('admin.missing-nav.create')).'','target' => '_blank']]); ?>
<?php $component->withName('link_add_new'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.missing-nav.create')).'','target' => '_blank']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
            ...
            <!-- Export -->
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.route('admin.missing-nav.export',$exportDataArr).'','class' => 'btn waves-effect waves-light btn-sm f-right btn-success','title' => ''.e(__('admin.export_txt')).'']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.route('admin.missing-nav.export',$exportDataArr).'','class' => 'btn waves-effect waves-light btn-sm f-right btn-success','title' => ''.e(__('admin.export_txt')).'']); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
        <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.missing-nav.index')); ?>">
...
<?php endif; ?>
            ...
            <div class="col-sm-5">
              <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.group_lyt1_3_7_2','data' => ['label' => ''.e(__('admin.fund.missing.scheme_txt')).'','for' => 'ffc','error' => ''.e($errors->first('ffc')).'','required' => 'true']]); ?>
<?php $component->withName('form.group_lyt1_3_7_2'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => ''.e(__('admin.fund.missing.scheme_txt')).'','for' => 'ffc','error' => ''.e($errors->first('ffc')).'','required' => 'true']); ?>
                <select name="ffc" id="ffc" class="form-control js-example-basic-single">
                  ...
                  <?php $__currentLoopData = $fundList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($value->fund_code); ?>" <?php if( $value->fund_code==old('ffc') ): ?> <?php echo e('selected'); ?> <?php elseif( $value->fund_code==$fltrDataArr['fund_code'] ): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($value->fund_name); ?>
            ...
            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
              <thead>
                <tr>
                  ...
                  <th><?php echo e(__('admin.fund.missing.scheme_txt')); ?></th>
                  <th><?php echo e(__('admin.fund.code_txt')); ?></th>
                </tr>
              </thead>
              <tbody>
                <?php if( count($dataListModel) > 0 ): ?>
...
<script>
  ...
  function filter() {
    ...
    window.location.href = "<?php echo e(route('admin.missing-nav.index')); ?>" + "?type=filter" + searchPagiData;
    return false;
  }
  /*Reset Filter*/
  function resetfilter() {
    window.location.href = "<?php echo e(route('admin.missing-nav.index')); ?>";
  }
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/fund/missing-list.blade.php ENDPATH**/ ?>