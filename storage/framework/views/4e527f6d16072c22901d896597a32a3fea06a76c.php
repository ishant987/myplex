...
<body>
    <div class="container">
        <div class="header">
            <img src="<?php echo e(asset('themes/frontend/assets/v1/img/logo_dash.png')); ?>" alt="myplexus">
        </div>
        <div class="body">
            <h2>Hi <?php echo e($user->f_name ?: 'User'); ?>,</h2>
            <p>Your <strong>myplexus</strong> subscription is expiring in <strong>3 days</strong>.</p>

            <div class="highlight">
                <p>Expiry Date: <?php echo e(\Carbon\Carbon::parse($expiry_date)->format('d M Y')); ?></p>
            </div>
            ...
            <p>
                <a href="<?php echo e($renewal_url); ?>" class="btn">Renew Subscription</a>
            </p>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> myplexus.com. All Rights Reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/emails/subscription_expiry.blade.php ENDPATH**/ ?>