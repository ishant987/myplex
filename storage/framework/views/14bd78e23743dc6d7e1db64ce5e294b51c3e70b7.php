...
<?php endif; ?>
                  ...
                  <td>
                    <select name="fav" id="fav" aria-controls="example" class="form-control">
                      <option value=""><?php echo e($cFilterArr['all_txt']); ?></option>
                      <?php $__currentLoopData = $arnVerificationStatusArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $statusFtxt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($key); ?>" <?php if( $key == ($fltrDataArr['arn_verification_status'] ?? '') ): ?> selected <?php endif; ?>><?php echo e($statusFtxt); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </td>
                  <td>
...
<?php endif; ?>
                  ...
                  <td>
                    <?php $arnStatus = $record->arn_verification_status ?: 'pending'; ?>
                    <span class="label btn-<?php echo e($arnStatus === 'verified' ? 'success' : 'warning'); ?>"><?php echo e($arnVerificationStatusArr[$arnStatus] ?? ucfirst($arnStatus)); ?></span>
                  </td>
                ...
                <?php else: ?>
                <tr>
                  <td colspan="17"><?php echo e(__('message.data_not_available')); ?></td>
                </tr>
                <?php endif; ?>
              </tbody>
            </table>
