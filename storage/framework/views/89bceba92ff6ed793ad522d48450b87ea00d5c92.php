...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (monthlyTab1) {
    monthlyTab1.addEventListener('click', function(e) {
      e.preventDefault();
      window.location.href = 'https://new.myplexus.com/calctest?cal=sip';
    });
  }
    ...
    weeklyTab1.addEventListener('click', function(e) {
      e.preventDefault();
      window.location.href = 'https://new.myplexus.com/calctest?cal=lump';
    });
  }
  ...
  //}
    ...
    pillmonthlytwo.addEventListener('click', function(e) {
      e.preventDefault();
      window.location.href = 'https://new.myplexus.com/calctest?cal=inflation';
    });
  }
	if (pillmonthlyg) {
    pillmonthlyg.addEventListener('click', function(e) {
      e.preventDefault();
      window.location.href = 'https://new.myplexus.com/calctest?cal=pills-goal1';
    });
  }
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/pages/calculators.blade.php ENDPATH**/ ?>