...
<?php endif; ?>
        ...
        <form name="eDataFrm" id="eDataFrm" action="<?php echo e(route('admin.plan.update', $dataArr->p_id)); ?>" method="POST">
...
<?php $component->withAttributes(['label' => ''.e(__('plan.type_txt')).'','for' => 'plan_type','error' => ''.e($errors->first('plan_type')).'','required' => 'true']); ?>
            <select name="plan_type" id="plan_type" aria-controls="example" class="form-control" disabled="true">
              ...
              <option value="<?php echo e($ptVal); ?>" <?php if($ptVal==old('plan_type')): ?> <?php echo e('selected'); ?> <?php elseif($ptVal==$dataArr->plan_type): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($moduleAtrArr['plan_type']['text'][$ptVal]); ?></option>
...
<?php $component->withAttributes(['label' => ''.e(__('plan.name_txt')).'','for' => 'plan_name','error' => ''.e($errors->first('plan_name')).'','required' => 'true']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'plan_name','name' => 'plan_name','value' => ''.e($dataArr->plan_name).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'plan_name','name' => 'plan_name','value' => ''.e($dataArr->plan_name).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
          ...
          <div id="lp_div" <?php if($dataArr->plan_type == $moduleAtrArr["plan_type"]["value"][1]): ?> <?php echo e('class=show-scn'); ?> <?php else: ?> <?php echo e('class=hide-scn'); ?> <?php endif; ?>>
...
<?php $component->withAttributes(['label' => ''.e(__('admin.description_txt')).'','for' => 'description','error' => ''.e($errors->first('description')).'']); ?>
              <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.textarea','data' => ['id' => 'description','name' => 'description','value' => ''.$dataArr->description.'','rows' => '3','class' => 'editor_full']]); ?>
<?php $component->withName('form.field.textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'description','name' => 'description','value' => ''.$dataArr->description.'','rows' => '3','class' => 'editor_full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('plan.amount_txt')).'','for' => 'amount','error' => ''.e($errors->first('amount')).'','info' => ''.__('plan.info.not_change').'']); ?>
              <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['type' => 'number','id' => 'amount','name' => 'amount','value' => ''.e($dataArr->amount).'','min' => '0','disabled' => 'true']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'number','id' => 'amount','name' => 'amount','value' => ''.e($dataArr->amount).'','min' => '0','disabled' => 'true']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('plan.duration_txt')).'','for' => 'plan_duration','error' => ''.e($errors->first('plan_duration')).'','required' => 'true','info' => ''.__('plan.info.plan_duration').'']); ?>
              <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['type' => 'number','id' => 'plan_duration','name' => 'plan_duration','value' => ''.e($dataArr->duration).'','min' => '0','disabled' => 'true']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'number','id' => 'plan_duration','name' => 'plan_duration','value' => ''.e($dataArr->duration).'','min' => '0','disabled' => 'true']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('plan.duration_name_txt')).'','for' => 'plan_duration_name','error' => ''.e($errors->first('plan_duration_name')).'']); ?>
              <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'plan_duration_name','name' => 'plan_duration_name','value' => ''.e($dataArr->duration_name).'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'plan_duration_name','name' => 'plan_duration_name','value' => ''.e($dataArr->duration_name).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes(['label' => ''.e(__('plan.free_trial_txt')).'','for' => 'free_trial','error' => ''.e($errors->first('free_trial')).'','required' => 'true']); ?>
              <select name="free_trial" id="free_trial" aria-controls="example" class="form-control">
                ...
                <option value="<?php echo e($key2); ?>" <?php if($key2==old('free_trial')): ?> <?php echo e('selected'); ?> <?php elseif($key2==$dataArr->free_trial): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($ftvalue); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['label' => ''.__('plan.show_website_app_txt').'','for' => 'show_on_wa','error' => ''.e($errors->first('show_on_wa')).'','required' => 'true']); ?>
              <select name="show_on_wa" id="show_on_wa" aria-controls="example" class="form-control">
                ...
                <option value="<?php echo e($key3); ?>" <?php if($key3==old('show_on_wa')): ?> <?php echo e('selected'); ?> <?php elseif($key3==$dataArr->show_on_wa): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($wavalue); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/plan/updateform.blade.php ENDPATH**/ ?>