                                        ...
                                        <div class="col-md-6">
                                            <div class="form_group">
                                                <input type="date" placeholder="Start Date" class="form-control"
                                                    ...
                                                    value="<?php echo e(old('p_one_start_date', isset($p_one_start_date) ? date('Y-m-d', strtotime($p_one_start_date)) : '')); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form_group">
                                                <input type="date" placeholder="End Date" class="form-control"
                                                    ...
                                                    value="<?php echo e(old('p_one_end_date', isset($p_one_end_date) ? date('Y-m-d', strtotime($p_one_end_date)) : '')); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form_group">
                                                <input type="date" placeholder="Start Date" class="form-control"
                                                    ...
                                                    value="<?php echo e(old('p_two_start_date', isset($p_two_start_date) ? date('Y-m-d', strtotime($p_two_start_date)) : '')); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form_group">
                                                <input type="date" placeholder="End Date" class="form-control"
                                                    ...
                                                    value="<?php echo e(old('p_two_end_date', isset($p_two_end_date) ? date('Y-m-d', strtotime($p_two_end_date)) : '')); ?>">
                                ...
                                <div class="col-md-6 div_hide_1" style="<?php echo e($isByFundMode ? '' : 'display:none;'); ?>">
                                    <div class="form_group multiple_select">
                                        <select name="fund_id[]" class="select2 multiple" id="select_fund_multiple"
                                            ...
                                            multiple onchange='fund_multiple(this)' <?php echo e($isByFundMode ? '' : 'disabled'); ?>>
