                ...
                <div class="graph_table">
                    ...
                    <table class="table datatable" id="pdfData-scrip">
                        ...
                        <tbody>
                         ...
                         <?php if($boomersScripRows->isNotEmpty()): ?>
                        <?php $__currentLoopData = $boomersScripRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scrp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                ...
                <div class="graph_table">
                    ...
                    <table class="table datatable" id="pdfData-industry">
                        ...
                        <tbody>
                         ...
                         <?php if($boomersIndustryRows->isNotEmpty()): ?>
                            <?php $__currentLoopData = $boomersIndustryRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scrp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
