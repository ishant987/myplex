...
<section class="inner-top">
    ...
    <div class="container">
        <h3 class="report-sub-heading">Report : Volatility</h3>
        <form id="myForm">
            <div class="top-form">
                <div class="row">
                    ...
                    <table class="table table-bordered result-table" id="myDatatable">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">Fund Rat-Avg of NAV (A)</th>
                                <th style="text-align: center">(Fund Rat-Avg of NAV)<sup>2</sup></th>
                            </tr>
                        </thead>
                            ...
                            <?php $i = 1; ?>
                                <?php $__currentLoopData = $searched_result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td align="right"><?php echo e($row['fund_ret_avg_of_nav']); ?></td>
                                        <td align="right"><?php echo e($row['fund_ret_avg_of_nav_squere']); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        ...
                        <table class="table table-bordered result-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Sum of (Fund Rat-Avg of NAV)<sup>2</sup></th>
                                    <th style="text-align: center">N</th>
                                    <th style="text-align: center">Sum of (Fund Rat-Avg of NAV)<sup>2</sup>/N</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center"><?php echo e($sum_of_g); ?></td>
                                    <td align="center"><?php echo e($total_number_of_result); ?></td>
                                    <td align="center"><?php echo e($sum_of_g_n); ?></td>
                                    <td align="center"><?php echo e($volatility); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('web.layout.infosolz_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/new.myplexus.com/httpdocs/my-plexus/resources/views/web/infosolz-calculator/volatility.blade.php ENDPATH**/ ?>