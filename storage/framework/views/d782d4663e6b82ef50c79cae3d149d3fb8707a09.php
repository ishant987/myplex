...
<?php echo e(Breadcrumbs::render('contact.index')); ?>
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5><?php echo e(__('contact.all_txt')); ?></h5>
        <div class="c-f-btns">
          <div class="c-f-b-f">
            <!-- Filter -->
...
<?php endif; ?>
            ...
            <!-- Export -->
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.route('admin.contact.export', $exportDataArr).'','class' => 'btn waves-effect waves-light btn-sm f-right btn-success','title' => ''.e(__('admin.export_txt')).'']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.route('admin.contact.export', $exportDataArr).'','class' => 'btn waves-effect waves-light btn-sm f-right btn-success','title' => ''.e(__('admin.export_txt')).'']); ?>
...
<?php endif; ?>
        <div class="dataTables_wrapper dt-bootstrap4 no-footer">
          <form id="filterForm" name="filterForm" method="get" action="<?php echo e(route('admin.contact.index')); ?>">
        ...
        <form id="listDataForm" name="listDataForm" method="post" action="<?php echo e(route('admin.deletecontact')); ?>">
...
<?php endif; ?>
                  ...
                  <?php endif; ?>
                  <?php endif; ?>
                  <th><?php echo e($sortbyArr['name']); ?></th>
                  <th><?php echo e($sortbyArr['email']); ?></th>
                  <th class="cc-w-95"><?php echo e($sortbyArr['mobile']); ?></th>
                  <th><?php echo e($sortbyArr['message']); ?></th>
                  <th class="cc-w-150"><?php echo e($sortbyArr['created_at']); ?></th>
                  <?php if($roleRights['view']): ?>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'ffn','name' => 'ffn','value' => ''.e($fltrDataArr['name'] ?? '').'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'ffn','name' => 'ffn','value' => ''.e($fltrDataArr['name'] ?? '').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                  ...
                  <td>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'fml','name' => 'fml','value' => ''.e($fltrDataArr['mobile'] ?? '').'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'fml','name' => 'fml','value' => ''.e($fltrDataArr['mobile'] ?? '').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                  ...
                  <td>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.text','data' => ['id' => 'fms','name' => 'fms','value' => ''.e($fltrDataArr['message'] ?? '').'']]); ?>
<?php $component->withName('form.field.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'fms','name' => 'fms','value' => ''.e($fltrDataArr['message'] ?? '').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <tr role="row" class="">
                  <?php if($roleRights['delete']): ?>
                  <td class="sorting_<?php echo e($record->enq_id); ?>">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.field.checkbox','data' => ['style' => 'default','name' => 'checkbox[]','value' => ''.e($record->enq_id).'','fldclass' => 'del-chkbx']]); ?>
<?php $component->withName('form.field.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['style' => 'default','name' => 'checkbox[]','value' => ''.e($record->enq_id).'','fldclass' => 'del-chkbx']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                  ...
                  <?php endif; ?>
                  <td>
                    <?php if($record->u_id > 0): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.e(route('admin.subscribeduser.edit', $record->u_id)).'','title' => ''.e($listDataAtrArr['view_txt']).'','target' => ''.e($listDataAtrArr['target']).'']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.subscribeduser.edit', $record->u_id)).'','title' => ''.e($listDataAtrArr['view_txt']).'','target' => ''.e($listDataAtrArr['target']).'']); ?>
...
<?php endif; ?>
                  ...
                  <td><?php echo \App\Lib\Core\Useful::getShortContent( strip_tags($record->message), 100); ?></td>
                  <td><?php echo e(date($listDataAtrArr['mdfy_dt_frmt'], strtotime($record->created_at))); ?></td>
                  <?php if($roleRights['view']): ?>
                  <td>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.link_tooltip','data' => ['url' => ''.e(route('admin.contact.show', $record->enq_id)).'','title' => ''.e($listDataAtrArr['view_txt']).'','target' => ''.e($listDataAtrArr['target']).'','class' => 'f-20','placement' => 'left']]); ?>
<?php $component->withName('link_tooltip'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.contact.show', $record->enq_id)).'','title' => ''.e($listDataAtrArr['view_txt']).'','target' => ''.e($listDataAtrArr['target']).'','class' => 'f-20','placement' => 'left']); ?>
                      <i class="fa fa-eye"></i>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<script>
  ...
  function filter() {
    ...
    window.location.href = "<?php echo e(route('admin.contact.index')); ?>" + "?page=0" + searchPagiData + "&ppage=" + "<?php echo e($perPage); ?>";
    return false;
  }
  /*Reset Filter*/
  function resetfilter() {
    window.location.href = "<?php echo e(route('admin.contact.index')); ?>";
  }
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('themes.backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ishant/Documents/GitHub/myplex/resources/views/themes/backend/pages/contact/index.blade.php ENDPATH**/ ?>