<template>
    ...
    <div class="custom-banner no-bg fw-bannerfund-portfolio-banner monthly-ranking monthly-snapshot-banner"><section class="inner_banner_section"><div class="container"><div class="row"><div class="col-md-12"><div class="inner_section_banner"><h4>Snapshot</h4></div></div></div></div></section></div>
    ...
    <section class="monthly_snapshop_sec graph_table">
        <div class="container">
            <div class="fund-c-analysis m-t-30 m-b-30 monthly-compo">
                ...
                <div class="wm_tab">
                    <ul>
                        <li><a :href="weeklyUrl">Weekly</a></li>
                                    ...
                                    <div class=" dy-table-wrap">
                                        <div class="dy-table-block br-5  index_changes_header">
                                            ...
                                            <div class="changes_table">
                                               <!-- <table class="table-responsive table-striped box-shadow">
                                                    <thead>
                                                        <tr>
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 box_border_right">
                                    <div class="dy-table-wrap">
                                        <div class="dy-table-block br-5  index_changes_header">
                                            ...
                                            <div class="changes_table">
                                                <!--<table id="currency" class="dataTable no-footer" role="grid">
                                                    <thead>
                                                        <tr>
                    ...
                    <div class="container p-0">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 pl-0 weekly-table-block-one">
                                                    <div class="changes_table ws-table-wrap">
                                                        ...
                                                        <div class="table-responsive">
                                                           <table class="dataTable no-footer table-striped" role="grid" v-if="showTable1">
                                                                <thead>
                                                                    <tr>
                        ...
                        <div :class="modalClasses" class="fade" id="reject" role="dialog">
                            <div class="modal-dialog">
									...
									<CustomTable class="table-responsive table-striped box-shadow" id="best-fund-change" :columns="[
      ...
      watch: {
        selectedFundType(value) {
            ...
            selectedDate(newDate) {
                this.getMonthlyChangesFundType(newDate);
            }
        },
      computed: {
