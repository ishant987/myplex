                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6 col-md-12 mb-4">
                                        <div class="cal_form_select">
                                            <label for="">What is the present cost of such marriage ? (in Rs.)</label>
                                            <input class="form-text" type="text" placeholder=""  v-model="var_1"  />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 mb-4">
                                        <div class="cal_form_select">
                                            <label for="">After how many years is your child likely to get married ? (Max. 50 years)</label>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="cal_form_select">
                                            <label for="">The amount you would require for your child's marriage (in Rs.)</label>
											<div class="row">
											<div class="col-md-8">
