        ...
        <div class="s_renge">
            <div class="row mb-3">
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="cal_form_select">
                        ...
                        <input class="form-text" type="text" placeholder=""  v-model="goalsipamount" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="cal_form_select">
                        <label for="">Investment Duration (Y)</label>
                        <input class="form-text" type="text" placeholder="" v-model="goalinvestmentduration"  />
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="cal_form_select">
                        <label for="">Expected Rate of Return (%p.a.)</label>
                        <input class="form-text" type="text" placeholder=""   v-model="goalrateofreturn" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="cal_form_select">
                        <label for="">Annual Inflation Rate (%)</label>
                ...
                <div class="col-md-12">
                    <a href="#" class="money_title_btn" :disabled="!inflationrate || !goalrateofreturn || !goalinvestmentduration" @click="calculate_goal_sip(plan)">Calculate</a>
                    &nbsp;<a href="#" class="money_title_btn" @click="inflationrate='';goalrateofreturn='';goalinvestmentduration='';goalsipamount='';final_goal_amt='';goal_sip_investments='';goal_sip_amt='';">Reset</a>
                </div>
            </div>
            <hr>
            ...
            <div class="row pt-4">
                <div class="col-lg-12 col-md-12" >
                    <div class="cal_form_select" >
                        <div class="row">
                            <div class="col-md-4" v-if="final_goal_amt">
                                <div class="cal_form_select">
                                    <label for="">Inflation Adjusted Goal Amount (Rs.)</label>
