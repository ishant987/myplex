                    ...
                    <div class="tab-pane fade show active" id="pills-Return" role="tabpanel" aria-labelledby="pills-Return-tab">
                        <div class="row investing-tools">
                            <div class="col-lg-5 col-md-5 col-sm-12 invst-wrap select2-styles">
                                <div class="invst-fields mt-0">
                                    ...
                                    <multiselect :disabled="process" class="" label="fund_name" track-by="fund_id" v-model="selectedFundReturns" tag-placeholder="" placeholder="Select Fund" :options="funds" :multiple="false" :taggable="false" selectLabel="" :searchable="true" :block-keys="['Tab', 'Enter', 'backspace']" :max-height="150" :showNoResults="true">
                                    </multiselect>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="datatable_ll main_trer fund_performance_table">
                            <div class="table-responsive">
                                <div class="fund_per_heading d-block d-sm-flex align-items-center justify-content-between">
                                    <h4>Performance Compare</h4>
                                    <div>
                                        <a href="javascript://" class="money_title_btn" @click="ratio_type = 'to_category';getFundRatios()" :disabled="ratio_type == 'to_category' || process">To Category</a>
                                        <a href="javascript://" class="money_title_btn" @click="ratio_type = 'to_benchmark';getFundRatios()" :disabled="ratio_type == 'to_benchmark'  || process">To Benchmark</a>
                                    </div>
                                </div>

                                <table id="example" class="table table-striped" style="width:100%" v-if="ratio_type">
                                    <thead>
                                        <tr>
                                            <td class="dark_bg color_white text-center" colspan="9">Performance Compare To Category <span v-if="ratio_type == 'to_category'">Category</span><span v-if="ratio_type == 'to_benchmark'">Benchmark</span></td>
                                        </tr>
                                        <tr>
                                            <th>Return</th>
                                            <th>7 Days</th>
                            ...
                            <div class="mt-5 " v-show="ratio_type" style="width: 100%;">
                                ...
                                <div style="height:30px; width:70px; background:#ffffff; position:absolute; z-index:999; margin-top:-34px;" id="myplexusC"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="datatable_ll main_trer fund_performance_table">
                            <div class="table-responsive">
                                ...
                                <table id="example" class="table table-striped" style="width:100%">
                                    <thead>
                                        <tr>
                                            <td class="dark_bg color_white text-center" colspan="3">Ratio as on <span class="ratio-date" v-if="Object.keys(jensenalpha_beta_volatility_ratios).length">{{ jensenalpha_beta_volatility_ratios.ONEYEAR.end_date }}</span></td>
                                        </tr>
                                        <tr>
                                            <th>Scheme Name</th>
                                            <th>1 Year</th>
                        ...
                        <div class="datatable_ll main_trer fund_performance_table">
                            <div class="table-responsive">
                                <table id="example" class="table table-striped" style="width:100%">
                                    <thead>
                                        <tr>
                                            <td class="dark_bg color_white text-center" colspan="9">Portfolio Details as on <span class="ratio-date" v-if="Object.keys(portfolio_data).length">{{ formatMonthYear(portfolio_data.monthinfo,portfolio_data.yearinfo) }}</span></td>
                                        </tr>
                                        <tr>
                                            <th>No.of Scrips</th>
                                            <th>Wtd. PE </th>
