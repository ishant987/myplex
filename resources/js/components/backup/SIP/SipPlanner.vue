<template>
    <div class="invst-wrap invst-sip-planner">

            <h3>SIP Planner</h3>

            <ul class="nav nav-tabs justify-content-start">
                <li><a class="active" data-toggle="tab" href="#calculate-sip">Calculate SIP</a></li>
                <li><a data-toggle="tab" href="#sip-planner-faq">FAQ's</a></li>
            </ul>
            ...
            <div class="tab-wrapper">
                <div class="tab-content">
                    ...
                    <div id="calculate-sip" class="tab-pane fade in active">

                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="step==1 || step==2">
                            <div class="sip-planner-ic-common sip-planner-ic-name">
                                <label>Value of Current Expenses (Rs.)</label>
                                <input type="text" id="inflation-username" placeholder="Enter Name" v-model="name" />
                            </div>
                            <div class="sip-planner-ic-common sip-planner-ic-email">
                                <label>Value of Current Expenses (Rs.)</label>
                                <input type="email" id="inflation-user-email" placeholder="Enter Email" v-model="email" />
                            </div>
                        </div>
                        
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="step==1 || step==2">
                            <div class="sip-planner-ic-common sip-planner-ic-phone" >
                                <label>Phone</label>
                                <input type="number" id="inflation-user-phone" placeholder="Enter Number" min="10" max="12" v-model="phone" />
                            </div>
                            <div class="sip-planner-ic-common sip-planner-ic-plan">
                                <label>Select Plan</label>
                                <select v-model="plan" :disabled="!name || !email && step==2" id="inflation-user-plan" class="js-example-placeholder-single js-states form-control">
                        ...
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="plan == 1">
                            
                            <div class="sip-planner-ic-common">
                                <label>Current monthly expenditure (in Rs.)</label>
                                <input type="number" class="form-control" v-model="var_1"    />
                            </div>
                            <div class="sip-planner-ic-common">
                                <label>Number of years left for retirement (Max. 50 years)</label>
                                <input type="number" max="50" class="form-control" v-model="var_2"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4">
                                <label>Assume a rate of inflation (in %)</label>
                                <input type="number" class="form-control" v-model="var_3"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4">
                                <label>Assume a risk free rate of return on your retirement fund (in Rs.)</label>
                                <input type="number" class="form-control" v-model="var_4"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4"></div>
                            <div class="sip-planner-ic-common mt-4" v-if="var_5">
                                <label>Retirement Fund required to meet your post retirement monthly expenses (in Rs.)</label>
                                <input :disabled="true" type="number" class="form-control" v-model="var_5"    />
                            </div>
                            
                        </div>
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="plan == 2">
                        ...
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="plan == 3">
                        ...
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="plan == 4">
                        ...
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between" v-if="plan == 5">
                            
                            <div class="sip-planner-ic-common">
                                <label>Goal Amount (Rs.)</label>
                                <input type="number" class="form-control" v-model="goalsipamount"    />
                            </div>
                            <div class="sip-planner-ic-common">
                                <label>Investment Duration (Y)</label>
                                <input type="number" class="form-control" v-model="goalinvestmentduration"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4">
                                <label>Expected Rate of Return (%p.a.)</label>
                                <input type="number" class="form-control" v-model="goalrateofreturn"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4">
                                <label>Annual Inflation Rate (%)</label>
                                <select  v-model="inflationrate" class="form-control" title="Inflation would decrease your savings buying power every year. A realistic range is in between 2%-10%, but over the last decade it has been between 4%-6% per annum">
                            ...
                            <div class="sip-planner-ic-common mt-4" v-if="final_goal_amt"></div>
                            <div class="sip-planner-ic-common mt-4" v-if="final_goal_amt">
                                <label>Inflation Adjusted Goal Amount (Rs.)</label>
                                <input :disabled="true" type="number" class="form-control" v-model="final_goal_amt"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4" v-if="goal_sip_investments"></div>
                            <div class="sip-planner-ic-common mt-4" v-if="goal_sip_investments">
                                <label>Your Total Investment (Rs.)</label>
                                <input :disabled="true" type="number" class="form-control" v-model="goal_sip_investments"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4" v-if="goal_sip_amt"></div>
                            <div class="sip-planner-ic-common mt-4" v-if="goal_sip_amt">
                                <label>Monthly SIP Amount (Rs.)</label>
                                <input :disabled="true" type="number" class="form-control" v-model="goal_sip_amt"    />
                            </div>
                        ...
                        <div class="row mx-0 invst-fields invst-field-1 justify-content-between">
                            <div class="sip-planner-ic-common sip-planner-ic-plan">
                            ...
                            <div class="sip-planner-ic-common">
                                <label>Amount Required on maturity (in Rs.)</label>
                                <input type="number" class="form-control" v-model="var_5"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4">
                                <label>Number of years (Max. 50 years)</label>
                                <input type="number" class="form-control" v-model="var_6"    />
                            </div>
                            <div class="sip-planner-ic-common mt-4">
                                <label>Frequency (Time a year)</label>
                                <select class="form-control" v-model="var_7">
                            ...
                            <div class="sip-planner-ic-common mt-4">
                                <label>Expected yield on investment (in %)</label>
                                <input type="number" class="form-control" v-model="var_8"    />
                            </div>
                                
                            <div class="sip-planner-ic-common mt-4" v-if="var_9">
                                <label>Installment amount to be invested: (in %)</label>
                                <input type="number" class="form-control" disabled v-model="var_9"    />
                            </div>
                            <p class="text-danger" v-if="error_msg2">{{error_msg2}}</p>
                        </div>
                    ...
                    <div id="sip-planner-faq" class="tab-pane fade">
                        ...
                        <div class="tabs-faqs">
                            <div class="tab-faqs">
                                ...
                                <div class="faq-main">
                                    ...
                                    <h6>All the questions that you want to know the answers to - the why, the how, the what etc. neatly put forth for your benefit.</h6>
                                    <div class="faq-wrap">
                                        <div id="accordion" v-html="sip_faqs"></div>
                                    </div>
                                </div>
...
export default {
  ...
  return !isNaN(parseFloat(n)) && isFinite(n);
    ...
    async send_graph_result(){
            ...
            if(this.plan == 1){
                form_data.push({'text':'Plan',value:'Planning for retirement'})
                form_data.push({'text':'Current monthly expenditure (in Rs.)',value:this.var_1})
                form_data.push({'text':'Number of years left for retirement (Max. 50 years)',value:this.var_2})
                form_data.push({'text':'Assume a rate of inflation (in %)',value:this.var_3})
                form_data.push({'text':'Assume a risk free rate of return on your retirement fund (in Rs.)',value:this.var_4})
                result_data.push({'text':'Retirement Fund required to meet your post retirement monthly expenses (in Rs.)',value:this.var_5})
            }
            if(this.plan == 2){
                form_data.push({'text':'Plan',value:"Planning for child's marriage"})
                form_data.push({'text':'What is the present cost of such marriage ? (in Rs.)',value:this.var_1})
                form_data.push({'text':'After how many years is your child likely to get married ? (Max. 50 years)',value:this.var_2})
                form_data.push({'text':'Assume a rate of inflation (in %)',value:this.var_3})
                result_data.push({'text':"The amount you would require for your child's marriage (in Rs.)",value:this.var_5})
            }
            if(this.plan == 3){
                form_data.push({'text':'Plan',value:"Planning for child's higher education"})
                form_data.push({'text':'What is the present cost of such educaton ? (in Rs.)',value:this.var_1})
                form_data.push({'text':'After how many years is your child likely to go for higher education ? (Max. 50 years)',value:this.var_2})
                form_data.push({'text':'Assume a rate of inflation (in %)',value:this.var_3})
                result_data.push({'text':"The amount you would require for yor child's higher education (in Rs.)",value:this.var_5})
            }
            if(this.plan == 4){
                form_data.push({'text':'Plan',value:'Planning for owning an asset'})
                form_data.push({'text':'What is the present cost of such asset ? (in Rs.)',value:this.var_1})
                form_data.push({'text':'After how many years you are planning to buy the said asset ? (Max. 50 years)',value:this.var_2})
                form_data.push({'text':'Assume a rate of inflation (in %)',value:this.var_3})
                result_data.push({'text':"Amount you would require to own the said asset (in Rs.)",value:this.var_5})
            }
            ...
            if(this.step == 3){
                ...
                form_data.push({'text':'Amount Required on maturity (in Rs.)',value:this.var_5})
                form_data.push({'text':'Number of years (Max. 50 years)',value:this.var_6})
                form_data.push({'text':'Frequency (Time a year)',value:this.var_7})
                form_data.push({'text':'Expected yield on investment (in %)',value:this.var_8})
                result_data.push({'text':'Installment amount to be invested: (in %)',value:this.var_9})
            }
            if(this.plan == 5){
                form_data.push({'text':'Plan',value:'Others'})
                form_data.push({'text':'Goal Amount (Rs.)',value:this.final_goal_amt})
                form_data.push({'text':'Investment Duration (Y)',value:this.goalinvestmentduration})
                form_data.push({'text':'Expected Rate of Return (%p.a.)',value:this.goalrateofreturn})
                form_data.push({'text':'Annual Inflation Rate (%)',value:this.inflationrate})

                result_data.push({'text':'Inflation Adjusted Goal Amount (Rs.)',value:this.final_goal_amt})
                result_data.push({'text':'Your Total Investment (Rs.)',value:this.goal_sip_investments})
                result_data.push({'text':'Monthly SIP Amount (Rs.)',value:this.goal_sip_amt})
    ...
    async get_goal_graph(){
		...
		for(i=1;i<=goal_investment_duration;i++){
			...
			dataPoints1.push({label: i+" Year", y: invested_amt});
			dataPoints2.push({label: i+" Year", y: return_amt});
		}    
        let chart = {
