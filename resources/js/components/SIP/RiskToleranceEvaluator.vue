...
<div class="risk-tol-eval-results br-5" v-if="Object.keys(calculatedValues).length">
    ...
    <div class="risk-tol-eval-risk-profile br-5">
        <div class="row risk-profile-titles">
            <div class="col-lg-6 col-md-6 col-sm-6 title-1">
                <h3>Your Overall Risk Profile</h3>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 title-2">
                <h3>{{ calculatedValues.capacity_to_take_risk_for_total }}</h3>
            </div>
        </div>
    ...
    methods: {
        ...
        submitForm() {
            ...
            for (let icount = 0; icount < that.questions.length; icount++) {
                ansArr.push({
                    question: icount + 1,
                    answer: that.questions[icount]['a']
                })
            }
            let data = {
                name: that.name,
