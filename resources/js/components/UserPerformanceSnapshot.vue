...
<section class="info_monitor_sec">
    <div class="compare-scemes-sec investing-tools perform-snapshot-tabs select2-styles">
        <div class="container tab_snap_shot new-shot scnd-shot">
            ...
            <ul class="nav nav-pills mb-3 w_tab" id="pills-tab" role="tablist">
                            ...
                            <div id="tab-weekly" class="tab-pane fade in" :class="{'active show':currentTab == 'weekly'}">
                                ...
                                <div class="light_green_bg">
                                    ...
                                    <div class="invst-wrap wrp-new">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <Datepicker placeholder="As On Date" class="" v-model="selectedDateWeekly" :format="'dd/MM/yyyy'" :enableTimePicker="false" :autoApply="true" :range="false" :maxDate="maxDateRang"></Datepicker>
                                            </div>
                                            <div class="col-md-4">
                                                <multiselect 
                                ...
                                <div class="perform-snapshot-points mt-2 bordr-only prfrm-snapst" v-if="weekly_snapshot_data.length">
                                    <ul>
                                        ...
                                        <li><p>As On : <span>{{ formattedDate(selectedDateWeekly) }}</span></p></li>
                                    </ul>
                                </div>
                                </div>

                                <div class="datatable_ll main_trer fund_performance_table perform-snapshot-table full-table-style-2 custom-sort-table main-trer-wrapper graph_table">
                            ...
                            <div id="tab-monthly" class="tab-pane fade" :class="{'active show':currentTab == 'monthly'}">
                               ...
                               <div class="light_green_bg">
                                    ...
                                    <div class="invst-wrap">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <Datepicker placeholder="As On Date" class="" v-model="selectedDateMonthly" :format="'dd/MM/yyyy'" :enableTimePicker="false" :autoApply="true" :range="false" :maxDate="maxDateRang"></Datepicker>
                                            </div>
                                            <div class="col-md-4">
                                                <multiselect 
                                                :disabled="loading || process"
                                ...
                                <div class="perform-snapshot-points mt-2 bordr-only prfrm-snapst" v-if="monthly_snapshot_data.length">
                                    <ul>
                                        ...
                                        <li><p>As On : <span>{{ this.aaum_date ? formattedDate(this.aaum_date): formattedDate(selectedDateMonthly) }}</span></p></li>
                                    </ul>
                                </div>
                               </div>
                                    ...
                                    <table id="performance-monthly" class="display w-100 dataTable" v-if="dataCategoryMonthly == 'indices' || dataCategoryMonthly == 'return' || dataCategoryMonthly == 'return_less_index'">
                                        ...
                                        <tbody>
                                            <tr v-for="(data,index) in monthly_snapshot_data" :key="index">
                                                ...
                                                <td>{{ data['sixmonths'] != NULL ? Number(data['sixmonths'].toFixed(3)).toFixed(2) : 0 }}</td>
                                                <td>{{ data['oneyear'] != NULL ? Number(data['oneyear'].toFixed(3)).toFixed(2) : 0 }}</td>
                                                <td>{{ data['twoyear'] != NULL ? Number(data['twoyear'].toFixed(3)).toFixed(2) : 0 }}</td>
                                                <td>{{ data['threeyear'] != NULL ? Number(data['threeyear'].toFixed(3)).toFixed(2) : 0 }}</td>
                                            </tr>
...
export default {
  ...
  methods: {
   ...
   generateURL(tabName) {
      const baseURL = 'https://myplexus.tech2dev.xyz/quick-ratio';
      const queryParams = {
