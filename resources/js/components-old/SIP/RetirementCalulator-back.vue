                                    ...
                                    <div class="cal_form_select">
                                        ...
                                        <input class="form-text" type="number"
                                            placeholder="Expected age of Retirement *" v-model="retirement_age" />
												...
												<div class="right">
										<div class="slidecontainer">
  <input type="range" min="1" max="100" value="50" class="slider" @input="expected_age_retirement_input" id="expected_age_retirement_output">
 <!-- <p>Value: <span id="demo"></span></p> -->
</div>
</div>
	</div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="cal_form_select">
                                        ...
                                        <input class="form-text" type="number" placeholder="Life Expectancy *"
											...
											<div class="right">
										<div class="slidecontainer">
  <input type="range" min="1" max="100" value="50" class="slider" id="life_expectancy_output" @input="life_expectancy_input">
 <!-- <p>Value: <span id="demo"></span></p> -->
</div>
</div>
	</div>
                                ...
                                <div class="col-lg-12 col-md-12 ">
                                    <div class="cal_form_select">
                                        ...
                                        <input class="form-text" type="text"
                                            ...
                                            v-model="return_during" id="accumulation_period"/>
	</div>
												<div class="right">
										<div class="slidecontainer">
                                ...
                                <div class="col-lg-12 col-md-12 ">
                                    <div class="cal_form_select">
										...
										<div class="d-flex">
											<div class="left">
                                        <input class="form-text" type="number"
                                            placeholder="Rate of return after retirement *" id="retirement" v-model="return_after" />
	</div>
												<div class="right">
										<div class="slidecontainer">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="cal_form_select">
                                        ...
                                        <input class="form-text" type="number" placeholder="Inflation *"
                                            v-model="inflation" id="inflation"/>
	</div>
												<div class="right">
										<div class="slidecontainer">
  <input type="range" min="1" max="100" value="50" class="slider" id="inflation_output" @input="inflation_input">
 <!-- <p>Value: <span id="demo"></span></p> -->
</div>
</div>
	</div>
                            ...
                            <div class="middle_left">
                                <a href="javascript://" :disabled="disabledCalculate"
                                    @click="calculate_retirement">Calculate</a>
                            </div>
                        </div>
                            <div class="row d-none">
								...
								<div class="col-6 right-side">
									<div class="text-center text-white">
										<h4>Estimate Retirement Fund</h4>
										<h3 class="mt-3">{{ corpus_need_on_retirement }}</h3>
                                    </div>
									<!--	<div class="d-flex align-items-center justify-content-center my-3 text-white">
											<span style="margin-right:6px">Monthly</span>
																	   <label class="switch">
  <input type="checkbox" checked>
  <span class="checkbox round"></span>
</label>
											<span style="margin-left:6px">Yearly</span>
	</div>
-->
										<img class="w-100" src="https://new.myplexus.com/themes/frontend/assets/v1/img/retirementcalculator.png" />
