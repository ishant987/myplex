...
export default {
  ...
  methods: {
   ...
   async getFundDetails(){
       ...
       await axios.get('/api/v1/fund-details', { params: {fund_code:fund_code} })
            .then(response => {
                if(that.currentTab == 'returns'){
   ...
   async getFundRatios(){
       ...
       if(!Object.keys(that.nav_graph_data).length){
        ...
        if(!Object.keys(that.category_compare_data).length && that.ratio_type == 'to_category'){
            await axios.get('/api/v1/fund-performance-compare-category', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   async schemeHighLow(){
       let that = this
       await axios.get('/api/v1/fund-performance-scheme-high-low', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   async benchmarkHighLow(){
       let that = this
       await axios.get('/api/v1/fund-performance-benchmark-high-low', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   async schemeJensenalphaBetaVolatility(){
       ...
       await axios.get('/api/v1/fund-performance-jensenalpha-beta-volatility', { params: {fund_code:fund_code} })
            .then(response => {
   ...
   async schemeReturn(){
       let that = this
       await axios.get('/api/v1/fund-return-scheme', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   async benchmarkReturn(){
       let that = this
       await axios.get('/api/v1/fund-return-benchmark', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   async schemeNAV(){
       ...
       that.dataPoints = []
       await axios.get('/api/v1/fund-index-currency', { params: {fund_code:that.selectedFundReturns.fund_code,days:that.selectedNavDays} })
            .then(response => {
   ...
   async schemeSIP(){
       let that = this
       await axios.get('/api/v1/fund-performance-scheme-sip', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   async benchmarkSIP(){
       let that = this
       await axios.get('/api/v1/fund-performance-benchmark-sip', { params: {fund_code:that.selectedFundReturns.fund_code} })
            .then(response => {
   ...
   calculate_sip(dates,values){
    ...
    async schemeAAUM(){
        let that = this
        that.aaum_data = []
        await axios.get('/api/v1/fund-performance-aaum', { params: {fund_code:that.selectedFundRatios.fund_code} })
                .then(response => {
    ...
    async schemePortfolio(){
        let that = this
        that.portfolio_data = []
        await axios.get('/api/v1/fund-portfolio-details', { params: {fund_code:that.selectedFundPortFolios.fund_code} })
                .then(response => {
    ...
    async schemePortfolioTopTenScripts(){
        let that = this
        await axios.get('/api/v1/fund-portfolio-top-scripts', { params: {fund_code:that.selectedFundPortFolios.fund_code} })
                .then(response => {
    ...
    async schemePortfolioTopIndustries(top_rows = 10){
        ...
        await axios.get('/api/v1/fund-portfolio-top-industries', { params: {fund_code:that.selectedFundPortFolios.fund_code,top_rows:top_rows} })
                .then(response => {
