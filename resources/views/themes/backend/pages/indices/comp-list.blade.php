...
@section('breadcrumb')
{{ Breadcrumbs::render('indices-comp.list')  }}
@endsection
    ...
    <div class="col-sm-12">
        <div class="card m-b-0">
            <div class="card-header">
                <h5>{{ __('admin.indices.comp.list_label_txt') }}</h5>
                <div class="c-f-btns">
                    <div class="c-f-b-f">
                        <!-- Filter -->
                        <x-form.btn_filter />
                    ...
                    <div class="c-f-b-r">
                        ...
                        <form id="listDataForm" name="listDataForm" method="post" action="{{ route('admin.indices-comp.delete') }}">
                            {{ csrf_field() }}
            ...
            <div class="card-block">
                ...
                <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form id="filterForm" name="filterForm" method="get" action="{{ route('admin.indices-comp.list') }}">
                    ...
                    <table class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <x-form.field.text id="fin" name="fin" value="{{ $fltrDataArr['indices_name'] ?? '' }}" />
                                </td>
                                <td>
...
<script>
    ...
    function filter() {
        ...
        window.location.href = "{{ route('admin.indices-comp.list') }}" + "?page=0" + searchPagiData + "&ppage=" + "{{ $perPage }}";
        return false;
    }
    /*Reset Filter*/
    function resetfilter() {
        window.location.href = "{{ route('admin.indices-comp.list') }}";
    }
</script>
@endpush