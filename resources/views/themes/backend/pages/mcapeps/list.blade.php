...
@section('breadcrumb')
{{ Breadcrumbs::render('mcap-eps.list')  }}
@endsection
  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      <div class="card-header">
        <h5>{{ __('admin.mcapeps.list_label_txt') }}</h5>
        <div class="c-f-btns">
          <div class="c-f-b-f">
            <!-- Filter -->
            <x-form.btn_filter />
          ...
          <div class="c-f-b-r">
            ...
            <form id="listDataForm" name="listDataForm" method="post" action="{{ route('admin.mcap-eps.delete') }}">
              {{ csrf_field() }}
      ...
      <div class="card-block">
        ...
        <div class="dataTables_wrapper dt-bootstrap4 no-footer">
          <form id="filterForm" name="filterForm" method="get" action="{{ route('admin.mcap-eps.list') }}">
          ...
          <table class="table table-striped table-bordered nowrap">
            <thead>
              <tr>
                ...
                <th class="cc-w-125">{{ $sortbyArr['market_cap'] }}</th>
                <th class="cc-w-125">{{ $sortbyArr['eps'] }}</th>
                <th class="cc-w-80">{{ $sortbyArr['pe'] }}</th>
...
<script>
  ...
  function filter() {
    ...
    window.location.href = "{{ route('admin.mcap-eps.list') }}" + "?page=0" + searchPagiData + "&ppage=" + "{{ $perPage }}";
    return false;
  }
  /*Reset Filter*/
  function resetfilter() {
    window.location.href = "{{ route('admin.mcap-eps.list') }}";
  }
</script>
@endpush