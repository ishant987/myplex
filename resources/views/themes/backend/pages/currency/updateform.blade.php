  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      ...
      <div class="card-block">
        ...
        <form name="eDataFrm" id="eDataFrm" action="{{ route('admin.currency.update', $dataArr->cm_id) }}" method="POST">
          {{ csrf_field() }}
          {{ method_field('PATCH') }}
          ...
          <x-form.group_lyt1_2_10 label="{{ __('admin.currency.url_txt') }}" for="currency_url" error="{{ $errors->first('currency_url') }}" required="true">
            <x-form.field.text id="currency_url" name="currency_url" value="{{ $dataArr->currencycor->cor }}" />
          </x-form.group_lyt1_2_10>
