...
@section('breadcrumb')
{{ Breadcrumbs::render('currencies.list')  }}
@endsection
    ...
    <div class="col-sm-12">
        <div class="card m-b-0">
            <div class="card-header">
                <h5>{{ __('admin.currency.list.label_txt') }}</h5>
                <div class="c-f-btns">
                    <div class="c-f-b-f">
                        <!-- Filter -->
                        <x-form.btn_filter />
                    ...
                    <div class="c-f-b-r">
                        ...
                        <form id="listDataForm" name="listDataForm" method="post" action="{{ route('admin.currencies.delete') }}">
                            {{ csrf_field() }}
            ...
            <div class="card-block">
                ...
                <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form id="filterForm" name="filterForm" method="get" action="{{ route('admin.currencies.list') }}">
                    ...
                    <table class="table table-striped table-bordered nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>{{ $sortbyArr['cur_name'] }}</th>
                                <th class="cc-w-125">{{ $sortbyArr['entry_value'] }}</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <x-form.field.text id="fcn" name="fcn" value="{{ $fltrDataArr['cur_name'] ?? '' }}" />
                                </td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr role="row" class="">
                                ...
                                <td>{{ $record->cur_name }}</td>
                                <td>{{ $record->entry_value }}</td>
...
<script>
    ...
    function filter() {
        ...
        window.location.href = "{{ route('admin.currencies.list') }}" + "?page=0" + searchPagiData + "&ppage=" + "{{ $perPage }}";
        return false;
    }
    /*Reset Filter*/
    function resetfilter() {
        window.location.href = "{{ route('admin.currencies.list') }}";
    }
</script>
@endpush