  ...
  <div class="col-sm-12">
    <div class="card m-b-0">
      ...
      <div class="card-block">
        ...
        <form name="eDataFrm" id="eDataFrm" action="{{ route('admin.fund-suggestion.update', $dataArr->fs_id) }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PATCH') }}
          ...
          <x-form.group_lyt1_2_10 label="{{ __('admin.description_txt') }}" for="description" error="{{ $errors->first('description') }}">
            <x-form.field.textarea id="description" name="description" value="{!! $dataArr->description !!}" rows="8" class="editor" />
          </x-form.group_lyt1_2_10>
