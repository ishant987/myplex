...
@section('vue-js') @stop
@section('content')
<div class="custom-banner no-bg  @if(!$dataArr['image_path']) performance-snapshot-banner  @endif" @if($dataArr['image_path']) style="background-image:url({{$dataArr['image_path']}})"  @endif">
	<div class="container">
