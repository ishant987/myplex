        ...
        <header class="head">
                <div class="top_bar">
                        ...
                        <ul class="mobile_profile_link">
                            <li>
                                <a href="{{ route('user.profile') }}" aria-label="Profile">
                                    <img src="{{asset('themes/frontend/assets/infosolz/images/wel.png')}}" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul class="welcome">
                        ...
                        <li><a href="{{ route('user.profile') }}"><img src="{{asset('themes/frontend/assets/infosolz/images/wel.png')}}" alt="">Profile</a></li>
                    ...
                    <div class="subs_in" data-subscription-banner>
                        <div class="subs_in__body">
                            @if(!empty($show_expired_warning))
                                ...
                                <p>
                                    {{ !empty($expiry_date_display) ? 'Subscription will expire on ' . $expiry_date_display . '.' : 'Subscription has expired.' }}
                                    <a href="{{ $subscription_cta_url ?? '#' }}">Renew now</a>
                                </p>
                            @elseif(!empty($show_renew_warning))
                                <i class="fa-solid fa-triangle-exclamation yellow"></i>
                                <p>
                                    Subscription will expire on {{ $expiry_date_display ?? date('d/m/Y', strtotime($expiry_date)) }}.
                                    <a href="{{ $subscription_cta_url ?? '#' }}">Renew now</a>
                                </p>
                            @elseif(!empty($expiry_date))
                                <i class="fa-solid fa-bell green"></i>
                                <p>Subscription active until {{ date('d/m/Y', strtotime($expiry_date)) }}.</p>
                            @else
                                <i class="fa-solid fa-bell green"></i>
                ...
                <nav class="left_menu same_height">
                    <ul>
                        ...
                        <!-- <li class="left_menu__utility left_menu__utility--start {{ request()->routeIs('user.index_dashboard') ? 'active' : '' }}"><a href="{{route('user.index_dashboard')}}"><img src="{{asset('themes/frontend/assets/infosolz/images/wel.png') }}" alt="">Dashboard</a></li>
                        <li class="left_menu__utility {{ request()->routeIs('user.profile') ? 'active' : '' }}"><a href="{{route('user.profile')}}"><img src="{{asset('themes/frontend/assets/infosolz/images/wel.png') }}" alt="">Profile</a></li>
                        <li class="left_menu__utility"><a href="{{route('user.logout')}}"><img src="{{asset('themes/frontend/assets/infosolz/images/log.png') }}" alt="">Logout</a></li> -->
                    </ul>
                </nav>
        </header>
