                ...
                <div class="hero_banner_right_slider">
                    <div class="single_slider_for">
                        ...
                        <div class="slider_caption">
                            <h2 class="animate__animated animate__fadeInUp">Invest in research</h2>
                            <p class="animate__animated animate__fadeInUp">Don’t get scared by the research word. Over here at myplexus.com, we have made everything fun and easy. So, when someone tells you a fact, check here if it is so or otherwise. Make your money secure through research. Research that is simple to understand and convey facts.</p>
                    ...
                    <div class="single_slider_for">
                        ...
                        <div class="slider_caption">
                            <h2 class="animate__animated animate__fadeInUp">Invest in numbers</h2>
                            <p class="animate__animated animate__fadeInUp">Numbers don’t lie. They can be interpreted without complications. They have an unique story to tell that cuts through the clutter. Here we provide these numbers that are easy to grasp and much easier to arrive at. </p>
                            <!-- <a href="/compare-scheme" class="banner_btn btn animate__animated animate__fadeInLeft">Compare</a> -->
                        </div>
                    </div>
					<div class="single_slider_for">
                        ...
                        <div class="slider_caption">
                            <h2 class="animate__animated animate__fadeInUp">Invest in awareness</h2>
                            <p class="animate__animated animate__fadeInUp">Not everybody has the same outlook or preference for investing. Some prefer higher risk whereas some others prefer lower risks. Choose as per your preferences. With your best analytical resource in mutual funds.</p>
                            <!-- <a href="/compare-scheme" class="banner_btn btn animate__animated animate__fadeInLeft">Compare</a> -->
                        </div>
                    </div>
                </div>
            ...
            <div class="money_seriously_title mb-4 mb-md-5">
                <div class="col-md-12" data-aos="fade-up" data-aos-duration="1000">
                    <div class="money_seriously_title d-block d-sm-flex align-items-center">
                        ...
                        <p>
                            The savings and investment universe has seen seismic changes over the last decade. Gone are the days when the simple bank fixed deposit sufficed. Today, we are faced with a plethora of outcomes from a multitude of solutions and products. The mind boggles. Here we attempt to provide contexts, feedbacks and explanations to emerging issues in the world of savings and investment for the overall benefit of your financial health. And knowledge is the only way to clear the clutter and move on. This is a collaborative platform. A platform that welcomes feedbacks. Thus adding to everyone’s strength in making the correct choices. 
