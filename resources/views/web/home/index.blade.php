                                        ...
                                        <div class="left_slider_sec">
                                            ...
                                            <div class="her_banner_left_slide">
                                                <div class="single_slider_nav">
                                                    <p>Bandhan Bank Q2 update: Loans, advances rise 22% to Rs 99,374 crore Why was Electronics
                                                        Mart India IPO a hit with investors?</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="single_abt_item  mb-5" data-aos="fade-up" data-aos-duration="1500">
                                                    ...
                                                    <div class="single_abt_content">
                                                        <p>An unique layout that very simply outlines the various performance parameters  and recommendations of funds, in numerical, graphical and color coded styles.</p>
                                            ...
                                            <div class="col-md-4">
                                                <div class="single_abt_item mb-5" data-aos="fade-up" data-aos-duration="1500">
                                                    ...
                                                    <div class="single_abt_content">
                                                        ...
                                                        <a href="/performance-snapshot">Go to Performance Snapshot <i
                                            ...
                                            <div class="col-md-4">
                                                <div class="single_abt_item" data-aos="fade-up" data-aos-duration="1500">
                                                    ...
                                                    <div class="single_abt_content">
                                                        <p>A comparison of fund's performance with its category and index over multiple time frames to understand the risk adjusted returns and ratios, and portfolios generated by the fund.</p>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="right_compare">
                                            <div class="single_right_compare d-flex align-items-start mb-4" data-aos="fade-up"
                                            ...
                                            <a href="{{ route('web.compare.scheme') }}" data-aos="fade-up" data-aos-duration="1000"
                                                class="compare_scheme_btn btn-block">Compare</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
However, merely tracking the historical returns and fund ranking will not help you choose the right fund. Here, we discuss topics such as investment objectives, levels of financial freedom, performance parameters, and how they  will help you understand what to look for in a fund. We will also cover some key concepts such as risk and return, asset allocation, and diversification.
                        ...
                        <section class="calulator_section section">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="nav nav-pills justify-content-center calculator_nav_pills mb-4" id="myTab"
                                            role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="Planner-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-selected="true">Planner</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="calculator_inner d-md-flex d-block align-items-center-between w-100">
                                                            <div class="single_calculator">
                                                                ...
                                                                <div data-aos="zoom-in" data-aos-duration="500">
                                                                    <a href="{{ route('web.calculators.inflation') }}">
                                                                        <img
                                                                            src="{{ asset('themes/frontend/assets/v1/img/calculator-icon1.png') }}" />
                                                            ...
                                                            <div class="single_calculator have_before">
                                                                ...
                                                                <div data-aos="zoom-in" data-aos-duration="1000">
                                                                    <a href="{{ route('web.calculators.retirement') }}?tab=retire-calc">
                                                                        <img
                                                                            src="{{ asset('themes/frontend/assets/v1/img/calculator-icon2.png') }}" />
                                                            ...
                                                            <div class="single_calculator have_before">
                                                                ...
                                                                <div data-aos="zoom-in" data-aos-duration="1500">
                                                                    <a href="{{ route('web.calculators.objective') }}">
                                                                        <img
                                                                            src="{{ asset('themes/frontend/assets/v1/img/calculator-icon3.png') }}" />
                                                            ...
                                                            <div class="single_calculator have_before">
                                                                ...
                                                                <div data-aos="zoom-in" data-aos-duration="2000">
                                                                    <a href="{{ route('web.calculators.risk') }}?tab=risk-tol-eval">
                                                                        <img
                                                                            src="{{ asset('themes/frontend/assets/v1/img/calculator-icon4.png') }}" />
                                                            ...
                                                            <div class="single_calculator have_before">
                                                                ...
                                                                <div data-aos="zoom-in" data-aos-duration="2000">
                                                                    <a href="#">
                                                                        <img
                                                                            src="{{ asset('themes/frontend/assets/v1/img/calculator-icon6.png') }}" />
                                                                        <h4>Future Value</h4>
                                                                    </a>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="Performance" role="tabpanel" aria-labelledby="Performance-tab">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div
                                                            class="calculator_inner d-md-flex d-block align-items-center-between justify-content-center w-100">
                                                            <div class="single_calculator">
                                                                <span class="right_circle d-none d-sm-block"></span>
                                                                <div data-aos="zoom-in" data-aos-duration="500">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="money_right_section" data-aos="fade-up" data-aos-duration="1000">
                                            <h4>{{$val->fund_name}}</h4>
                                            <p>{{$val->objective}}</p>
                                            <a href="{{url('/nfo-monitor').'/'.$val->no_id}}">View More Details</a>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <section class="fund_expert_section section">
                            <img class="fund_expert_man" src="{{ asset('themes/frontend/assets/v1/img/fund_expert.png') }}"
                                            ...
                                            <div class="testimonial_slider">
                                                <div class="single_testimonila_slide">
                                                    <div class="single_slider_message">
                                                        ...
                                                        <p>myplexus.com provides data and analysis like no other platform. It is a very evolved
                                                            and contemporary platform to evaluate fund performance. The comparisons between
                                                            funds that it provides by using exhaustive statistical tools lend to it the
                                                            credibility that investors and advisors will certainly benefit from. Certain
                                                            features and tools myplexus.com utilises provide insights unmatched anywhere else.
                                                        </p>
                                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="research_right_sec">
                                            <div class="research_row d-md-block d-lg-flex d-block align-items-center mb-40">
                                                ...
                                                <div class="single_reserch d-flex align-items-center" data-aos="fade-down"
                                                    data-aos-duration="1000">
                                                    <div class="research_icon">
