                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-error">
                            <div class="form-wrapper">
                                ...
                                <input type="text" id="from_date_cagr" onchange="getOneYearDate()" name="search_from_date" value="{{old('search_from_date',isset($search_from_date)?$search_from_date:'')}}" class="from_date_for_cagr form-control" readonly required>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-error">
                            <div class="form-wrapper">
                                <label>To Date :</label>
                                <input type="text" class=" form-control" id="cagr_to_date" name="search_to_date" value="{{old('search_to_date',isset($search_to_date)?$search_to_date:'')}}" readonly required>
                            </div>
                ...
                <div class="col-12">
                    <div class="table-wrapper">
                        <table class="table table-bordered result-table">
                            ...
                            <tbody>
                                <tr>
                                    <td align="center">{{$fund_return_absolute}}</td>
                                    <td align="center">{{$index_return_absolute}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
