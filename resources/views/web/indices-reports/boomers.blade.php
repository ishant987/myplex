                    ...
                    <div class="tab">
                        ...
                        <div class="graph_table">
                            <div class="share_pdf">
                                ...
                                <a href="javascript:void(0)" id="exportPDF-indices-scrip" class="pdf"><img src="{{asset('themes/frontend/assets/infosolz/images/pdf.png')}}" ></a>
                    ...
                    <div class="tab">
                        ...
                        <div class="graph_table">
                            ...
                            <div class="share_pdf">
                                ...
                                <div class="sharethis-inline-share-buttons" ></div>
                                <a href="javascript:void(0)" id="exportPDF-indices-industry" class="pdf"><img src="{{asset('themes/frontend/assets/infosolz/images/pdf.png')}}" ></a>
    ...
    document.addEventListener('DOMContentLoaded', function() 
    {
        ...
        exportButton.addEventListener('click', function() 
        {
            ...
            img.onload = function() 
            {
                ...
                @if(isset($month) && isset($month_second) && isset($year) && isset($year_second))
                    var scripsBoomersText = `Scrips Boomers: For the month of {{ date('F', mktime(0, 0, 0, $month, 10)) }}, {{ $year }} to {{ date('F', mktime(0, 0, 0, $month_second, 10)) }}, {{ $year_second }}`;
    ...
    document.addEventListener('DOMContentLoaded', function() 
    {
        ...
        exportButton.addEventListener('click', function() {
            ...
            img.onload = function() {
                ...
                @if(isset($month) && isset($month_second) && isset($year) && isset($year_second))
                    var industriesBoomersText = `Industries Boomers: For the month of {{ isset($month) ? date('F', mktime(0, 0, 0, $month, 10)) : 'N/A' }}, {{ isset($year) ? $year : 'N/A' }} to {{ isset($month_second) ? date('F', mktime(0, 0, 0, $month_second, 10)) : 'N/A' }}, {{ isset($year_second) ? $year_second : 'N/A' }}`;
