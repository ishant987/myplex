                    ...
                    @if (isset($p_one_quartile_decile_result) &&
                        ...
                        <div class="quartile_tab">
                            <div class="graph_table">
                                ...
                                <table class="table comp2 datatable">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @php
                                            ...
                                            if (isset($p_one_quartile_decile_result[$quartile_set]) && count($p_one_quartile_decile_result[$quartile_set]) > 0) {
                                                ...
                                                if (
                                                    ...
                                                    $p_one_quartile_decile_result[$quartile_set] = custom_sort($p_one_quartile_decile_result[$quartile_set]);
                                                    // asort(($p_one_quartile_decile_result[$quartile_set]);
                                                } else {
                                                    $p_one_quartile_decile_result[$quartile_set] = custom_sort($p_one_quartile_decile_result[$quartile_set], 'dsc');
                                                    // arsort(($p_one_quartile_decile_result[$quartile_set]);
                                                }
                                            }
                                        @endphp
                                            ...
                                            <tr class="data">
                                                ...
                                                <td class="text_right">
                                                    @if ($quartile_set == 'quartile')
                                                        {{ is_numeric($p_one_quartile_decile_result['fund_absolute_return'][$fundId]) ? $p_one_quartile_decile_result['quartile'][$fundId] : 'N/A' }}
                                                    @else
                                                        {{ is_numeric($p_one_quartile_decile_result['fund_absolute_return'][$fundId]) ? $p_one_quartile_decile_result['decile'][$fundId] : 'N/A' }}
                                                    @endif
                                                </td>
                                                ...
                                                <td class="text_right">
                                                    @if ($quartile_set == 'quartile')
                                                        {{ is_numeric($p_two_quartile_decile_result['fund_absolute_return'][$fundId]) ? $p_two_quartile_decile_result['quartile'][$fundId] : 'N/A' }}
                                                    @else
                                                        {{ is_numeric($p_two_quartile_decile_result['fund_absolute_return'][$fundId]) ? $p_two_quartile_decile_result['decile'][$fundId] : 'N/A' }}
                                                    @endif
                                                </td>
                                                <td class="text_right">
