            ...
            <div class="content_left">
                ...
                <div class="fund_detail mt_15">
                    ...
                    <div class="single_fund">
                        ...
                        <ul>
                            ...
                            <li><p>Total Asset Size</p> <i>:</i> <span>{{ $crore }} Crores</span></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="perform_single">
                            ...
                            <table class="cmn_table">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th style="padding: -2px 16px;">{{ $return_date_6_month.' - '.$return_date }}</th>
                                        <th>{{ $return_date_1.' - '.$return_date }}</th>
                                        <th>{{ $return_date_2.' - '.$return_date }}</th>
                                        <th>{{ $return_date_3.' - '.$return_date }}</th>
                                        <th>{{ $return_date_5.' - '.$return_date }}</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="perform_single">
                            ...
                            <table class="cmn_table">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>{{ $return_date_6_month.' - '.$return_date }}</th>
                                        <th>{{ $return_date_odd_1.' - '.$return_date_6_month }}</th>
                                        <th>{{ $return_date_odd_2.' - '.$return_date_odd_1 }}</th>
                                    </tr>
                                </thead>
                                <tbody class="retunr_discontinus_table">
                ...
                <div class="fund_compo mt_15">
                    ...
                    <table class="cmn_table">
                        ...
                        <tbody>
                        @if(!empty($fund_scrips) || !empty($fund_scrips1) || !empty($fund_scrips2) || !empty($fund_scrips3) || !empty($fund_scrips4))
                            @for ($i = 0; $i<10; $i++)
                            <tr>
                                <td>{{ !empty($fund_scrips[$i]) ? $fund_scrips[$i]->scrip_name : 'NA' }}</td>
                                <td>{{ !empty($fund_scrips[$i]) ? $fund_scrips[$i]->qty:'NA' }}</td>
                                <td>{{ !empty($fund_scrips1[$i]) ? $fund_scrips1[$i]->qty:'NA' }}</td>
                                <td>{{ !empty($fund_scrips2[$i]) ? $fund_scrips2[$i]->qty:'NA' }}</td>
                                <td>{{ !empty($fund_scrips3[$i]) ? $fund_scrips3[$i]->qty:'NA' }}</td>
                                <td>{{ !empty($fund_scrips[$i]) ? $fund_scrips4[$i]->qty:'NA' }}</td>
                            </tr>
                            @endfor
                        @endif
                        </tbody>
                ...
                <div class="m_fund">
                    <ul>
                        ...
                        <a href="{{ url('new-fundwatch') }}/{{$fund_code_encoded}}">
                            ...
                            <figure>
                            <a href="{{ url('new-fundwatch') }}/{{$fund_code_encoded}}"><img src="{{ env('ADMIN_SITE') }}/assets/images/{{ $recentPost->logo }}" alt=""></a>
                            </figure>
                        </li>
                        @endforeach
                    </ul>
...
<input type="hidden" value="{{ $AAUMValue }}" id="aaum_values">
                        ...
                        <input type="hidden" value="{{ $getRankQuartileDecile }}" id="getRankQuartileDecile">
