...
@section('content')
<!-- <div id="vue-app">
    <monthly-snapshot page_title="{{$dataArr['title']}}"  page_description="{{$dataArr['descp']}}" page_image="{{ $dataArr['image_path'] }}" image_path="{{asset('themes/frontend/assets/v1/img/')}}"></monthly-snapshot>
            ...
            <div class="container p-0">
                <div class="snapshot_inner">
                    <div class="snapshot_header" style="padding: 0px 3px;">
                        <p>Monthly Snapshot Report: {{ date('d/m/Y', strtotime($from_date)) }} to {{ date('d/m/Y', strtotime($to_date)) }}</p>
                    </div>
                                        ...
                                        <div class="changes_table ws-table-wrap">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table dataTable no-footer table-striped" role="grid">
                                                    ...
                                                    <tbody>
                                                        @foreach ($data['monthly_benchmark'] as $benchmark_details)
                                                        <tr>
