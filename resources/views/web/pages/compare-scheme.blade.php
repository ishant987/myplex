  ...
  @section('vue-js') @stop
  @section('content')
  <div class="custom-banner no-bg fw-banner @if (!$dataArr['image_path']) fund-portfolio-banner @endif"
      @if ($dataArr['image_path']) style="background-image:url({{ $dataArr['image_path'] }})" @endif>
      ...
      <div class="container">
          <div class="comp_schem_bdr">
              ...
              <div class="tab-content" id="pills-tabContent">
                          ...
                          <div class="row mb-1">
                              <div class="col-md-12 col-lg-6 pe-lg-1">
                                  <div class="form_select border_top_left">
                                      ...
                                      <select class="form-select select2 form-select-lg js-example-basic-single" id="main_list">
                                      </select>
                                  </div>
                              </div>
                          ...
                          <div class="row">
                              <div class="col-md-12 col-lg-3 pe-lg-1 col-12 mb-1">
                                  <div class="form_select bg_green border_bottom_left">
                                      ...
                                      <select class="form-select select2 form-select-lg js-example-basic-single"
                                          id="first_child_list">
                                      </select>
                                  </div>
                              </div>
                  ...
                  <!-- ratio calulation -->
                  @include('web.pages.ratio-calculation')
                  ...
                  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                              ...
                              <div class="row mb-1">
                                  <div class="col-md-12 col-lg-5 pe-lg-1">
                                      <div class="form_select border_top_left">
                                          ...
                                          <div class="d-flex">
                                              ...
                                              <button class="btn btn-primary mr-1" onclick="composition_main_type('indices', this)">Index</button>

                                          </div>
                                          <select class="form-select select2 form-select-lg js-example-basic-single" id="composition_select_first">
                                          </select>
                                  ...
                                  <div class="col-md-6 col-lg-4 pe-sm-1 ps-lg-0">
                                      <div class="form_select h-100"> <label for="">Category</label>
                                          <select class="form-select select2" id="compostion_category">
                                              <option value="">Select</option>
                                  ...
                                  <div class="col-md-6 col-lg-3 ps-lg-0 d-none">
                                      <div class="form_select top_bg_right_black border_top_right h-100">
                                          <label for="">Month / Year</label>
                                          <input type="month" id="start" name="start" min="2000-03" value="<?= date('Y-m'); ?>" style=" width: 100%;  padding: 8px; border-radius: 7px; ">
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-md-12 col-lg-3 pe-lg-1 col-6 mb-1">
                                      <div class="form_select bg_green border_bottom_left">
                                          <div class="d-flex">
                                              ...
                                              <button class="btn btn-primary mr-2 w-45" onclick="composition_main_type_one('indices', this)">Index</button>

                                          </div>
                                          <select class="form-select select2 form-select-lg js-example-basic-single" id="composition_select_two">
                                  ...
                                  <div class="col-md-12 col-lg-3 ps-lg-0 pe-lg-1 col-6">
                                      <div class="form_select bg_green">
                                          <div class="d-flex">
                                              ...
                                              <button class="btn btn-primary mr-3 w-45" onclick="composition_main_type_two('indices', this)">Index</button>

                                          </div>
                                          <select class="form-select select2 form-select-lg js-example-basic-single" id="composition_select_three">
                                  ...
                                  <div class="col-md-12 col-lg-3 ps-lg-0 pe-lg-1 col-6">
                                      <div class="form_select bg_green">
                                          <div class="d-flex">
                                              ...
                                              <button class="btn btn-primary mr-4 w-45" onclick="composition_main_type_three('indices', this)">Index</button>

                                          </div>
                                          <select class="form-select select2 form-select-lg js-example-basic-single" id="composition_select_four">
                                          </select>
                                      </div>
                                  </div>
                                  <div class="col-md-12 col-lg-3 ps-lg-0 pe-lg-1 col-6">
                                      <div class="form_select bg_green">
                                          <div class="d-flex">
                                              ...
                                              <button class="btn btn-primary mr-5 w-45" onclick="composition_main_type_four('indices', this)">Index</button>

                                          </div>
                                          <select class="form-select select2 form-select-lg js-example-basic-single" id="composition_select_five">
                                          </select>
                                      </div>
                                  </div>
                      ...
                      <div class="three_btn mt-3">
                          <div class="row align-items-center">
                              <div class="col-lg-12">
                                  ...
                                  <h4 class="fund_per_heading d-block d-sm-flex align-items-center justify-content-between hding-vue " id="info_box2"></h4>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="mt-5" style="">
                          <div id="loader" style="display: none;">
                              <img src="{{asset('themes/frontend/assets/v1/img/spinning-loading.gif')}}" width="150px" height="100px" alt="" />
                          </div>
  ...
  <script>
      ...
      function getCurrencies(id) {
          ...
          let url = "<?= URL::to('api/v1/currencies'); ?>";
          $.ajax({
              type: 'GET',
              url: url,
              success: function(data) {
      ...
      $('#compostion_btn').on('click', function() {
          ...
          if (compare_type != "" && value1 != "" && (value2 != "" || value3 != "" || value4 != "" || value5 != "") && $('#start').val() != "") {
              if (value1 != "" && value2 != "") {
                  ...
                  //console.log(compare_composition);
              } else {
              ...
              compare_url = "<?= URL::to('api/v1/compare-compositions'); ?>";
              $.ajax({
                  type: 'GET',
                  url: compare_url,
                  data: {
                  ...
                  success: function(data) {
                      ...
                      if (data.success) {
                          ...
                          console.log(data.data.info_box);
                          $('.showrslt').html("");
                          $('#compose_table').html("");
                          $('#info_box2').text(data.data.info_box);
                          ...
                          if (compare_type == 'top_script' || compare_type == 'top_industry') {
                              ...
                              if (data.data.composition_data.scheme1) {
                                  ...
                                  html_auum += '<tr>';
                                  html_auum += '<th class="bg-gray text-white" style="width: 75% !important;">Name Of Fund</th>';
                                  html_auum += '<th class="bg-gray text-white" style="min-width: 150px;">AAUM (in Crores)</th>';
                                  html_auum += '</tr>';
                                  html_auum += '<tbody>';
      ...
      function buildHtml(compare_type, hd_text, scheme_data) {
          ...
          if (compare_type == 'top_script') {
              ...
              if (scheme_data.data != null) {
                  var corpus_entry = (scheme_data.data.corpus_entry / 100);
                  html += '<tr><td class="modal-td">' + hd_text + '</td><td>' + corpus_entry.toFixed(2) + '</td></tr>';
              }
      ...
      function compare() {
          ...
          let compare_url = "<?= URL::to('api/v2/compare-price'); ?>";
