            ...
            <div class="content_left">
                ...
                <div class="perform mt_15">
                    ...
                    <div class="perform_in">
                        <div class="perform_single">
                            <h5>Lumsump (Amount Invested | Rs. 1,00,000/-)</h5>
                ...
                <div class="risk_adjust mt_15">
                    <div class="rist_table_top">
                        <h5>Risk Adjusted Alpha (Jensen's) and The Risk Rations</h5>
                    </div>
                ...
                <div class="fund_compo mt_15">
                    ...
                    <table class="cmn_table">
                        ...
                        @if(!empty($fund_scrips) || !empty($fund_scrips1) || !empty($fund_scrips2) || !empty($fund_scrip3s) || !empty($fund_scrips4))
                            @for ($i = 0; $i<10; $i++)
                            <tr>
                                <td>{{ $fund_scrips[$i]->scrip_name }}</td>
                                <td>{{ $fund_scrips[$i]->qty }}</td>
                                <td>{{ $fund_scrips1[$i]->qty }}</td>
                                <td>{{ $fund_scrips2[$i]->qty }}</td>
                                <td>{{ $fund_scrips3[$i]->qty }}</td>
                                <td>{{ $fund_scrips4[$i]->qty }}</td>
                            </tr>
                            @endfor
                        @endif
                        </tbody>
                ...
                <div class="feedback mt_15">
                    <h3>Myplexus.com Feedback</h3>
                    <p>{!! $fundWatch->feedback !!}</p>
                </div>

                <p class="discl"><strong>Disclaimer :</strong> {!! $fundWatch->disclaimer !!}</p>
            </div>     <!--CONTENT LEFT-->    
                            ...
                            function drawRankQuartileDecile() {
                                ...
                                for (var timeSpan in jsonData) {
                                    if (jsonData.hasOwnProperty(timeSpan)) {
                                        data.addRow([timeSpan, jsonData[timeSpan].rank, jsonData[timeSpan].quartile, jsonData[timeSpan].decile]);
                                    }
                                }
                                ...
                                var options = {
                                    ...
                                    colors: ['#16AB6C', '#dc3912', '#fcd303'] // specify custom colors for each series
                                };
