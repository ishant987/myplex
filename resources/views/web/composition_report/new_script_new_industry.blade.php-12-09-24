        ...
        <div class="page_detail">
            <div class="inner_padding">
                ...
                <div class="new_page">
                    ...
                    <input type="hidden" name="fund_codes" id="fund_codes" value="{{ isset($fundCodes) ? json_encode($fundCodes) : ''}}">
                    ...
                    @if (isset($month) && isset($year) && isset($month_second) && isset($year_second) && $request->Category != '')
                        ...
                        <div class="wm_tab">
                            <ul class="tabs">
                                <li>
                                    <a class="active" href="javascript:void(0)">Scrips</a>
                                </li>
                                <li>
                                    ...
                                    <table class="table datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text_center">Ammount (in lacs.)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                @foreach ($scrips as $sc)
                                                    <tr>
                                                        ...
                                                        <td class="text_right open-popup-scrip-industry"
                                                            ...
                                                            {{ isset($sc->content_per) ? number_format($sc->content_per, 5) : '0' }}
                                                        </td>
                                                        <td class="text_right open-popup-scrip-industry"
                                            ...
                                            @if (isset($industry) && count($industry) > 0)
                                                @foreach ($industry as $inds)
                                                    <tr>
                                                        ...
                                                        <td class="text_left open-popup-scrip-industry" data-using="industry" data-category="content_per" data-parameter="{{$inds->industry}}">
                                                            {{ isset($inds->content_per) ? number_format($inds->content_per, 3) : '0' }}
                                                        </td>
                                                        <td class="text_left open-popup-scrip-industry" data-using="industry" data-category="amount" data-parameter="{{$inds->industry}}">
                                                            {{ isset($inds->amount) ? number_format($inds->amount) : '0' }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
