                ...
                <div class="login-wrap">
                    <div class="sip-calc-wrapper">
                        ...
                        <div class="sip-calc-loginin-wrap">
                            ...
                            <h5>Log In with</h5>
                            <ul>
                                <li><a href="{{ route('web.calculators.social.login','google-calc') }}"><i class="fa fa-envelope"></i></a></li>
                                <li><a href="{{ route('web.calculators.social.login','facebook-calc') }}"><i class="fa fa-facebook"></i></a></li>
                            </ul>
                            <h5>Or</h5>
                        </div>
