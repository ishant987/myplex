                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund1.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund2.png')}}" />
                                        <h4>Income Funds</h4>
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund3.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund4.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund5.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund6.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund12.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund7.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund8.png')}}" />
                                        <h4>Gilt Funds</h4>
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund9.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund10.png')}}" />
                                ...
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="single_classification h-100">
                                        <img src="{{asset('themes/frontend/assets/v1/img/fund11.png')}}" />
                                        <h4>Hybrid Debt</h4>
                                        <p>Monthly Income Plan invests in a combination of debt and equity securities. It invests pre-dominantly in debt securities and 15-25% in equities.</p>
                                    </div>
                                </div>
