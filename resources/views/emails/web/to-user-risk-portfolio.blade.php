  ...
  <tbody>
    ...
    <tr>
      <td align="center" valign="top" style="margin:0;padding:0;">
        <p style="margin:0;padding:0px 0px 10px 0px;font-family:{{ $mailCssAtr['font_family'] }}; font-size:{{ $mailCssAtr['txt_fnt_size'] }};color:{{ $mailCssAtr['txt_color'] }};font-weight:{{ $mailCssAtr['fnt_nrml'] }};">Here is summary of your Risk Profile that you just filled.</p>      
      </td>
    </tr>
    <tr>
      <td align="center" valign="top" style="margin:0;padding:0;">
            ...
            <table class="table table-bordered" style="background: #f7f7fb;width: 100%;">
              ...
              <tbody> 
                <tr>
                  ...
                  <td style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;">{{$mailArr['portfolio_data']['capacity_to_take_risk_for_accor1']}}</td>
                  <td  style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;" id="c_type_star">
                        <img src="{{ url('images/'.$mailArr['portfolio_data']['accor1_star'].'-green-star.png') }}" alt="{{$mailArr['portfolio_data']['accor1_star']}} - start" />                       
                  </td>
                </tr>
                <tr>
                  <td  style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;">Risk appetite</td>
                  <td  style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;"id="r_type">{{$mailArr['portfolio_data']['capacity_to_take_risk_for_accor2']}}</td>
                  <td  style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;" id="r_type_star">
                     <img src="{{ url('images/'.$mailArr['portfolio_data']['accor2_star'].'-green-star.png') }}" alt="{{ $mailArr['portfolio_data']['accor2_star'] }} - start" />  
                  </td>
                </tr>
                <tr> 
                  <td  style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;">Need to take Risk</td>
                  <td  style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;" id="r_r_type">{{$mailArr['portfolio_data']['capacity_to_take_risk_for_accor3']}}</td>
                  <td style="padding: .75rem;vertical-align: top;border: 1px solid #000000;font-size: 15px;color: #000;" id="r_r_type_star">
                      <img src="{{ url('images/'.$mailArr['portfolio_data']['accor3_star'].'-green-star.png') }}" alt="{{ $mailArr['portfolio_data']['accor3_star'] }} - start" />
                    </td>
                </tr>
              </tbody>
            </table>
    ...
    <tr>
      <td align="center" valign="top" style="margin:0;padding:0;">
        <div class="overall_risk" align="center">  
            <ul style="margin:0;padding:0px 0px 10px 0px;font-family:{{ $mailCssAtr['font_family'] }}; font-size:{{ $mailCssAtr['txt_fnt_size'] }};color:{{ $mailCssAtr['txt_color'] }};font-weight:{{ $mailCssAtr['fnt_nrml'] }};">
                ...
                <li style="width: 45%;text-align: center;font-size: 16px;color: #000;display: inline-block;font-weight: bold;"><span id="tot_r_type">{{$mailArr['portfolio_data']['capacity_to_take_risk_for_total']}}</span></li>
            </ul>
        </div>     
      </td>
    </tr>
    <tr>
      <td align="center" valign="top" style="margin:0;padding:0;">
          <p style="margin:0;padding:0px 0px 10px 0px;font-family:{{ $mailCssAtr['font_family'] }}; font-size:{{ $mailCssAtr['txt_fnt_size'] }};color:{{ $mailCssAtr['txt_color'] }};font-weight:{{ $mailCssAtr['fnt_nrml'] }};">For your reference</p>
      </td>
    </tr>
    <tr>
      <td align="center" valign="top" style="margin:0;padding:0;">
